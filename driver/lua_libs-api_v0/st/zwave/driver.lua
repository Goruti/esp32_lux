...
local function zw_cmd_handler(driver, message_channel)
  ...
  device.log.info(string.format("received Z-Wave command: %s", cmd))
...
-- A default handler may be set to receive all commands for which no explicit
-- handler is registered.  But by default, this is nil.
