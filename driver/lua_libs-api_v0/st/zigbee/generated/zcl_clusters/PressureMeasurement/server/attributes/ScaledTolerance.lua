...
--- @class st.zigbee.zcl.clusters.PressureMeasurement.ScaledTolerance
--- @alias ScaledTolerance
---
--- @field public ID number 0x0013 the ID of this attribute
--- @field public NAME string "ScaledTolerance" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ScaledTolerance = {
  ID = 0x0013,
  NAME = "ScaledTolerance",
  base_type = data_types.Uint16,
}

function ScaledTolerance:augment_type(base_type_obj)
...
function ScaledTolerance.pretty_print(value_obj)
  ScaledTolerance.base_type.pretty_print(value_obj)
end

--- @function ScaledTolerance:build_test_attr_report
---
...
ScaledTolerance.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ScaledTolerance:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ScaledTolerance.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the ScaledTolerance(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function ScaledTolerance:new_value(...)
...
function ScaledTolerance:read(device)
...
function ScaledTolerance:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ScaledTolerance:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ScaledTolerance, {__call = ScaledTolerance.new_value})
