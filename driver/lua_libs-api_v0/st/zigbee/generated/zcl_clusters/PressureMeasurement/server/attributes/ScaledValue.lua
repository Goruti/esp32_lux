...
--- @class st.zigbee.zcl.clusters.PressureMeasurement.ScaledValue
--- @alias ScaledValue
---
--- @field public ID number 0x0010 the ID of this attribute
--- @field public NAME string "ScaledValue" the name of this attribute
...
function ScaledValue:augment_type(base_type_obj)
...
function ScaledValue.pretty_print(value_obj)
  ScaledValue.base_type.pretty_print(value_obj)
end

--- @function ScaledValue:build_test_attr_report
---
...
ScaledValue.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ScaledValue:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ScaledValue.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Int16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the ScaledValue(...) syntax
---
--- @vararg vararg the values needed to construct a Int16
--- @return st.zigbee.data_types.Int16
function ScaledValue:new_value(...)
...
function ScaledValue:read(device)
...
function ScaledValue:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ScaledValue:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ScaledValue, {__call = ScaledValue.new_value})
return ScaledValue
