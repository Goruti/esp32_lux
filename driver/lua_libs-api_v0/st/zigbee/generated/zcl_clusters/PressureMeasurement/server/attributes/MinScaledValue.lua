...
--- @class st.zigbee.zcl.clusters.PressureMeasurement.MinScaledValue
--- @alias MinScaledValue
---
--- @field public ID number 0x0011 the ID of this attribute
--- @field public NAME string "MinScaledValue" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local MinScaledValue = {
  ID = 0x0011,
  NAME = "MinScaledValue",
  base_type = data_types.Int16,
}

function MinScaledValue:augment_type(base_type_obj)
...
function MinScaledValue.pretty_print(value_obj)
  MinScaledValue.base_type.pretty_print(value_obj)
end

--- @function MinScaledValue:build_test_attr_report
---
...
MinScaledValue.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinScaledValue:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinScaledValue.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Int16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MinScaledValue(...) syntax
---
--- @vararg vararg the values needed to construct a Int16
--- @return st.zigbee.data_types.Int16
function MinScaledValue:new_value(...)
...
function MinScaledValue:read(device)
...
function MinScaledValue:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinScaledValue:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinScaledValue, {__call = MinScaledValue.new_value})
