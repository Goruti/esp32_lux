...
--- @class st.zigbee.zcl.clusters.PressureMeasurement.MaxScaledValue
--- @alias MaxScaledValue
---
--- @field public ID number 0x0012 the ID of this attribute
--- @field public NAME string "MaxScaledValue" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local MaxScaledValue = {
  ID = 0x0012,
  NAME = "MaxScaledValue",
  base_type = data_types.Int16,
}

function MaxScaledValue:augment_type(base_type_obj)
...
function MaxScaledValue.pretty_print(value_obj)
  MaxScaledValue.base_type.pretty_print(value_obj)
end

--- @function MaxScaledValue:build_test_attr_report
---
...
MaxScaledValue.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxScaledValue:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxScaledValue.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Int16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MaxScaledValue(...) syntax
---
--- @vararg vararg the values needed to construct a Int16
--- @return st.zigbee.data_types.Int16
function MaxScaledValue:new_value(...)
...
function MaxScaledValue:read(device)
...
function MaxScaledValue:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxScaledValue:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxScaledValue, {__call = MaxScaledValue.new_value})
