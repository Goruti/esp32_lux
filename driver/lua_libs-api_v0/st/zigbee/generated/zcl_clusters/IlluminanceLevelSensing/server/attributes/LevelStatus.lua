...
--- @field public NAME string "LevelStatus" the name of this attribute
--- @field public data_type st.zigbee.data_types.Enum8 the data type of this attribute
--- @field public ILLUMINANCE_ON_TARGET number 0
--- @field public ILLUMINANCE_BELOW_TARGET number 1
--- @field public ILLUMINANCE_ABOVE_TARGET number 2
local LevelStatus = {
  ID = 0x0000,
  NAME = "LevelStatus",
...
LevelStatus.ILLUMINANCE_ON_TARGET    = 0x00
LevelStatus.ILLUMINANCE_BELOW_TARGET = 0x01
LevelStatus.ILLUMINANCE_ABOVE_TARGET = 0x02


LevelStatus.enum_fields = {
    [LevelStatus.ILLUMINANCE_ON_TARGET]    = "ILLUMINANCE_ON_TARGET",
    [LevelStatus.ILLUMINANCE_BELOW_TARGET] = "ILLUMINANCE_BELOW_TARGET",
    [LevelStatus.ILLUMINANCE_ABOVE_TARGET] = "ILLUMINANCE_ABOVE_TARGET",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.zigbee.data_types.Enum8 the base data type object to add functionality to
function LevelStatus:augment_type(base_type_obj)
...
function LevelStatus.pretty_print(value_obj)
  return string.format("%s: %s[%s]", value_obj.field_name or value_obj.NAME, LevelStatus.NAME, LevelStatus.enum_fields[value_obj.value])
end

--- @function LevelStatus:build_test_attr_report
---
...
LevelStatus.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LevelStatus:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Enum8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LevelStatus.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LevelStatus:new_value(...)
...
function LevelStatus:read(device)
...
function LevelStatus:configure_reporting(device, min_rep_int, max_rep_int)
...
function LevelStatus:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LevelStatus, {__call = LevelStatus.new_value})
return LevelStatus
