...
function IlluminanceTargetLevel.pretty_print(value_obj)
  IlluminanceTargetLevel.base_type.pretty_print(value_obj)
end

--- @function IlluminanceTargetLevel:build_test_attr_report
---
...
IlluminanceTargetLevel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function IlluminanceTargetLevel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
IlluminanceTargetLevel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function IlluminanceTargetLevel:new_value(...)
...
function IlluminanceTargetLevel:read(device)
...
function IlluminanceTargetLevel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function IlluminanceTargetLevel:write(device, value)
...
function IlluminanceTargetLevel:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(IlluminanceTargetLevel, {__call = IlluminanceTargetLevel.new_value})
