...
--- @field public NAME string "AlarmCount" the name of this attribute
...
function AlarmCount:augment_type(base_type_obj)
...
function AlarmCount.pretty_print(value_obj)
  AlarmCount.base_type.pretty_print(value_obj)
end

--- @function AlarmCount:build_test_attr_report
---
...
AlarmCount.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AlarmCount:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AlarmCount.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AlarmCount:read(device)
...
function AlarmCount:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AlarmCount:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AlarmCount, {__call = AlarmCount.new_value})
return AlarmCount
