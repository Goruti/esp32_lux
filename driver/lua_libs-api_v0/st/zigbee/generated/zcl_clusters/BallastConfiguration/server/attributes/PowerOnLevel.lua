...
--- @field public NAME string "PowerOnLevel" the name of this attribute
...
function PowerOnLevel:augment_type(base_type_obj)
...
function PowerOnLevel.pretty_print(value_obj)
  PowerOnLevel.base_type.pretty_print(value_obj)
end

--- @function PowerOnLevel:build_test_attr_report
---
...
PowerOnLevel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PowerOnLevel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PowerOnLevel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PowerOnLevel:new_value(...)
...
function PowerOnLevel:read(device)
...
function PowerOnLevel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PowerOnLevel:write(device, value)
...
function PowerOnLevel:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PowerOnLevel, {__call = PowerOnLevel.new_value})
return PowerOnLevel
