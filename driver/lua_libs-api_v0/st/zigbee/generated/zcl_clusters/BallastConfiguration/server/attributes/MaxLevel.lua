...
--- @field public NAME string "MaxLevel" the name of this attribute
...
function MaxLevel:augment_type(base_type_obj)
...
function MaxLevel.pretty_print(value_obj)
  MaxLevel.base_type.pretty_print(value_obj)
end

--- @function MaxLevel:build_test_attr_report
---
...
MaxLevel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxLevel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxLevel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxLevel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxLevel:write(device, value)
...
function MaxLevel:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxLevel, {__call = MaxLevel.new_value})
return MaxLevel
