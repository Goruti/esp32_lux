...
function PowerOnFadeTime.pretty_print(value_obj)
  PowerOnFadeTime.base_type.pretty_print(value_obj)
end

--- @function PowerOnFadeTime:build_test_attr_report
---
...
PowerOnFadeTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PowerOnFadeTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PowerOnFadeTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PowerOnFadeTime:new_value(...)
...
function PowerOnFadeTime:read(device)
...
function PowerOnFadeTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PowerOnFadeTime:write(device, value)
...
function PowerOnFadeTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PowerOnFadeTime, {__call = PowerOnFadeTime.new_value})
