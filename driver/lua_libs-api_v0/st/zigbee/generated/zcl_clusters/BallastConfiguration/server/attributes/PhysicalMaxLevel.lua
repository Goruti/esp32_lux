...
function PhysicalMaxLevel.pretty_print(value_obj)
  PhysicalMaxLevel.base_type.pretty_print(value_obj)
end

--- @function PhysicalMaxLevel:build_test_attr_report
---
...
PhysicalMaxLevel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PhysicalMaxLevel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PhysicalMaxLevel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PhysicalMaxLevel:new_value(...)
...
function PhysicalMaxLevel:read(device)
...
function PhysicalMaxLevel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PhysicalMaxLevel:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PhysicalMaxLevel, {__call = PhysicalMaxLevel.new_value})
