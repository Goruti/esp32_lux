...
--- @field public NAME string "LampQuantity" the name of this attribute
...
function LampQuantity:augment_type(base_type_obj)
...
function LampQuantity.pretty_print(value_obj)
  LampQuantity.base_type.pretty_print(value_obj)
end

--- @function LampQuantity:build_test_attr_report
---
...
LampQuantity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LampQuantity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LampQuantity.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LampQuantity:new_value(...)
...
function LampQuantity:read(device)
...
function LampQuantity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LampQuantity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LampQuantity, {__call = LampQuantity.new_value})
return LampQuantity
