...
--- @alias BallastFactorAdjustment
---
--- @field public ID number 0x0015 the ID of this attribute
--- @field public NAME string "BallastFactorAdjustment" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local BallastFactorAdjustment = {
  ID = 0x0015,
  NAME = "BallastFactorAdjustment",
  base_type = data_types.Uint8,
}

function BallastFactorAdjustment:augment_type(base_type_obj)
...
function BallastFactorAdjustment.pretty_print(value_obj)
  BallastFactorAdjustment.base_type.pretty_print(value_obj)
end

--- @function BallastFactorAdjustment:build_test_attr_report
---
...
BallastFactorAdjustment.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BallastFactorAdjustment:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BallastFactorAdjustment.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function BallastFactorAdjustment:new_value(...)
...
function BallastFactorAdjustment:read(device)
...
function BallastFactorAdjustment:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BallastFactorAdjustment:write(device, value)
...
function BallastFactorAdjustment:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BallastFactorAdjustment, {__call = BallastFactorAdjustment.new_value})
