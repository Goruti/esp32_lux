...
--- @field public NAME string "MinLevel" the name of this attribute
...
function MinLevel:augment_type(base_type_obj)
...
function MinLevel.pretty_print(value_obj)
  MinLevel.base_type.pretty_print(value_obj)
end

--- @function MinLevel:build_test_attr_report
---
...
MinLevel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinLevel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinLevel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinLevel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinLevel:write(device, value)
...
function MinLevel:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinLevel, {__call = MinLevel.new_value})
return MinLevel
