...
function PhysicalMinLevel.pretty_print(value_obj)
  PhysicalMinLevel.base_type.pretty_print(value_obj)
end

--- @function PhysicalMinLevel:build_test_attr_report
---
...
PhysicalMinLevel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PhysicalMinLevel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PhysicalMinLevel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PhysicalMinLevel:new_value(...)
...
function PhysicalMinLevel:read(device)
...
function PhysicalMinLevel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PhysicalMinLevel:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PhysicalMinLevel, {__call = PhysicalMinLevel.new_value})
