...
--- @field public NAME string "LampType" the name of this attribute
...
function LampType:augment_type(base_type_obj)
...
function LampType.pretty_print(value_obj)
  LampType.base_type.pretty_print(value_obj)
end

--- @function LampType:build_test_attr_report
---
...
LampType.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LampType:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.CharString the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LampType.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LampType:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LampType:write(device, value)
...
function LampType:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LampType, {__call = LampType.new_value})
return LampType
