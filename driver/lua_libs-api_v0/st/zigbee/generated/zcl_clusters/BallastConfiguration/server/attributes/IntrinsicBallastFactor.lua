...
--- @alias IntrinsicBallastFactor
---
--- @field public ID number 0x0014 the ID of this attribute
--- @field public NAME string "IntrinsicBallastFactor" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local IntrinsicBallastFactor = {
  ID = 0x0014,
  NAME = "IntrinsicBallastFactor",
  base_type = data_types.Uint8,
}

function IntrinsicBallastFactor:augment_type(base_type_obj)
...
function IntrinsicBallastFactor.pretty_print(value_obj)
  IntrinsicBallastFactor.base_type.pretty_print(value_obj)
end

--- @function IntrinsicBallastFactor:build_test_attr_report
---
...
IntrinsicBallastFactor.build_test_attr_report = cluster_base.build_test_attr_report

--- @function IntrinsicBallastFactor:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
IntrinsicBallastFactor.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function IntrinsicBallastFactor:new_value(...)
...
function IntrinsicBallastFactor:read(device)
...
function IntrinsicBallastFactor:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function IntrinsicBallastFactor:write(device, value)
...
function IntrinsicBallastFactor:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(IntrinsicBallastFactor, {__call = IntrinsicBallastFactor.new_value})
