...
--- @field public NAME string "BallastStatus" the name of this attribute
...
BallastStatus.BASE_MASK               = 0xFF
BallastStatus.BALLAST_NON_OPERATIONAL = 0x01
BallastStatus.LAMP_FAILURE            = 0x02


BallastStatus.mask_fields = {
  BASE_MASK = 0xFF,
  BALLAST_NON_OPERATIONAL = 0x01,
  LAMP_FAILURE = 0x02,
}


--- @function BallastStatus:is_ballast_non_operational_set
--- @return boolean True if the value of BALLAST_NON_OPERATIONAL is non-zero
BallastStatus.is_ballast_non_operational_set = function(self)
  return (self.value & self.BALLAST_NON_OPERATIONAL) ~= 0
end
 
--- @function BallastStatus:set_ballast_non_operational
--- Set the value of the bit in the BALLAST_NON_OPERATIONAL field to 1
BallastStatus.set_ballast_non_operational = function(self)
  self.value = self.value | self.BALLAST_NON_OPERATIONAL
end

--- @function BallastStatus:unset_ballast_non_operational
--- Set the value of the bits in the BALLAST_NON_OPERATIONAL field to 0
BallastStatus.unset_ballast_non_operational = function(self)
  self.value = self.value & (~self.BALLAST_NON_OPERATIONAL & self.BASE_MASK)
end

--- @function BallastStatus:is_lamp_failure_set
--- @return boolean True if the value of LAMP_FAILURE is non-zero
BallastStatus.is_lamp_failure_set = function(self)
  return (self.value & self.LAMP_FAILURE) ~= 0
end
 
--- @function BallastStatus:set_lamp_failure
--- Set the value of the bit in the LAMP_FAILURE field to 1
BallastStatus.set_lamp_failure = function(self)
  self.value = self.value | self.LAMP_FAILURE
end

--- @function BallastStatus:unset_lamp_failure
--- Set the value of the bits in the LAMP_FAILURE field to 0
BallastStatus.unset_lamp_failure = function(self)
  self.value = self.value & (~self.LAMP_FAILURE & self.BASE_MASK)
end


BallastStatus.mask_methods = {
  is_ballast_non_operational_set = BallastStatus.is_ballast_non_operational_set,
  set_ballast_non_operational = BallastStatus.set_ballast_non_operational,
  unset_ballast_non_operational = BallastStatus.unset_ballast_non_operational,
  is_lamp_failure_set = BallastStatus.is_lamp_failure_set,
  set_lamp_failure = BallastStatus.set_lamp_failure,
  unset_lamp_failure = BallastStatus.unset_lamp_failure,
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.zigbee.data_types.Bitmap8 the base data type object to add functionality to
function BallastStatus:augment_type(base_type_obj)
...
function BallastStatus.pretty_print(value_obj)
  local zb_utils = require "st.zigbee.utils" 
  local pattern = ">I" .. value_obj.byte_length
  return string.format("%s: %s[0x]", value_obj.field_name or value_obj.NAME, BallastStatus.NAME, zb_utils.pretty_print_hex_str(string.pack(pattern, value_obj.value)))
end

--- @function BallastStatus:build_test_attr_report
---
...
BallastStatus.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BallastStatus:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Bitmap8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BallastStatus.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function BallastStatus:new_value(...)
...
function BallastStatus:read(device)
...
function BallastStatus:configure_reporting(device, min_rep_int, max_rep_int)
...
function BallastStatus:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BallastStatus, {__call = BallastStatus.new_value})
