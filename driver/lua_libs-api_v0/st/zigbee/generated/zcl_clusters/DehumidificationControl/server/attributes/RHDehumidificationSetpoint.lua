...
--- @class st.zigbee.zcl.clusters.DehumidificationControl.RHDehumidificationSetpoint
--- @alias RHDehumidificationSetpoint
---
--- @field public ID number 0x0010 the ID of this attribute
--- @field public NAME string "RHDehumidificationSetpoint" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local RHDehumidificationSetpoint = {
  ID = 0x0010,
  NAME = "RHDehumidificationSetpoint",
  base_type = data_types.Uint8,
}

function RHDehumidificationSetpoint:augment_type(base_type_obj)
...
function RHDehumidificationSetpoint.pretty_print(value_obj)
  RHDehumidificationSetpoint.base_type.pretty_print(value_obj)
end

--- @function RHDehumidificationSetpoint:build_test_attr_report
---
...
RHDehumidificationSetpoint.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RHDehumidificationSetpoint:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RHDehumidificationSetpoint.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the RHDehumidificationSetpoint(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function RHDehumidificationSetpoint:new_value(...)
...
function RHDehumidificationSetpoint:read(device)
...
function RHDehumidificationSetpoint:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RHDehumidificationSetpoint:write(device, value)
...
function RHDehumidificationSetpoint:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RHDehumidificationSetpoint, {__call = RHDehumidificationSetpoint.new_value})
