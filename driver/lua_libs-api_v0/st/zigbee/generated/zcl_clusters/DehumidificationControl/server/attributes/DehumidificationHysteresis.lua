...
--- @class st.zigbee.zcl.clusters.DehumidificationControl.DehumidificationHysteresis
--- @alias DehumidificationHysteresis
---
--- @field public ID number 0x0013 the ID of this attribute
--- @field public NAME string "DehumidificationHysteresis" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local DehumidificationHysteresis = {
  ID = 0x0013,
  NAME = "DehumidificationHysteresis",
  base_type = data_types.Uint8,
}

function DehumidificationHysteresis:augment_type(base_type_obj)
...
function DehumidificationHysteresis.pretty_print(value_obj)
  DehumidificationHysteresis.base_type.pretty_print(value_obj)
end

--- @function DehumidificationHysteresis:build_test_attr_report
---
...
DehumidificationHysteresis.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DehumidificationHysteresis:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DehumidificationHysteresis.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the DehumidificationHysteresis(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function DehumidificationHysteresis:new_value(...)
...
function DehumidificationHysteresis:read(device)
...
function DehumidificationHysteresis:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DehumidificationHysteresis:write(device, value)
...
function DehumidificationHysteresis:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DehumidificationHysteresis, {__call = DehumidificationHysteresis.new_value})
