...
--- @class st.zigbee.zcl.clusters.DehumidificationControl.DehumidificationCooling
--- @alias DehumidificationCooling
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "DehumidificationCooling" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local DehumidificationCooling = {
  ID = 0x0001,
  NAME = "DehumidificationCooling",
  base_type = data_types.Uint8,
}

function DehumidificationCooling:augment_type(base_type_obj)
...
function DehumidificationCooling.pretty_print(value_obj)
  DehumidificationCooling.base_type.pretty_print(value_obj)
end

--- @function DehumidificationCooling:build_test_attr_report
---
...
DehumidificationCooling.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DehumidificationCooling:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DehumidificationCooling.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the DehumidificationCooling(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function DehumidificationCooling:new_value(...)
...
function DehumidificationCooling:read(device)
...
function DehumidificationCooling:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DehumidificationCooling:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DehumidificationCooling, {__call = DehumidificationCooling.new_value})
