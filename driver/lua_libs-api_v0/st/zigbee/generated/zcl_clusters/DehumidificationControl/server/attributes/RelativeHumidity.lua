...
--- @class st.zigbee.zcl.clusters.DehumidificationControl.RelativeHumidity
--- @alias RelativeHumidity
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "RelativeHumidity" the name of this attribute
...
function RelativeHumidity:augment_type(base_type_obj)
...
function RelativeHumidity.pretty_print(value_obj)
  RelativeHumidity.base_type.pretty_print(value_obj)
end

--- @function RelativeHumidity:build_test_attr_report
---
...
RelativeHumidity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RelativeHumidity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RelativeHumidity.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the RelativeHumidity(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function RelativeHumidity:new_value(...)
...
function RelativeHumidity:read(device)
...
function RelativeHumidity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RelativeHumidity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RelativeHumidity, {__call = RelativeHumidity.new_value})
