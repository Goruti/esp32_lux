...
--- @class st.zigbee.zcl.clusters.DeviceTemperatureConfiguration.MinTempExperienced
--- @alias MinTempExperienced
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "MinTempExperienced" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local MinTempExperienced = {
  ID = 0x0001,
  NAME = "MinTempExperienced",
  base_type = data_types.Int16,
}

function MinTempExperienced:augment_type(base_type_obj)
...
function MinTempExperienced.pretty_print(value_obj)
  MinTempExperienced.base_type.pretty_print(value_obj)
end

--- @function MinTempExperienced:build_test_attr_report
---
...
MinTempExperienced.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinTempExperienced:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinTempExperienced.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Int16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MinTempExperienced(...) syntax
---
--- @vararg vararg the values needed to construct a Int16
--- @return st.zigbee.data_types.Int16
function MinTempExperienced:new_value(...)
...
function MinTempExperienced:read(device)
...
function MinTempExperienced:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinTempExperienced:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinTempExperienced, {__call = MinTempExperienced.new_value})
