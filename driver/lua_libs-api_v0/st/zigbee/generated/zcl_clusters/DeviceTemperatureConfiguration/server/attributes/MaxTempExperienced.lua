...
--- @class st.zigbee.zcl.clusters.DeviceTemperatureConfiguration.MaxTempExperienced
--- @alias MaxTempExperienced
---
--- @field public ID number 0x0002 the ID of this attribute
--- @field public NAME string "MaxTempExperienced" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local MaxTempExperienced = {
  ID = 0x0002,
  NAME = "MaxTempExperienced",
  base_type = data_types.Int16,
}

function MaxTempExperienced:augment_type(base_type_obj)
...
function MaxTempExperienced.pretty_print(value_obj)
  MaxTempExperienced.base_type.pretty_print(value_obj)
end

--- @function MaxTempExperienced:build_test_attr_report
---
...
MaxTempExperienced.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxTempExperienced:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxTempExperienced.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Int16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MaxTempExperienced(...) syntax
---
--- @vararg vararg the values needed to construct a Int16
--- @return st.zigbee.data_types.Int16
function MaxTempExperienced:new_value(...)
...
function MaxTempExperienced:read(device)
...
function MaxTempExperienced:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxTempExperienced:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxTempExperienced, {__call = MaxTempExperienced.new_value})
