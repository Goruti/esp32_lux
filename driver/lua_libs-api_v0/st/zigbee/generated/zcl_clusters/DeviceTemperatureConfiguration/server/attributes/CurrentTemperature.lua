...
--- @class st.zigbee.zcl.clusters.DeviceTemperatureConfiguration.CurrentTemperature
--- @alias CurrentTemperature
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "CurrentTemperature" the name of this attribute
...
function CurrentTemperature:augment_type(base_type_obj)
...
function CurrentTemperature.pretty_print(value_obj)
  CurrentTemperature.base_type.pretty_print(value_obj)
end

--- @function CurrentTemperature:build_test_attr_report
---
...
CurrentTemperature.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentTemperature:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentTemperature.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Int16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the CurrentTemperature(...) syntax
---
--- @vararg vararg the values needed to construct a Int16
--- @return st.zigbee.data_types.Int16
function CurrentTemperature:new_value(...)
...
function CurrentTemperature:read(device)
...
function CurrentTemperature:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentTemperature:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentTemperature, {__call = CurrentTemperature.new_value})
