...
--- @class st.zigbee.zcl.clusters.DeviceTemperatureConfiguration.LowTempThreshold
--- @alias LowTempThreshold
---
--- @field public ID number 0x0011 the ID of this attribute
--- @field public NAME string "LowTempThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local LowTempThreshold = {
  ID = 0x0011,
  NAME = "LowTempThreshold",
  base_type = data_types.Int16,
}

function LowTempThreshold:augment_type(base_type_obj)
...
function LowTempThreshold.pretty_print(value_obj)
  LowTempThreshold.base_type.pretty_print(value_obj)
end

--- @function LowTempThreshold:build_test_attr_report
---
...
LowTempThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LowTempThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LowTempThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Int16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the LowTempThreshold(...) syntax
---
--- @vararg vararg the values needed to construct a Int16
--- @return st.zigbee.data_types.Int16
function LowTempThreshold:new_value(...)
...
function LowTempThreshold:read(device)
...
function LowTempThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LowTempThreshold:write(device, value)
...
function LowTempThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LowTempThreshold, {__call = LowTempThreshold.new_value})
