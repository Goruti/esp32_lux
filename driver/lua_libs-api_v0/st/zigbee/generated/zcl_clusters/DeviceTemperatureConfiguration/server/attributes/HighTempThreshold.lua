...
--- @class st.zigbee.zcl.clusters.DeviceTemperatureConfiguration.HighTempThreshold
--- @alias HighTempThreshold
---
--- @field public ID number 0x0012 the ID of this attribute
--- @field public NAME string "HighTempThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local HighTempThreshold = {
  ID = 0x0012,
  NAME = "HighTempThreshold",
  base_type = data_types.Int16,
}

function HighTempThreshold:augment_type(base_type_obj)
...
function HighTempThreshold.pretty_print(value_obj)
  HighTempThreshold.base_type.pretty_print(value_obj)
end

--- @function HighTempThreshold:build_test_attr_report
---
...
HighTempThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function HighTempThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
HighTempThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Int16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the HighTempThreshold(...) syntax
---
--- @vararg vararg the values needed to construct a Int16
--- @return st.zigbee.data_types.Int16
function HighTempThreshold:new_value(...)
...
function HighTempThreshold:read(device)
...
function HighTempThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function HighTempThreshold:write(device, value)
...
function HighTempThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(HighTempThreshold, {__call = HighTempThreshold.new_value})
