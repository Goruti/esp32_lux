...
--- @class st.zigbee.zcl.clusters.DeviceTemperatureConfiguration.OverTempTotalDwell
--- @alias OverTempTotalDwell
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "OverTempTotalDwell" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local OverTempTotalDwell = {
  ID = 0x0003,
  NAME = "OverTempTotalDwell",
  base_type = data_types.Uint16,
}

function OverTempTotalDwell:augment_type(base_type_obj)
...
function OverTempTotalDwell.pretty_print(value_obj)
  OverTempTotalDwell.base_type.pretty_print(value_obj)
end

--- @function OverTempTotalDwell:build_test_attr_report
---
...
OverTempTotalDwell.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OverTempTotalDwell:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OverTempTotalDwell.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the OverTempTotalDwell(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function OverTempTotalDwell:new_value(...)
...
function OverTempTotalDwell:read(device)
...
function OverTempTotalDwell:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OverTempTotalDwell:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OverTempTotalDwell, {__call = OverTempTotalDwell.new_value})
