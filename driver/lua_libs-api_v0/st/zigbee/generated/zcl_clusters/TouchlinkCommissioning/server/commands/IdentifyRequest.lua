...
--- @field public identify_duration st.zigbee.data_types.Uint16
...
IdentifyRequest._serialize = utils.serialize_from_fields
...
function IdentifyRequest.deserialize(buf)
  ...
  for _, v in ipairs(IdentifyRequest.args_def) do
    ...
    elseif not v.optional then
      log.debug("Missing command arg " .. v.name .. " for deserializing IdentifyRequest")
    end
  end
...
--- @param identify_duration st.zigbee.data_types.Uint16
