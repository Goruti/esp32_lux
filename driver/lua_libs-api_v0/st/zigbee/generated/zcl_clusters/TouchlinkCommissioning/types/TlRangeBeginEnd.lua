...
---
local TlRangeBeginEnd = {}
local new_mt = UintABC.new_mt({NAME = "TlRangeBeginEnd", ID = data_types.name_to_id_map["Uint16"]}, 2)
setmetatable(TlRangeBeginEnd, new_mt)
return TlRangeBeginEnd
