...
--- @alias ScheduleProgrammingVisibility
---
--- @field public ID number 0x0002 the ID of this attribute
--- @field public NAME string "ScheduleProgrammingVisibility" the name of this attribute
--- @field public data_type st.zigbee.data_types.Enum8 the data type of this attribute
--- @field public LOCAL_ENABLED number 0
--- @field public LOCAL_DISABLED number 1
local ScheduleProgrammingVisibility = {
  ID = 0x0002,
  NAME = "ScheduleProgrammingVisibility",
  base_type = data_types.Enum8,
}

ScheduleProgrammingVisibility.LOCAL_ENABLED  = 0x00
ScheduleProgrammingVisibility.LOCAL_DISABLED = 0x01


ScheduleProgrammingVisibility.enum_fields = {
    [ScheduleProgrammingVisibility.LOCAL_ENABLED]  = "LOCAL_ENABLED",
    [ScheduleProgrammingVisibility.LOCAL_DISABLED] = "LOCAL_DISABLED",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.zigbee.data_types.Enum8 the base data type object to add functionality to
function ScheduleProgrammingVisibility:augment_type(base_type_obj)
...
function ScheduleProgrammingVisibility.pretty_print(value_obj)
  return string.format("%s: %s[%s]", value_obj.field_name or value_obj.NAME, ScheduleProgrammingVisibility.NAME, ScheduleProgrammingVisibility.enum_fields[value_obj.value])
end

--- @function ScheduleProgrammingVisibility:build_test_attr_report
---
...
ScheduleProgrammingVisibility.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ScheduleProgrammingVisibility:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Enum8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ScheduleProgrammingVisibility.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ScheduleProgrammingVisibility:new_value(...)
...
function ScheduleProgrammingVisibility:read(device)
...
function ScheduleProgrammingVisibility:configure_reporting(device, min_rep_int, max_rep_int)
...
function ScheduleProgrammingVisibility:write(device, value)
...
function ScheduleProgrammingVisibility:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ScheduleProgrammingVisibility, {__call = ScheduleProgrammingVisibility.new_value})
