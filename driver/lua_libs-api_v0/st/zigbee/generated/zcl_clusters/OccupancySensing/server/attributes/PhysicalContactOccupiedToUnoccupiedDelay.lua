...
--- @alias PhysicalContactOccupiedToUnoccupiedDelay
---
--- @field public ID number 0x0030 the ID of this attribute
--- @field public NAME string "PhysicalContactOccupiedToUnoccupiedDelay" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PhysicalContactOccupiedToUnoccupiedDelay = {
  ID = 0x0030,
  NAME = "PhysicalContactOccupiedToUnoccupiedDelay",
  base_type = data_types.Uint16,
}

function PhysicalContactOccupiedToUnoccupiedDelay:augment_type(base_type_obj)
...
function PhysicalContactOccupiedToUnoccupiedDelay.pretty_print(value_obj)
  PhysicalContactOccupiedToUnoccupiedDelay.base_type.pretty_print(value_obj)
end

--- @function PhysicalContactOccupiedToUnoccupiedDelay:build_test_attr_report
---
...
PhysicalContactOccupiedToUnoccupiedDelay.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PhysicalContactOccupiedToUnoccupiedDelay:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PhysicalContactOccupiedToUnoccupiedDelay.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PhysicalContactOccupiedToUnoccupiedDelay:new_value(...)
...
function PhysicalContactOccupiedToUnoccupiedDelay:read(device)
...
function PhysicalContactOccupiedToUnoccupiedDelay:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PhysicalContactOccupiedToUnoccupiedDelay:write(device, value)
...
function PhysicalContactOccupiedToUnoccupiedDelay:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PhysicalContactOccupiedToUnoccupiedDelay, {__call = PhysicalContactOccupiedToUnoccupiedDelay.new_value})
