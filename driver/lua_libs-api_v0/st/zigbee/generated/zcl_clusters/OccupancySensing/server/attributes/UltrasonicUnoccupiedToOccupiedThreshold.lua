...
--- @alias UltrasonicUnoccupiedToOccupiedThreshold
---
--- @field public ID number 0x0022 the ID of this attribute
--- @field public NAME string "UltrasonicUnoccupiedToOccupiedThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local UltrasonicUnoccupiedToOccupiedThreshold = {
  ID = 0x0022,
  NAME = "UltrasonicUnoccupiedToOccupiedThreshold",
  base_type = data_types.Uint8,
}

function UltrasonicUnoccupiedToOccupiedThreshold:augment_type(base_type_obj)
...
function UltrasonicUnoccupiedToOccupiedThreshold.pretty_print(value_obj)
  UltrasonicUnoccupiedToOccupiedThreshold.base_type.pretty_print(value_obj)
end

--- @function UltrasonicUnoccupiedToOccupiedThreshold:build_test_attr_report
---
...
UltrasonicUnoccupiedToOccupiedThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UltrasonicUnoccupiedToOccupiedThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UltrasonicUnoccupiedToOccupiedThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UltrasonicUnoccupiedToOccupiedThreshold:new_value(...)
...
function UltrasonicUnoccupiedToOccupiedThreshold:read(device)
...
function UltrasonicUnoccupiedToOccupiedThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function UltrasonicUnoccupiedToOccupiedThreshold:write(device, value)
...
function UltrasonicUnoccupiedToOccupiedThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(UltrasonicUnoccupiedToOccupiedThreshold, {__call = UltrasonicUnoccupiedToOccupiedThreshold.new_value})
