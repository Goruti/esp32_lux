...
--- @alias UltrasonicUnoccupiedToOccupiedDelay
---
--- @field public ID number 0x0021 the ID of this attribute
--- @field public NAME string "UltrasonicUnoccupiedToOccupiedDelay" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local UltrasonicUnoccupiedToOccupiedDelay = {
  ID = 0x0021,
  NAME = "UltrasonicUnoccupiedToOccupiedDelay",
  base_type = data_types.Uint16,
}

function UltrasonicUnoccupiedToOccupiedDelay:augment_type(base_type_obj)
...
function UltrasonicUnoccupiedToOccupiedDelay.pretty_print(value_obj)
  UltrasonicUnoccupiedToOccupiedDelay.base_type.pretty_print(value_obj)
end

--- @function UltrasonicUnoccupiedToOccupiedDelay:build_test_attr_report
---
...
UltrasonicUnoccupiedToOccupiedDelay.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UltrasonicUnoccupiedToOccupiedDelay:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UltrasonicUnoccupiedToOccupiedDelay.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UltrasonicUnoccupiedToOccupiedDelay:new_value(...)
...
function UltrasonicUnoccupiedToOccupiedDelay:read(device)
...
function UltrasonicUnoccupiedToOccupiedDelay:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function UltrasonicUnoccupiedToOccupiedDelay:write(device, value)
...
function UltrasonicUnoccupiedToOccupiedDelay:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(UltrasonicUnoccupiedToOccupiedDelay, {__call = UltrasonicUnoccupiedToOccupiedDelay.new_value})
