...
--- @alias PIRUnoccupiedToOccupiedDelay
---
--- @field public ID number 0x0011 the ID of this attribute
--- @field public NAME string "PIRUnoccupiedToOccupiedDelay" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PIRUnoccupiedToOccupiedDelay = {
  ID = 0x0011,
  NAME = "PIRUnoccupiedToOccupiedDelay",
  base_type = data_types.Uint16,
}

function PIRUnoccupiedToOccupiedDelay:augment_type(base_type_obj)
...
function PIRUnoccupiedToOccupiedDelay.pretty_print(value_obj)
  PIRUnoccupiedToOccupiedDelay.base_type.pretty_print(value_obj)
end

--- @function PIRUnoccupiedToOccupiedDelay:build_test_attr_report
---
...
PIRUnoccupiedToOccupiedDelay.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PIRUnoccupiedToOccupiedDelay:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PIRUnoccupiedToOccupiedDelay.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PIRUnoccupiedToOccupiedDelay:new_value(...)
...
function PIRUnoccupiedToOccupiedDelay:read(device)
...
function PIRUnoccupiedToOccupiedDelay:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PIRUnoccupiedToOccupiedDelay:write(device, value)
...
function PIRUnoccupiedToOccupiedDelay:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PIRUnoccupiedToOccupiedDelay, {__call = PIRUnoccupiedToOccupiedDelay.new_value})
