...
--- @alias PIRUnoccupiedToOccupiedThreshold
---
--- @field public ID number 0x0012 the ID of this attribute
--- @field public NAME string "PIRUnoccupiedToOccupiedThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local PIRUnoccupiedToOccupiedThreshold = {
  ID = 0x0012,
  NAME = "PIRUnoccupiedToOccupiedThreshold",
  base_type = data_types.Uint8,
}

function PIRUnoccupiedToOccupiedThreshold:augment_type(base_type_obj)
...
function PIRUnoccupiedToOccupiedThreshold.pretty_print(value_obj)
  PIRUnoccupiedToOccupiedThreshold.base_type.pretty_print(value_obj)
end

--- @function PIRUnoccupiedToOccupiedThreshold:build_test_attr_report
---
...
PIRUnoccupiedToOccupiedThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PIRUnoccupiedToOccupiedThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PIRUnoccupiedToOccupiedThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PIRUnoccupiedToOccupiedThreshold:new_value(...)
...
function PIRUnoccupiedToOccupiedThreshold:read(device)
...
function PIRUnoccupiedToOccupiedThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PIRUnoccupiedToOccupiedThreshold:write(device, value)
...
function PIRUnoccupiedToOccupiedThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PIRUnoccupiedToOccupiedThreshold, {__call = PIRUnoccupiedToOccupiedThreshold.new_value})
