...
--- @alias PhysicalContactUnoccupiedToOccupiedDelay
---
--- @field public ID number 0x0031 the ID of this attribute
--- @field public NAME string "PhysicalContactUnoccupiedToOccupiedDelay" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PhysicalContactUnoccupiedToOccupiedDelay = {
  ID = 0x0031,
  NAME = "PhysicalContactUnoccupiedToOccupiedDelay",
  base_type = data_types.Uint16,
}

function PhysicalContactUnoccupiedToOccupiedDelay:augment_type(base_type_obj)
...
function PhysicalContactUnoccupiedToOccupiedDelay.pretty_print(value_obj)
  PhysicalContactUnoccupiedToOccupiedDelay.base_type.pretty_print(value_obj)
end

--- @function PhysicalContactUnoccupiedToOccupiedDelay:build_test_attr_report
---
...
PhysicalContactUnoccupiedToOccupiedDelay.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PhysicalContactUnoccupiedToOccupiedDelay:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PhysicalContactUnoccupiedToOccupiedDelay.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PhysicalContactUnoccupiedToOccupiedDelay:new_value(...)
...
function PhysicalContactUnoccupiedToOccupiedDelay:read(device)
...
function PhysicalContactUnoccupiedToOccupiedDelay:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PhysicalContactUnoccupiedToOccupiedDelay:write(device, value)
...
function PhysicalContactUnoccupiedToOccupiedDelay:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PhysicalContactUnoccupiedToOccupiedDelay, {__call = PhysicalContactUnoccupiedToOccupiedDelay.new_value})
