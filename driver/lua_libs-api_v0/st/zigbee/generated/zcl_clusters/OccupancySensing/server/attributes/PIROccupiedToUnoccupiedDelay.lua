...
--- @alias PIROccupiedToUnoccupiedDelay
---
--- @field public ID number 0x0010 the ID of this attribute
--- @field public NAME string "PIROccupiedToUnoccupiedDelay" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PIROccupiedToUnoccupiedDelay = {
  ID = 0x0010,
  NAME = "PIROccupiedToUnoccupiedDelay",
  base_type = data_types.Uint16,
}

function PIROccupiedToUnoccupiedDelay:augment_type(base_type_obj)
...
function PIROccupiedToUnoccupiedDelay.pretty_print(value_obj)
  PIROccupiedToUnoccupiedDelay.base_type.pretty_print(value_obj)
end

--- @function PIROccupiedToUnoccupiedDelay:build_test_attr_report
---
...
PIROccupiedToUnoccupiedDelay.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PIROccupiedToUnoccupiedDelay:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PIROccupiedToUnoccupiedDelay.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PIROccupiedToUnoccupiedDelay:new_value(...)
...
function PIROccupiedToUnoccupiedDelay:read(device)
...
function PIROccupiedToUnoccupiedDelay:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PIROccupiedToUnoccupiedDelay:write(device, value)
...
function PIROccupiedToUnoccupiedDelay:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PIROccupiedToUnoccupiedDelay, {__call = PIROccupiedToUnoccupiedDelay.new_value})
