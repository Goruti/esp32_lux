...
--- @alias PhysicalContactUnoccupiedToOccupiedThreshold
---
--- @field public ID number 0x0032 the ID of this attribute
--- @field public NAME string "PhysicalContactUnoccupiedToOccupiedThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local PhysicalContactUnoccupiedToOccupiedThreshold = {
  ID = 0x0032,
  NAME = "PhysicalContactUnoccupiedToOccupiedThreshold",
  base_type = data_types.Uint8,
}

function PhysicalContactUnoccupiedToOccupiedThreshold:augment_type(base_type_obj)
...
function PhysicalContactUnoccupiedToOccupiedThreshold.pretty_print(value_obj)
  PhysicalContactUnoccupiedToOccupiedThreshold.base_type.pretty_print(value_obj)
end

--- @function PhysicalContactUnoccupiedToOccupiedThreshold:build_test_attr_report
---
...
PhysicalContactUnoccupiedToOccupiedThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PhysicalContactUnoccupiedToOccupiedThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PhysicalContactUnoccupiedToOccupiedThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PhysicalContactUnoccupiedToOccupiedThreshold:new_value(...)
...
function PhysicalContactUnoccupiedToOccupiedThreshold:read(device)
...
function PhysicalContactUnoccupiedToOccupiedThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PhysicalContactUnoccupiedToOccupiedThreshold:write(device, value)
...
function PhysicalContactUnoccupiedToOccupiedThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PhysicalContactUnoccupiedToOccupiedThreshold, {__call = PhysicalContactUnoccupiedToOccupiedThreshold.new_value})
