...
--- @alias UltrasonicOccupiedToUnoccupiedDelay
---
--- @field public ID number 0x0020 the ID of this attribute
--- @field public NAME string "UltrasonicOccupiedToUnoccupiedDelay" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local UltrasonicOccupiedToUnoccupiedDelay = {
  ID = 0x0020,
  NAME = "UltrasonicOccupiedToUnoccupiedDelay",
  base_type = data_types.Uint16,
}

function UltrasonicOccupiedToUnoccupiedDelay:augment_type(base_type_obj)
...
function UltrasonicOccupiedToUnoccupiedDelay.pretty_print(value_obj)
  UltrasonicOccupiedToUnoccupiedDelay.base_type.pretty_print(value_obj)
end

--- @function UltrasonicOccupiedToUnoccupiedDelay:build_test_attr_report
---
...
UltrasonicOccupiedToUnoccupiedDelay.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UltrasonicOccupiedToUnoccupiedDelay:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UltrasonicOccupiedToUnoccupiedDelay.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UltrasonicOccupiedToUnoccupiedDelay:new_value(...)
...
function UltrasonicOccupiedToUnoccupiedDelay:read(device)
...
function UltrasonicOccupiedToUnoccupiedDelay:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function UltrasonicOccupiedToUnoccupiedDelay:write(device, value)
...
function UltrasonicOccupiedToUnoccupiedDelay:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(UltrasonicOccupiedToUnoccupiedDelay, {__call = UltrasonicOccupiedToUnoccupiedDelay.new_value})
