...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery2AHrRating
--- @alias Battery2AHrRating
---
--- @field public ID number 0x0052 the ID of this attribute
--- @field public NAME string "Battery2AHrRating" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local Battery2AHrRating = {
  ID = 0x0052,
  NAME = "Battery2AHrRating",
  base_type = data_types.Uint16,
}

function Battery2AHrRating:augment_type(base_type_obj)
...
function Battery2AHrRating.pretty_print(value_obj)
  Battery2AHrRating.base_type.pretty_print(value_obj)
end

--- @function Battery2AHrRating:build_test_attr_report
---
...
Battery2AHrRating.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery2AHrRating:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery2AHrRating.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery2AHrRating(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function Battery2AHrRating:new_value(...)
...
function Battery2AHrRating:read(device)
...
function Battery2AHrRating:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery2AHrRating:write(device, value)
...
function Battery2AHrRating:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery2AHrRating, {__call = Battery2AHrRating.new_value})
