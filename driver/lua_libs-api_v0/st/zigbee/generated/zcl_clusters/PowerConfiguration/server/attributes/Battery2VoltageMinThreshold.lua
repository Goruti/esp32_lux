...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery2VoltageMinThreshold
--- @alias Battery2VoltageMinThreshold
---
--- @field public ID number 0x0056 the ID of this attribute
--- @field public NAME string "Battery2VoltageMinThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery2VoltageMinThreshold = {
  ID = 0x0056,
  NAME = "Battery2VoltageMinThreshold",
  base_type = data_types.Uint8,
}

function Battery2VoltageMinThreshold:augment_type(base_type_obj)
...
function Battery2VoltageMinThreshold.pretty_print(value_obj)
  Battery2VoltageMinThreshold.base_type.pretty_print(value_obj)
end

--- @function Battery2VoltageMinThreshold:build_test_attr_report
---
...
Battery2VoltageMinThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery2VoltageMinThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery2VoltageMinThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery2VoltageMinThreshold(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery2VoltageMinThreshold:new_value(...)
...
function Battery2VoltageMinThreshold:read(device)
...
function Battery2VoltageMinThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery2VoltageMinThreshold:write(device, value)
...
function Battery2VoltageMinThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery2VoltageMinThreshold, {__call = Battery2VoltageMinThreshold.new_value})
