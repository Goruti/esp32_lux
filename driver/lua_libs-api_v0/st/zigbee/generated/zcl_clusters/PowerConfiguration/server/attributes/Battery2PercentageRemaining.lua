...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery2PercentageRemaining
--- @alias Battery2PercentageRemaining
---
--- @field public ID number 0x0041 the ID of this attribute
--- @field public NAME string "Battery2PercentageRemaining" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery2PercentageRemaining = {
  ID = 0x0041,
  NAME = "Battery2PercentageRemaining",
  base_type = data_types.Uint8,
}

function Battery2PercentageRemaining:augment_type(base_type_obj)
...
function Battery2PercentageRemaining.pretty_print(value_obj)
  Battery2PercentageRemaining.base_type.pretty_print(value_obj)
end

--- @function Battery2PercentageRemaining:build_test_attr_report
---
...
Battery2PercentageRemaining.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery2PercentageRemaining:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery2PercentageRemaining.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery2PercentageRemaining(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery2PercentageRemaining:new_value(...)
...
function Battery2PercentageRemaining:read(device)
...
function Battery2PercentageRemaining:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery2PercentageRemaining:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery2PercentageRemaining, {__call = Battery2PercentageRemaining.new_value})
