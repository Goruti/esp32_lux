...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.MainsVoltageMinThreshold
--- @alias MainsVoltageMinThreshold
---
--- @field public ID number 0x0011 the ID of this attribute
--- @field public NAME string "MainsVoltageMinThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local MainsVoltageMinThreshold = {
  ID = 0x0011,
  NAME = "MainsVoltageMinThreshold",
  base_type = data_types.Uint16,
}

function MainsVoltageMinThreshold:augment_type(base_type_obj)
...
function MainsVoltageMinThreshold.pretty_print(value_obj)
  MainsVoltageMinThreshold.base_type.pretty_print(value_obj)
end

--- @function MainsVoltageMinThreshold:build_test_attr_report
---
...
MainsVoltageMinThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MainsVoltageMinThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MainsVoltageMinThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MainsVoltageMinThreshold(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function MainsVoltageMinThreshold:new_value(...)
...
function MainsVoltageMinThreshold:read(device)
...
function MainsVoltageMinThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MainsVoltageMinThreshold:write(device, value)
...
function MainsVoltageMinThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MainsVoltageMinThreshold, {__call = MainsVoltageMinThreshold.new_value})
