...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery3AHrRating
--- @alias Battery3AHrRating
---
--- @field public ID number 0x0072 the ID of this attribute
--- @field public NAME string "Battery3AHrRating" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local Battery3AHrRating = {
  ID = 0x0072,
  NAME = "Battery3AHrRating",
  base_type = data_types.Uint16,
}

function Battery3AHrRating:augment_type(base_type_obj)
...
function Battery3AHrRating.pretty_print(value_obj)
  Battery3AHrRating.base_type.pretty_print(value_obj)
end

--- @function Battery3AHrRating:build_test_attr_report
---
...
Battery3AHrRating.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery3AHrRating:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery3AHrRating.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery3AHrRating(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function Battery3AHrRating:new_value(...)
...
function Battery3AHrRating:read(device)
...
function Battery3AHrRating:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery3AHrRating:write(device, value)
...
function Battery3AHrRating:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery3AHrRating, {__call = Battery3AHrRating.new_value})
