...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.BatteryVoltage
--- @alias BatteryVoltage
---
--- @field public ID number 0x0020 the ID of this attribute
--- @field public NAME string "BatteryVoltage" the name of this attribute
...
function BatteryVoltage:augment_type(base_type_obj)
...
function BatteryVoltage.pretty_print(value_obj)
  BatteryVoltage.base_type.pretty_print(value_obj)
end

--- @function BatteryVoltage:build_test_attr_report
---
...
BatteryVoltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BatteryVoltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BatteryVoltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the BatteryVoltage(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function BatteryVoltage:new_value(...)
...
function BatteryVoltage:read(device)
...
function BatteryVoltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BatteryVoltage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BatteryVoltage, {__call = BatteryVoltage.new_value})
