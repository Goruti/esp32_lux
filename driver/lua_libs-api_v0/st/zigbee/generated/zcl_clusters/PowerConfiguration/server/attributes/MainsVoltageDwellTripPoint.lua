...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.MainsVoltageDwellTripPoint
--- @alias MainsVoltageDwellTripPoint
---
--- @field public ID number 0x0013 the ID of this attribute
--- @field public NAME string "MainsVoltageDwellTripPoint" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local MainsVoltageDwellTripPoint = {
  ID = 0x0013,
  NAME = "MainsVoltageDwellTripPoint",
  base_type = data_types.Uint16,
}

function MainsVoltageDwellTripPoint:augment_type(base_type_obj)
...
function MainsVoltageDwellTripPoint.pretty_print(value_obj)
  MainsVoltageDwellTripPoint.base_type.pretty_print(value_obj)
end

--- @function MainsVoltageDwellTripPoint:build_test_attr_report
---
...
MainsVoltageDwellTripPoint.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MainsVoltageDwellTripPoint:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MainsVoltageDwellTripPoint.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MainsVoltageDwellTripPoint(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function MainsVoltageDwellTripPoint:new_value(...)
...
function MainsVoltageDwellTripPoint:read(device)
...
function MainsVoltageDwellTripPoint:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MainsVoltageDwellTripPoint:write(device, value)
...
function MainsVoltageDwellTripPoint:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MainsVoltageDwellTripPoint, {__call = MainsVoltageDwellTripPoint.new_value})
