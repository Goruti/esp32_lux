...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery2VoltageThreshold2
--- @alias Battery2VoltageThreshold2
---
--- @field public ID number 0x0058 the ID of this attribute
--- @field public NAME string "Battery2VoltageThreshold2" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery2VoltageThreshold2 = {
  ID = 0x0058,
  NAME = "Battery2VoltageThreshold2",
  base_type = data_types.Uint8,
}

function Battery2VoltageThreshold2:augment_type(base_type_obj)
...
function Battery2VoltageThreshold2.pretty_print(value_obj)
  Battery2VoltageThreshold2.base_type.pretty_print(value_obj)
end

--- @function Battery2VoltageThreshold2:build_test_attr_report
---
...
Battery2VoltageThreshold2.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery2VoltageThreshold2:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery2VoltageThreshold2.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery2VoltageThreshold2(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery2VoltageThreshold2:new_value(...)
...
function Battery2VoltageThreshold2:read(device)
...
function Battery2VoltageThreshold2:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery2VoltageThreshold2:write(device, value)
...
function Battery2VoltageThreshold2:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery2VoltageThreshold2, {__call = Battery2VoltageThreshold2.new_value})
