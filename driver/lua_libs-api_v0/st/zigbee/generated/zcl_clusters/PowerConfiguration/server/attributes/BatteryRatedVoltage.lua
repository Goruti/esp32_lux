...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.BatteryRatedVoltage
--- @alias BatteryRatedVoltage
---
--- @field public ID number 0x0034 the ID of this attribute
--- @field public NAME string "BatteryRatedVoltage" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local BatteryRatedVoltage = {
  ID = 0x0034,
  NAME = "BatteryRatedVoltage",
  base_type = data_types.Uint8,
}

function BatteryRatedVoltage:augment_type(base_type_obj)
...
function BatteryRatedVoltage.pretty_print(value_obj)
  BatteryRatedVoltage.base_type.pretty_print(value_obj)
end

--- @function BatteryRatedVoltage:build_test_attr_report
---
...
BatteryRatedVoltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BatteryRatedVoltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BatteryRatedVoltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the BatteryRatedVoltage(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function BatteryRatedVoltage:new_value(...)
...
function BatteryRatedVoltage:read(device)
...
function BatteryRatedVoltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BatteryRatedVoltage:write(device, value)
...
function BatteryRatedVoltage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BatteryRatedVoltage, {__call = BatteryRatedVoltage.new_value})
