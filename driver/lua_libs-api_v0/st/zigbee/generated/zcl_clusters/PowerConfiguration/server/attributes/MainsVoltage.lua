...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.MainsVoltage
--- @alias MainsVoltage
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "MainsVoltage" the name of this attribute
...
function MainsVoltage:augment_type(base_type_obj)
...
function MainsVoltage.pretty_print(value_obj)
  MainsVoltage.base_type.pretty_print(value_obj)
end

--- @function MainsVoltage:build_test_attr_report
---
...
MainsVoltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MainsVoltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MainsVoltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MainsVoltage(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function MainsVoltage:new_value(...)
...
function MainsVoltage:read(device)
...
function MainsVoltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MainsVoltage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MainsVoltage, {__call = MainsVoltage.new_value})
return MainsVoltage
