...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.BatteryAHrRating
--- @alias BatteryAHrRating
---
--- @field public ID number 0x0032 the ID of this attribute
--- @field public NAME string "BatteryAHrRating" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local BatteryAHrRating = {
  ID = 0x0032,
  NAME = "BatteryAHrRating",
  base_type = data_types.Uint16,
}

function BatteryAHrRating:augment_type(base_type_obj)
...
function BatteryAHrRating.pretty_print(value_obj)
  BatteryAHrRating.base_type.pretty_print(value_obj)
end

--- @function BatteryAHrRating:build_test_attr_report
---
...
BatteryAHrRating.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BatteryAHrRating:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BatteryAHrRating.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the BatteryAHrRating(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function BatteryAHrRating:new_value(...)
...
function BatteryAHrRating:read(device)
...
function BatteryAHrRating:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BatteryAHrRating:write(device, value)
...
function BatteryAHrRating:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BatteryAHrRating, {__call = BatteryAHrRating.new_value})
