...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.BatteryPercentageRemaining
--- @alias BatteryPercentageRemaining
---
--- @field public ID number 0x0021 the ID of this attribute
--- @field public NAME string "BatteryPercentageRemaining" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local BatteryPercentageRemaining = {
  ID = 0x0021,
  NAME = "BatteryPercentageRemaining",
  base_type = data_types.Uint8,
}

function BatteryPercentageRemaining:augment_type(base_type_obj)
...
function BatteryPercentageRemaining.pretty_print(value_obj)
  BatteryPercentageRemaining.base_type.pretty_print(value_obj)
end

--- @function BatteryPercentageRemaining:build_test_attr_report
---
...
BatteryPercentageRemaining.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BatteryPercentageRemaining:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BatteryPercentageRemaining.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the BatteryPercentageRemaining(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function BatteryPercentageRemaining:new_value(...)
...
function BatteryPercentageRemaining:read(device)
...
function BatteryPercentageRemaining:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BatteryPercentageRemaining:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BatteryPercentageRemaining, {__call = BatteryPercentageRemaining.new_value})
