...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.BatteryVoltageMinThreshold
--- @alias BatteryVoltageMinThreshold
---
--- @field public ID number 0x0036 the ID of this attribute
--- @field public NAME string "BatteryVoltageMinThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local BatteryVoltageMinThreshold = {
  ID = 0x0036,
  NAME = "BatteryVoltageMinThreshold",
  base_type = data_types.Uint8,
}

function BatteryVoltageMinThreshold:augment_type(base_type_obj)
...
function BatteryVoltageMinThreshold.pretty_print(value_obj)
  BatteryVoltageMinThreshold.base_type.pretty_print(value_obj)
end

--- @function BatteryVoltageMinThreshold:build_test_attr_report
---
...
BatteryVoltageMinThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BatteryVoltageMinThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BatteryVoltageMinThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the BatteryVoltageMinThreshold(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function BatteryVoltageMinThreshold:new_value(...)
...
function BatteryVoltageMinThreshold:read(device)
...
function BatteryVoltageMinThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BatteryVoltageMinThreshold:write(device, value)
...
function BatteryVoltageMinThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BatteryVoltageMinThreshold, {__call = BatteryVoltageMinThreshold.new_value})
