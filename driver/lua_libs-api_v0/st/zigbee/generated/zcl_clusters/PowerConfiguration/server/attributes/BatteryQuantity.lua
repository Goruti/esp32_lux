...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.BatteryQuantity
--- @alias BatteryQuantity
---
--- @field public ID number 0x0033 the ID of this attribute
--- @field public NAME string "BatteryQuantity" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local BatteryQuantity = {
  ID = 0x0033,
  NAME = "BatteryQuantity",
  base_type = data_types.Uint8,
}

function BatteryQuantity:augment_type(base_type_obj)
...
function BatteryQuantity.pretty_print(value_obj)
  BatteryQuantity.base_type.pretty_print(value_obj)
end

--- @function BatteryQuantity:build_test_attr_report
---
...
BatteryQuantity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BatteryQuantity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BatteryQuantity.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the BatteryQuantity(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function BatteryQuantity:new_value(...)
...
function BatteryQuantity:read(device)
...
function BatteryQuantity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BatteryQuantity:write(device, value)
...
function BatteryQuantity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BatteryQuantity, {__call = BatteryQuantity.new_value})
