...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery3PercentageThreshold2
--- @alias Battery3PercentageThreshold2
---
--- @field public ID number 0x007C the ID of this attribute
--- @field public NAME string "Battery3PercentageThreshold2" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery3PercentageThreshold2 = {
  ID = 0x007C,
  NAME = "Battery3PercentageThreshold2",
  base_type = data_types.Uint8,
}

function Battery3PercentageThreshold2:augment_type(base_type_obj)
...
function Battery3PercentageThreshold2.pretty_print(value_obj)
  Battery3PercentageThreshold2.base_type.pretty_print(value_obj)
end

--- @function Battery3PercentageThreshold2:build_test_attr_report
---
...
Battery3PercentageThreshold2.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery3PercentageThreshold2:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery3PercentageThreshold2.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery3PercentageThreshold2(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery3PercentageThreshold2:new_value(...)
...
function Battery3PercentageThreshold2:read(device)
...
function Battery3PercentageThreshold2:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery3PercentageThreshold2:write(device, value)
...
function Battery3PercentageThreshold2:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery3PercentageThreshold2, {__call = Battery3PercentageThreshold2.new_value})
