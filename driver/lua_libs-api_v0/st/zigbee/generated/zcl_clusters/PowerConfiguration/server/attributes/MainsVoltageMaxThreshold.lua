...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.MainsVoltageMaxThreshold
--- @alias MainsVoltageMaxThreshold
---
--- @field public ID number 0x0012 the ID of this attribute
--- @field public NAME string "MainsVoltageMaxThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local MainsVoltageMaxThreshold = {
  ID = 0x0012,
  NAME = "MainsVoltageMaxThreshold",
  base_type = data_types.Uint16,
}

function MainsVoltageMaxThreshold:augment_type(base_type_obj)
...
function MainsVoltageMaxThreshold.pretty_print(value_obj)
  MainsVoltageMaxThreshold.base_type.pretty_print(value_obj)
end

--- @function MainsVoltageMaxThreshold:build_test_attr_report
---
...
MainsVoltageMaxThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MainsVoltageMaxThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MainsVoltageMaxThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MainsVoltageMaxThreshold(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function MainsVoltageMaxThreshold:new_value(...)
...
function MainsVoltageMaxThreshold:read(device)
...
function MainsVoltageMaxThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MainsVoltageMaxThreshold:write(device, value)
...
function MainsVoltageMaxThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MainsVoltageMaxThreshold, {__call = MainsVoltageMaxThreshold.new_value})
