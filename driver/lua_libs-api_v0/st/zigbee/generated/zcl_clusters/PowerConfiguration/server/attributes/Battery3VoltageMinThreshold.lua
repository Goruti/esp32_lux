...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery3VoltageMinThreshold
--- @alias Battery3VoltageMinThreshold
---
--- @field public ID number 0x0076 the ID of this attribute
--- @field public NAME string "Battery3VoltageMinThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery3VoltageMinThreshold = {
  ID = 0x0076,
  NAME = "Battery3VoltageMinThreshold",
  base_type = data_types.Uint8,
}

function Battery3VoltageMinThreshold:augment_type(base_type_obj)
...
function Battery3VoltageMinThreshold.pretty_print(value_obj)
  Battery3VoltageMinThreshold.base_type.pretty_print(value_obj)
end

--- @function Battery3VoltageMinThreshold:build_test_attr_report
---
...
Battery3VoltageMinThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery3VoltageMinThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery3VoltageMinThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery3VoltageMinThreshold(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery3VoltageMinThreshold:new_value(...)
...
function Battery3VoltageMinThreshold:read(device)
...
function Battery3VoltageMinThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery3VoltageMinThreshold:write(device, value)
...
function Battery3VoltageMinThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery3VoltageMinThreshold, {__call = Battery3VoltageMinThreshold.new_value})
