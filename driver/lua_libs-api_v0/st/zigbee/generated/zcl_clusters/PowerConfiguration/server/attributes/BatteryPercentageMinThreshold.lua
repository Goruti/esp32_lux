...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.BatteryPercentageMinThreshold
--- @alias BatteryPercentageMinThreshold
---
--- @field public ID number 0x003A the ID of this attribute
--- @field public NAME string "BatteryPercentageMinThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local BatteryPercentageMinThreshold = {
  ID = 0x003A,
  NAME = "BatteryPercentageMinThreshold",
  base_type = data_types.Uint8,
}

function BatteryPercentageMinThreshold:augment_type(base_type_obj)
...
function BatteryPercentageMinThreshold.pretty_print(value_obj)
  BatteryPercentageMinThreshold.base_type.pretty_print(value_obj)
end

--- @function BatteryPercentageMinThreshold:build_test_attr_report
---
...
BatteryPercentageMinThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BatteryPercentageMinThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BatteryPercentageMinThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the BatteryPercentageMinThreshold(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function BatteryPercentageMinThreshold:new_value(...)
...
function BatteryPercentageMinThreshold:read(device)
...
function BatteryPercentageMinThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BatteryPercentageMinThreshold:write(device, value)
...
function BatteryPercentageMinThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BatteryPercentageMinThreshold, {__call = BatteryPercentageMinThreshold.new_value})
