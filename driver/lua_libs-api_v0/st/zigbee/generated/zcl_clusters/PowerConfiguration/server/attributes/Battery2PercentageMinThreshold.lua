...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery2PercentageMinThreshold
--- @alias Battery2PercentageMinThreshold
---
--- @field public ID number 0x005A the ID of this attribute
--- @field public NAME string "Battery2PercentageMinThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery2PercentageMinThreshold = {
  ID = 0x005A,
  NAME = "Battery2PercentageMinThreshold",
  base_type = data_types.Uint8,
}

function Battery2PercentageMinThreshold:augment_type(base_type_obj)
...
function Battery2PercentageMinThreshold.pretty_print(value_obj)
  Battery2PercentageMinThreshold.base_type.pretty_print(value_obj)
end

--- @function Battery2PercentageMinThreshold:build_test_attr_report
---
...
Battery2PercentageMinThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery2PercentageMinThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery2PercentageMinThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery2PercentageMinThreshold(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery2PercentageMinThreshold:new_value(...)
...
function Battery2PercentageMinThreshold:read(device)
...
function Battery2PercentageMinThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery2PercentageMinThreshold:write(device, value)
...
function Battery2PercentageMinThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery2PercentageMinThreshold, {__call = Battery2PercentageMinThreshold.new_value})
