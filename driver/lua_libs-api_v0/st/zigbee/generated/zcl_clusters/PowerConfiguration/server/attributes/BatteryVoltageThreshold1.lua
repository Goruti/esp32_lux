...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.BatteryVoltageThreshold1
--- @alias BatteryVoltageThreshold1
---
--- @field public ID number 0x0037 the ID of this attribute
--- @field public NAME string "BatteryVoltageThreshold1" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local BatteryVoltageThreshold1 = {
  ID = 0x0037,
  NAME = "BatteryVoltageThreshold1",
  base_type = data_types.Uint8,
}

function BatteryVoltageThreshold1:augment_type(base_type_obj)
...
function BatteryVoltageThreshold1.pretty_print(value_obj)
  BatteryVoltageThreshold1.base_type.pretty_print(value_obj)
end

--- @function BatteryVoltageThreshold1:build_test_attr_report
---
...
BatteryVoltageThreshold1.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BatteryVoltageThreshold1:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BatteryVoltageThreshold1.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the BatteryVoltageThreshold1(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function BatteryVoltageThreshold1:new_value(...)
...
function BatteryVoltageThreshold1:read(device)
...
function BatteryVoltageThreshold1:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BatteryVoltageThreshold1:write(device, value)
...
function BatteryVoltageThreshold1:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BatteryVoltageThreshold1, {__call = BatteryVoltageThreshold1.new_value})
