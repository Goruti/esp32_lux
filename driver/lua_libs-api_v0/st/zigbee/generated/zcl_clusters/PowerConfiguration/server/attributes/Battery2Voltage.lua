...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery2Voltage
--- @alias Battery2Voltage
---
--- @field public ID number 0x0040 the ID of this attribute
--- @field public NAME string "Battery2Voltage" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery2Voltage = {
  ID = 0x0040,
  NAME = "Battery2Voltage",
  base_type = data_types.Uint8,
}

function Battery2Voltage:augment_type(base_type_obj)
...
function Battery2Voltage.pretty_print(value_obj)
  Battery2Voltage.base_type.pretty_print(value_obj)
end

--- @function Battery2Voltage:build_test_attr_report
---
...
Battery2Voltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery2Voltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery2Voltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery2Voltage(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery2Voltage:new_value(...)
...
function Battery2Voltage:read(device)
...
function Battery2Voltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery2Voltage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery2Voltage, {__call = Battery2Voltage.new_value})
