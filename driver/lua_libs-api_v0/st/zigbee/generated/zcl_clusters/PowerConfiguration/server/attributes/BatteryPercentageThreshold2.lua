...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.BatteryPercentageThreshold2
--- @alias BatteryPercentageThreshold2
---
--- @field public ID number 0x003C the ID of this attribute
--- @field public NAME string "BatteryPercentageThreshold2" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local BatteryPercentageThreshold2 = {
  ID = 0x003C,
  NAME = "BatteryPercentageThreshold2",
  base_type = data_types.Uint8,
}

function BatteryPercentageThreshold2:augment_type(base_type_obj)
...
function BatteryPercentageThreshold2.pretty_print(value_obj)
  BatteryPercentageThreshold2.base_type.pretty_print(value_obj)
end

--- @function BatteryPercentageThreshold2:build_test_attr_report
---
...
BatteryPercentageThreshold2.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BatteryPercentageThreshold2:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BatteryPercentageThreshold2.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the BatteryPercentageThreshold2(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function BatteryPercentageThreshold2:new_value(...)
...
function BatteryPercentageThreshold2:read(device)
...
function BatteryPercentageThreshold2:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BatteryPercentageThreshold2:write(device, value)
...
function BatteryPercentageThreshold2:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BatteryPercentageThreshold2, {__call = BatteryPercentageThreshold2.new_value})
