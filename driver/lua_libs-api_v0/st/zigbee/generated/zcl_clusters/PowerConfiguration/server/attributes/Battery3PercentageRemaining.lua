...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery3PercentageRemaining
--- @alias Battery3PercentageRemaining
---
--- @field public ID number 0x0061 the ID of this attribute
--- @field public NAME string "Battery3PercentageRemaining" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery3PercentageRemaining = {
  ID = 0x0061,
  NAME = "Battery3PercentageRemaining",
  base_type = data_types.Uint8,
}

function Battery3PercentageRemaining:augment_type(base_type_obj)
...
function Battery3PercentageRemaining.pretty_print(value_obj)
  Battery3PercentageRemaining.base_type.pretty_print(value_obj)
end

--- @function Battery3PercentageRemaining:build_test_attr_report
---
...
Battery3PercentageRemaining.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery3PercentageRemaining:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery3PercentageRemaining.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery3PercentageRemaining(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery3PercentageRemaining:new_value(...)
...
function Battery3PercentageRemaining:read(device)
...
function Battery3PercentageRemaining:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery3PercentageRemaining:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery3PercentageRemaining, {__call = Battery3PercentageRemaining.new_value})
