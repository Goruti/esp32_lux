...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery3RatedVoltage
--- @alias Battery3RatedVoltage
---
--- @field public ID number 0x0074 the ID of this attribute
--- @field public NAME string "Battery3RatedVoltage" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery3RatedVoltage = {
  ID = 0x0074,
  NAME = "Battery3RatedVoltage",
  base_type = data_types.Uint8,
}

function Battery3RatedVoltage:augment_type(base_type_obj)
...
function Battery3RatedVoltage.pretty_print(value_obj)
  Battery3RatedVoltage.base_type.pretty_print(value_obj)
end

--- @function Battery3RatedVoltage:build_test_attr_report
---
...
Battery3RatedVoltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery3RatedVoltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery3RatedVoltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery3RatedVoltage(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery3RatedVoltage:new_value(...)
...
function Battery3RatedVoltage:read(device)
...
function Battery3RatedVoltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery3RatedVoltage:write(device, value)
...
function Battery3RatedVoltage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery3RatedVoltage, {__call = Battery3RatedVoltage.new_value})
