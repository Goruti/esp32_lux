...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery2VoltageThreshold3
--- @alias Battery2VoltageThreshold3
---
--- @field public ID number 0x0059 the ID of this attribute
--- @field public NAME string "Battery2VoltageThreshold3" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery2VoltageThreshold3 = {
  ID = 0x0059,
  NAME = "Battery2VoltageThreshold3",
  base_type = data_types.Uint8,
}

function Battery2VoltageThreshold3:augment_type(base_type_obj)
...
function Battery2VoltageThreshold3.pretty_print(value_obj)
  Battery2VoltageThreshold3.base_type.pretty_print(value_obj)
end

--- @function Battery2VoltageThreshold3:build_test_attr_report
---
...
Battery2VoltageThreshold3.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery2VoltageThreshold3:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery2VoltageThreshold3.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery2VoltageThreshold3(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery2VoltageThreshold3:new_value(...)
...
function Battery2VoltageThreshold3:read(device)
...
function Battery2VoltageThreshold3:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery2VoltageThreshold3:write(device, value)
...
function Battery2VoltageThreshold3:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery2VoltageThreshold3, {__call = Battery2VoltageThreshold3.new_value})
