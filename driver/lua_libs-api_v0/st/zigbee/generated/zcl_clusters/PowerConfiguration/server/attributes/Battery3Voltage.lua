...
--- @class st.zigbee.zcl.clusters.PowerConfiguration.Battery3Voltage
--- @alias Battery3Voltage
---
--- @field public ID number 0x0060 the ID of this attribute
--- @field public NAME string "Battery3Voltage" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local Battery3Voltage = {
  ID = 0x0060,
  NAME = "Battery3Voltage",
  base_type = data_types.Uint8,
}

function Battery3Voltage:augment_type(base_type_obj)
...
function Battery3Voltage.pretty_print(value_obj)
  Battery3Voltage.base_type.pretty_print(value_obj)
end

--- @function Battery3Voltage:build_test_attr_report
---
...
Battery3Voltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Battery3Voltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Battery3Voltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the Battery3Voltage(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function Battery3Voltage:new_value(...)
...
function Battery3Voltage:read(device)
...
function Battery3Voltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Battery3Voltage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Battery3Voltage, {__call = Battery3Voltage.new_value})
