...
---
local DrlkRfidUserId = {}
local new_mt = UintABC.new_mt({NAME = "DrlkRfidUserId", ID = data_types.name_to_id_map["Uint16"]}, 2)
setmetatable(DrlkRfidUserId, new_mt)
return DrlkRfidUserId
