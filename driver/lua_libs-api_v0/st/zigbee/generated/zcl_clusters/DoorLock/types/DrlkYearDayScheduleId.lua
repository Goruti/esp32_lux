...
---
local DrlkYearDayScheduleId = {}
local new_mt = UintABC.new_mt({NAME = "DrlkYearDayScheduleId", ID = data_types.name_to_id_map["Uint8"]}, 1)
setmetatable(DrlkYearDayScheduleId, new_mt)
return DrlkYearDayScheduleId
