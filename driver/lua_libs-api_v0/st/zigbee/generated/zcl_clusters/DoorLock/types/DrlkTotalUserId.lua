...
---
local DrlkTotalUserId = {}
local new_mt = UintABC.new_mt({NAME = "DrlkTotalUserId", ID = data_types.name_to_id_map["Uint16"]}, 2)
setmetatable(DrlkTotalUserId, new_mt)
return DrlkTotalUserId
