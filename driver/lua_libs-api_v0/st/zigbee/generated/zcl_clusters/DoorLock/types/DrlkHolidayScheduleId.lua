...
---
local DrlkHolidayScheduleId = {}
local new_mt = UintABC.new_mt({NAME = "DrlkHolidayScheduleId", ID = data_types.name_to_id_map["Uint8"]}, 1)
setmetatable(DrlkHolidayScheduleId, new_mt)
return DrlkHolidayScheduleId
