...
--- @alias MaxPINCodeLength
---
--- @field public ID number 0x0017 the ID of this attribute
--- @field public NAME string "MaxPINCodeLength" the name of this attribute
...
function MaxPINCodeLength:augment_type(base_type_obj)
...
function MaxPINCodeLength.pretty_print(value_obj)
  MaxPINCodeLength.base_type.pretty_print(value_obj)
end

--- @function MaxPINCodeLength:build_test_attr_report
---
...
MaxPINCodeLength.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxPINCodeLength:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxPINCodeLength.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxPINCodeLength:read(device)
...
function MaxPINCodeLength:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
setmetatable(MaxPINCodeLength, {__call = MaxPINCodeLength.new_value})
