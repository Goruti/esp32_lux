...
--- @alias NumberOfYearDaySchedulesSupportedPerUser
---
--- @field public ID number 0x0015 the ID of this attribute
--- @field public NAME string "NumberOfYearDaySchedulesSupportedPerUser" the name of this attribute
...
function NumberOfYearDaySchedulesSupportedPerUser:augment_type(base_type_obj)
...
function NumberOfYearDaySchedulesSupportedPerUser.pretty_print(value_obj)
  NumberOfYearDaySchedulesSupportedPerUser.base_type.pretty_print(value_obj)
end

--- @function NumberOfYearDaySchedulesSupportedPerUser:build_test_attr_report
---
...
NumberOfYearDaySchedulesSupportedPerUser.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfYearDaySchedulesSupportedPerUser:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfYearDaySchedulesSupportedPerUser.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfYearDaySchedulesSupportedPerUser:read(device)
...
function NumberOfYearDaySchedulesSupportedPerUser:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
setmetatable(NumberOfYearDaySchedulesSupportedPerUser, {__call = NumberOfYearDaySchedulesSupportedPerUser.new_value})
