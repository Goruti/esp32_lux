...
function SetYearDaySchedule.deserialize(buf)
  local out = {}
  for _, v in ipairs(SetYearDaySchedule.args_def) do
    ...
    elseif not v.optional then
      log.debug("Missing command arg " .. v.name .. " for deserializing SetYearDaySchedule")
    end
  end
  setmetatable(out, {__index = SetYearDaySchedule})
  out:set_field_names()
  return out
end
...
function SetYearDaySchedule.build_test_rx(device, schedule_id, user_id, local_start_time, local_end_time)
  ...
  for i,v in ipairs(SetYearDaySchedule.args_def) do
  ...
  setmetatable(out, {__index = SetYearDaySchedule})
  out:set_field_names()
  return SetYearDaySchedule._cluster:build_test_rx_cluster_specific_command(device, out, "server")
end
