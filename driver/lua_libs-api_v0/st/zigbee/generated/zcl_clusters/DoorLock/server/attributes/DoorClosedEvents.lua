...
function DoorClosedEvents.pretty_print(value_obj)
  DoorClosedEvents.base_type.pretty_print(value_obj)
end

--- @function DoorClosedEvents:build_test_attr_report
---
...
DoorClosedEvents.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DoorClosedEvents:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DoorClosedEvents.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DoorClosedEvents:new_value(...)
...
function DoorClosedEvents:read(device)
...
function DoorClosedEvents:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DoorClosedEvents:write(device, value)
...
function DoorClosedEvents:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DoorClosedEvents, {__call = DoorClosedEvents.new_value})
