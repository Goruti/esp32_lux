...
--- @field public data_type st.zigbee.zcl.clusters.DoorLock.types.DrlkOperatingMode the data type of this attribute
local OperatingMode = {
  ID = 0x0025,
  NAME = "OperatingMode",
  base_type = DrlkOperatingModeType,
}
...
function OperatingMode.pretty_print(value_obj)
  OperatingMode.base_type.pretty_print(value_obj)
end

--- @function OperatingMode:build_test_attr_report
---
--- Build a Rx Zigbee message as if a device reported this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.zcl.clusters.DoorLock.types.DrlkOperatingMode the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an AttributeReport body
OperatingMode.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OperatingMode:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.zcl.clusters.DoorLock.types.DrlkOperatingMode the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OperatingMode.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
--- @return st.zigbee.zcl.clusters.DoorLock.types.DrlkOperatingMode
...
function OperatingMode:read(device)
...
--- @param rep_change st.zigbee.zcl.clusters.DoorLock.types.DrlkOperatingMode The amount of change of the attribute to trigger a report
--- @return st.zigbee.ZigbeeMessageTx containing a ConfigureReporting body
function OperatingMode:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
---
--- @param device st.zigbee.Device
--- @param value st.zigbee.zcl.clusters.DoorLock.types.DrlkOperatingMode the value to write
function OperatingMode:write(device, value)
