...
--- @alias WrongCodeEntryLimit
---
--- @field public ID number 0x0030 the ID of this attribute
--- @field public NAME string "WrongCodeEntryLimit" the name of this attribute
...
function WrongCodeEntryLimit:augment_type(base_type_obj)
...
function WrongCodeEntryLimit.pretty_print(value_obj)
  WrongCodeEntryLimit.base_type.pretty_print(value_obj)
end

--- @function WrongCodeEntryLimit:build_test_attr_report
---
...
WrongCodeEntryLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function WrongCodeEntryLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
WrongCodeEntryLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function WrongCodeEntryLimit:read(device)
...
function WrongCodeEntryLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function WrongCodeEntryLimit:write(device, value)
...
setmetatable(WrongCodeEntryLimit, {__call = WrongCodeEntryLimit.new_value})
