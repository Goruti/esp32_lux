...
--- @field public NAME string "EnableLogging" the name of this attribute
...
function EnableLogging:augment_type(base_type_obj)
...
function EnableLogging.pretty_print(value_obj)
  EnableLogging.base_type.pretty_print(value_obj)
end

--- @function EnableLogging:build_test_attr_report
---
...
EnableLogging.build_test_attr_report = cluster_base.build_test_attr_report

--- @function EnableLogging:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
EnableLogging.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function EnableLogging:new_value(...)
...
function EnableLogging:read(device)
...
function EnableLogging:configure_reporting(device, min_rep_int, max_rep_int)
...
function EnableLogging:write(device, value)
...
function EnableLogging:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(EnableLogging, {__call = EnableLogging.new_value})
