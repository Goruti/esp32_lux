...
function MaxRFIDCodeLength.pretty_print(value_obj)
  MaxRFIDCodeLength.base_type.pretty_print(value_obj)
end

--- @function MaxRFIDCodeLength:build_test_attr_report
---
...
MaxRFIDCodeLength.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxRFIDCodeLength:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxRFIDCodeLength.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxRFIDCodeLength:new_value(...)
...
function MaxRFIDCodeLength:read(device)
...
function MaxRFIDCodeLength:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxRFIDCodeLength:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxRFIDCodeLength, {__call = MaxRFIDCodeLength.new_value})
