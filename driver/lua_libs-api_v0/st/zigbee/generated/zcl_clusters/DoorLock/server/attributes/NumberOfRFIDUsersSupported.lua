...
--- @alias NumberOfRFIDUsersSupported
---
--- @field public ID number 0x0013 the ID of this attribute
--- @field public NAME string "NumberOfRFIDUsersSupported" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local NumberOfRFIDUsersSupported = {
  ID = 0x0013,
  NAME = "NumberOfRFIDUsersSupported",
  base_type = data_types.Uint16,
}

function NumberOfRFIDUsersSupported:augment_type(base_type_obj)
...
function NumberOfRFIDUsersSupported.pretty_print(value_obj)
  NumberOfRFIDUsersSupported.base_type.pretty_print(value_obj)
end

--- @function NumberOfRFIDUsersSupported:build_test_attr_report
---
...
NumberOfRFIDUsersSupported.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfRFIDUsersSupported:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfRFIDUsersSupported.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfRFIDUsersSupported:new_value(...)
...
function NumberOfRFIDUsersSupported:read(device)
...
function NumberOfRFIDUsersSupported:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NumberOfRFIDUsersSupported:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NumberOfRFIDUsersSupported, {__call = NumberOfRFIDUsersSupported.new_value})
