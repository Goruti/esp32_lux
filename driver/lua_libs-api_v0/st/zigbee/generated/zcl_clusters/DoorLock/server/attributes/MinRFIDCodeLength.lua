...
function MinRFIDCodeLength.pretty_print(value_obj)
  MinRFIDCodeLength.base_type.pretty_print(value_obj)
end

--- @function MinRFIDCodeLength:build_test_attr_report
---
...
MinRFIDCodeLength.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinRFIDCodeLength:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinRFIDCodeLength.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinRFIDCodeLength:new_value(...)
...
function MinRFIDCodeLength:read(device)
...
function MinRFIDCodeLength:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinRFIDCodeLength:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinRFIDCodeLength, {__call = MinRFIDCodeLength.new_value})
