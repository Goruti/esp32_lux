...
function DoorOpenEvents.pretty_print(value_obj)
  DoorOpenEvents.base_type.pretty_print(value_obj)
end

--- @function DoorOpenEvents:build_test_attr_report
---
...
DoorOpenEvents.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DoorOpenEvents:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DoorOpenEvents.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DoorOpenEvents:new_value(...)
...
function DoorOpenEvents:read(device)
...
function DoorOpenEvents:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DoorOpenEvents:write(device, value)
...
function DoorOpenEvents:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DoorOpenEvents, {__call = DoorOpenEvents.new_value})
