...
--- @alias NumberOfPINUsersSupported
---
--- @field public ID number 0x0012 the ID of this attribute
--- @field public NAME string "NumberOfPINUsersSupported" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local NumberOfPINUsersSupported = {
  ID = 0x0012,
  NAME = "NumberOfPINUsersSupported",
  base_type = data_types.Uint16,
}

function NumberOfPINUsersSupported:augment_type(base_type_obj)
...
function NumberOfPINUsersSupported.pretty_print(value_obj)
  NumberOfPINUsersSupported.base_type.pretty_print(value_obj)
end

--- @function NumberOfPINUsersSupported:build_test_attr_report
---
...
NumberOfPINUsersSupported.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfPINUsersSupported:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfPINUsersSupported.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfPINUsersSupported:new_value(...)
...
function NumberOfPINUsersSupported:read(device)
...
function NumberOfPINUsersSupported:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NumberOfPINUsersSupported:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NumberOfPINUsersSupported, {__call = NumberOfPINUsersSupported.new_value})
