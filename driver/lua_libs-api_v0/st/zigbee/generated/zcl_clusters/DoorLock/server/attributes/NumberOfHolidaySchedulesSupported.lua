...
--- @alias NumberOfHolidaySchedulesSupported
---
--- @field public ID number 0x0016 the ID of this attribute
--- @field public NAME string "NumberOfHolidaySchedulesSupported" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local NumberOfHolidaySchedulesSupported = {
  ID = 0x0016,
  NAME = "NumberOfHolidaySchedulesSupported",
  base_type = data_types.Uint8,
}

function NumberOfHolidaySchedulesSupported:augment_type(base_type_obj)
...
function NumberOfHolidaySchedulesSupported.pretty_print(value_obj)
  NumberOfHolidaySchedulesSupported.base_type.pretty_print(value_obj)
end

--- @function NumberOfHolidaySchedulesSupported:build_test_attr_report
---
...
NumberOfHolidaySchedulesSupported.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfHolidaySchedulesSupported:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfHolidaySchedulesSupported.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfHolidaySchedulesSupported:new_value(...)
...
function NumberOfHolidaySchedulesSupported:read(device)
...
function NumberOfHolidaySchedulesSupported:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NumberOfHolidaySchedulesSupported:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NumberOfHolidaySchedulesSupported, {__call = NumberOfHolidaySchedulesSupported.new_value})
