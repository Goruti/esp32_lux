...
--- @alias SendPINOverTheAir
---
--- @field public ID number 0x0032 the ID of this attribute
--- @field public NAME string "SendPINOverTheAir" the name of this attribute
...
function SendPINOverTheAir:augment_type(base_type_obj)
...
function SendPINOverTheAir.pretty_print(value_obj)
  SendPINOverTheAir.base_type.pretty_print(value_obj)
end

--- @function SendPINOverTheAir:build_test_attr_report
---
...
SendPINOverTheAir.build_test_attr_report = cluster_base.build_test_attr_report

--- @function SendPINOverTheAir:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
SendPINOverTheAir.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function SendPINOverTheAir:read(device)
...
function SendPINOverTheAir:configure_reporting(device, min_rep_int, max_rep_int)
...
function SendPINOverTheAir:write(device, value)
...
setmetatable(SendPINOverTheAir, {__call = SendPINOverTheAir.new_value})
