...
--- @alias NumberOfWeekDaySchedulesSupportedPerUser
---
--- @field public ID number 0x0014 the ID of this attribute
--- @field public NAME string "NumberOfWeekDaySchedulesSupportedPerUser" the name of this attribute
...
function NumberOfWeekDaySchedulesSupportedPerUser:augment_type(base_type_obj)
...
function NumberOfWeekDaySchedulesSupportedPerUser.pretty_print(value_obj)
  NumberOfWeekDaySchedulesSupportedPerUser.base_type.pretty_print(value_obj)
end

--- @function NumberOfWeekDaySchedulesSupportedPerUser:build_test_attr_report
---
...
NumberOfWeekDaySchedulesSupportedPerUser.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfWeekDaySchedulesSupportedPerUser:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfWeekDaySchedulesSupportedPerUser.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfWeekDaySchedulesSupportedPerUser:read(device)
...
function NumberOfWeekDaySchedulesSupportedPerUser:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
setmetatable(NumberOfWeekDaySchedulesSupportedPerUser, {__call = NumberOfWeekDaySchedulesSupportedPerUser.new_value})
