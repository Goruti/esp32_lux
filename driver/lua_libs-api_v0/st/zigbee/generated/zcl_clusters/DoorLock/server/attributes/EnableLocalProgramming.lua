...
function EnableLocalProgramming:augment_type(base_type_obj)
...
function EnableLocalProgramming.pretty_print(value_obj)
  EnableLocalProgramming.base_type.pretty_print(value_obj)
end

--- @function EnableLocalProgramming:build_test_attr_report
---
...
EnableLocalProgramming.build_test_attr_report = cluster_base.build_test_attr_report

--- @function EnableLocalProgramming:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
EnableLocalProgramming.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function EnableLocalProgramming:read(device)
...
function EnableLocalProgramming:configure_reporting(device, min_rep_int, max_rep_int)
...
function EnableLocalProgramming:write(device, value)
