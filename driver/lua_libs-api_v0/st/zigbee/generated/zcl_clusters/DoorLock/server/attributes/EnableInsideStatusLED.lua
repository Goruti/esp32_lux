...
--- @alias EnableInsideStatusLED
---
--- @field public ID number 0x002A the ID of this attribute
--- @field public NAME string "EnableInsideStatusLED" the name of this attribute
--- @field public data_type st.zigbee.data_types.Boolean the data type of this attribute
local EnableInsideStatusLED = {
  ID = 0x002A,
  NAME = "EnableInsideStatusLED",
  base_type = data_types.Boolean,
}

function EnableInsideStatusLED:augment_type(base_type_obj)
...
function EnableInsideStatusLED.pretty_print(value_obj)
  EnableInsideStatusLED.base_type.pretty_print(value_obj)
end

--- @function EnableInsideStatusLED:build_test_attr_report
---
...
EnableInsideStatusLED.build_test_attr_report = cluster_base.build_test_attr_report

--- @function EnableInsideStatusLED:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
EnableInsideStatusLED.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function EnableInsideStatusLED:new_value(...)
...
function EnableInsideStatusLED:read(device)
...
function EnableInsideStatusLED:configure_reporting(device, min_rep_int, max_rep_int)
...
function EnableInsideStatusLED:write(device, value)
...
function EnableInsideStatusLED:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(EnableInsideStatusLED, {__call = EnableInsideStatusLED.new_value})
