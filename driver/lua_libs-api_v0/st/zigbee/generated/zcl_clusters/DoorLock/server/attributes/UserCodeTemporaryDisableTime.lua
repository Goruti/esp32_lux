...
--- @alias UserCodeTemporaryDisableTime
---
--- @field public ID number 0x0031 the ID of this attribute
--- @field public NAME string "UserCodeTemporaryDisableTime" the name of this attribute
...
function UserCodeTemporaryDisableTime:augment_type(base_type_obj)
...
function UserCodeTemporaryDisableTime.pretty_print(value_obj)
  UserCodeTemporaryDisableTime.base_type.pretty_print(value_obj)
end

--- @function UserCodeTemporaryDisableTime:build_test_attr_report
---
...
UserCodeTemporaryDisableTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UserCodeTemporaryDisableTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UserCodeTemporaryDisableTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UserCodeTemporaryDisableTime:read(device)
...
function UserCodeTemporaryDisableTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function UserCodeTemporaryDisableTime:write(device, value)
...
setmetatable(UserCodeTemporaryDisableTime, {__call = UserCodeTemporaryDisableTime.new_value})
