...
--- @alias NumberOfLogRecordsSupported
---
--- @field public ID number 0x0010 the ID of this attribute
--- @field public NAME string "NumberOfLogRecordsSupported" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local NumberOfLogRecordsSupported = {
  ID = 0x0010,
  NAME = "NumberOfLogRecordsSupported",
  base_type = data_types.Uint16,
}

function NumberOfLogRecordsSupported:augment_type(base_type_obj)
...
function NumberOfLogRecordsSupported.pretty_print(value_obj)
  NumberOfLogRecordsSupported.base_type.pretty_print(value_obj)
end

--- @function NumberOfLogRecordsSupported:build_test_attr_report
---
...
NumberOfLogRecordsSupported.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfLogRecordsSupported:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfLogRecordsSupported.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfLogRecordsSupported:new_value(...)
...
function NumberOfLogRecordsSupported:read(device)
...
function NumberOfLogRecordsSupported:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NumberOfLogRecordsSupported:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NumberOfLogRecordsSupported, {__call = NumberOfLogRecordsSupported.new_value})
