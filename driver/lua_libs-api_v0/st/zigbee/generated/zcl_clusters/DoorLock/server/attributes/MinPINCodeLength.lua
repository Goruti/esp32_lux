...
--- @alias MinPINCodeLength
---
--- @field public ID number 0x0018 the ID of this attribute
--- @field public NAME string "MinPINCodeLength" the name of this attribute
...
function MinPINCodeLength:augment_type(base_type_obj)
...
function MinPINCodeLength.pretty_print(value_obj)
  MinPINCodeLength.base_type.pretty_print(value_obj)
end

--- @function MinPINCodeLength:build_test_attr_report
---
...
MinPINCodeLength.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinPINCodeLength:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinPINCodeLength.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinPINCodeLength:read(device)
...
function MinPINCodeLength:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
setmetatable(MinPINCodeLength, {__call = MinPINCodeLength.new_value})
