...
--- @alias NumberOfTotalUsersSupported
---
--- @field public ID number 0x0011 the ID of this attribute
--- @field public NAME string "NumberOfTotalUsersSupported" the name of this attribute
...
function NumberOfTotalUsersSupported:augment_type(base_type_obj)
...
function NumberOfTotalUsersSupported.pretty_print(value_obj)
  NumberOfTotalUsersSupported.base_type.pretty_print(value_obj)
end

--- @function NumberOfTotalUsersSupported:build_test_attr_report
---
...
NumberOfTotalUsersSupported.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfTotalUsersSupported:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfTotalUsersSupported.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfTotalUsersSupported:read(device)
...
function NumberOfTotalUsersSupported:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
setmetatable(NumberOfTotalUsersSupported, {__call = NumberOfTotalUsersSupported.new_value})
