...
--- @field public NAME string "IdentifyTime" the name of this attribute
...
function IdentifyTime:augment_type(base_type_obj)
...
function IdentifyTime.pretty_print(value_obj)
  IdentifyTime.base_type.pretty_print(value_obj)
end

--- @function IdentifyTime:build_test_attr_report
---
...
IdentifyTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function IdentifyTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
IdentifyTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function IdentifyTime:new_value(...)
...
function IdentifyTime:read(device)
...
function IdentifyTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function IdentifyTime:write(device, value)
...
function IdentifyTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(IdentifyTime, {__call = IdentifyTime.new_value})
return IdentifyTime
