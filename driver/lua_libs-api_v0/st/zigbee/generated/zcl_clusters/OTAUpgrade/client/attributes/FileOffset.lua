...
--- @field public NAME string "FileOffset" the name of this attribute
...
function FileOffset:augment_type(base_type_obj)
...
function FileOffset.pretty_print(value_obj)
  FileOffset.base_type.pretty_print(value_obj)
end

--- @function FileOffset:build_test_attr_report
---
...
FileOffset.build_test_attr_report = cluster_base.build_test_attr_report

--- @function FileOffset:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
FileOffset.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function FileOffset:read(device)
...
function FileOffset:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function FileOffset:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(FileOffset, {__call = FileOffset.new_value})
return FileOffset
