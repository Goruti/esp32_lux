...
--- @field public NAME string "ManufacturerID" the name of this attribute
...
function ManufacturerID:augment_type(base_type_obj)
...
function ManufacturerID.pretty_print(value_obj)
  ManufacturerID.base_type.pretty_print(value_obj)
end

--- @function ManufacturerID:build_test_attr_report
---
...
ManufacturerID.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ManufacturerID:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ManufacturerID.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ManufacturerID:new_value(...)
...
function ManufacturerID:read(device)
...
function ManufacturerID:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ManufacturerID:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ManufacturerID, {__call = ManufacturerID.new_value})
