...
--- @field public NAME string "ImageTypeID" the name of this attribute
...
function ImageTypeID:augment_type(base_type_obj)
...
function ImageTypeID.pretty_print(value_obj)
  ImageTypeID.base_type.pretty_print(value_obj)
end

--- @function ImageTypeID:build_test_attr_report
---
...
ImageTypeID.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ImageTypeID:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ImageTypeID.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ImageTypeID:new_value(...)
...
function ImageTypeID:read(device)
...
function ImageTypeID:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ImageTypeID:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ImageTypeID, {__call = ImageTypeID.new_value})
return ImageTypeID
