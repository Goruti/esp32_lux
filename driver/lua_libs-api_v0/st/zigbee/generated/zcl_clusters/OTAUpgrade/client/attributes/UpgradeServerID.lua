...
function UpgradeServerID.pretty_print(value_obj)
  UpgradeServerID.base_type.pretty_print(value_obj)
end

--- @function UpgradeServerID:build_test_attr_report
---
...
UpgradeServerID.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UpgradeServerID:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.IeeeAddress the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UpgradeServerID.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UpgradeServerID:new_value(...)
...
function UpgradeServerID:read(device)
...
function UpgradeServerID:configure_reporting(device, min_rep_int, max_rep_int)
...
function UpgradeServerID:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(UpgradeServerID, {__call = UpgradeServerID.new_value})
