...
--- @alias CurrentZigBeeStackVersion
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "CurrentZigBeeStackVersion" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local CurrentZigBeeStackVersion = {
  ID = 0x0003,
  NAME = "CurrentZigBeeStackVersion",
  base_type = data_types.Uint16,
}

function CurrentZigBeeStackVersion:augment_type(base_type_obj)
...
function CurrentZigBeeStackVersion.pretty_print(value_obj)
  CurrentZigBeeStackVersion.base_type.pretty_print(value_obj)
end

--- @function CurrentZigBeeStackVersion:build_test_attr_report
---
...
CurrentZigBeeStackVersion.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentZigBeeStackVersion:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentZigBeeStackVersion.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentZigBeeStackVersion:new_value(...)
...
function CurrentZigBeeStackVersion:read(device)
...
function CurrentZigBeeStackVersion:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentZigBeeStackVersion:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentZigBeeStackVersion, {__call = CurrentZigBeeStackVersion.new_value})
