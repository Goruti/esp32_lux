...
function MinimumBlockPeriod.pretty_print(value_obj)
  MinimumBlockPeriod.base_type.pretty_print(value_obj)
end

--- @function MinimumBlockPeriod:build_test_attr_report
---
...
MinimumBlockPeriod.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinimumBlockPeriod:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinimumBlockPeriod.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinimumBlockPeriod:new_value(...)
...
function MinimumBlockPeriod:read(device)
...
function MinimumBlockPeriod:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinimumBlockPeriod:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinimumBlockPeriod, {__call = MinimumBlockPeriod.new_value})
