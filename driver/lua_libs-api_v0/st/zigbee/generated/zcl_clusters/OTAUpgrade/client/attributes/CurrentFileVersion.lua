...
function CurrentFileVersion.pretty_print(value_obj)
  CurrentFileVersion.base_type.pretty_print(value_obj)
end

--- @function CurrentFileVersion:build_test_attr_report
---
...
CurrentFileVersion.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentFileVersion:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentFileVersion.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentFileVersion:new_value(...)
...
function CurrentFileVersion:read(device)
...
function CurrentFileVersion:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentFileVersion:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentFileVersion, {__call = CurrentFileVersion.new_value})
