...
--- @field public NAME string "ImageStamp" the name of this attribute
...
function ImageStamp:augment_type(base_type_obj)
...
function ImageStamp.pretty_print(value_obj)
  ImageStamp.base_type.pretty_print(value_obj)
end

--- @function ImageStamp:build_test_attr_report
---
...
ImageStamp.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ImageStamp:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ImageStamp.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ImageStamp:read(device)
...
function ImageStamp:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ImageStamp:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ImageStamp, {__call = ImageStamp.new_value})
return ImageStamp
