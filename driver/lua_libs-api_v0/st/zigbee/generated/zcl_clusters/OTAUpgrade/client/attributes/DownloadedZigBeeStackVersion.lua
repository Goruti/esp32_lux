...
--- @alias DownloadedZigBeeStackVersion
---
--- @field public ID number 0x0005 the ID of this attribute
--- @field public NAME string "DownloadedZigBeeStackVersion" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local DownloadedZigBeeStackVersion = {
  ID = 0x0005,
  NAME = "DownloadedZigBeeStackVersion",
  base_type = data_types.Uint16,
}

function DownloadedZigBeeStackVersion:augment_type(base_type_obj)
...
function DownloadedZigBeeStackVersion.pretty_print(value_obj)
  DownloadedZigBeeStackVersion.base_type.pretty_print(value_obj)
end

--- @function DownloadedZigBeeStackVersion:build_test_attr_report
---
...
DownloadedZigBeeStackVersion.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DownloadedZigBeeStackVersion:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DownloadedZigBeeStackVersion.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DownloadedZigBeeStackVersion:new_value(...)
...
function DownloadedZigBeeStackVersion:read(device)
...
function DownloadedZigBeeStackVersion:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DownloadedZigBeeStackVersion:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DownloadedZigBeeStackVersion, {__call = DownloadedZigBeeStackVersion.new_value})
