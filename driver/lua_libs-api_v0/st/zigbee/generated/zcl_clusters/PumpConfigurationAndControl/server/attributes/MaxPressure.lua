...
--- @field public NAME string "MaxPressure" the name of this attribute
...
function MaxPressure:augment_type(base_type_obj)
...
function MaxPressure.pretty_print(value_obj)
  MaxPressure.base_type.pretty_print(value_obj)
end

--- @function MaxPressure:build_test_attr_report
---
...
MaxPressure.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxPressure:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxPressure.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxPressure:new_value(...)
...
function MaxPressure:read(device)
...
function MaxPressure:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxPressure:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxPressure, {__call = MaxPressure.new_value})
return MaxPressure
