...
function MinConstPressure.pretty_print(value_obj)
  MinConstPressure.base_type.pretty_print(value_obj)
end

--- @function MinConstPressure:build_test_attr_report
---
...
MinConstPressure.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinConstPressure:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinConstPressure.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinConstPressure:new_value(...)
...
function MinConstPressure:read(device)
...
function MinConstPressure:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinConstPressure:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinConstPressure, {__call = MinConstPressure.new_value})
