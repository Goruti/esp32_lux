...
--- @field public NAME string "MaxConstTemp" the name of this attribute
...
function MaxConstTemp:augment_type(base_type_obj)
...
function MaxConstTemp.pretty_print(value_obj)
  MaxConstTemp.base_type.pretty_print(value_obj)
end

--- @function MaxConstTemp:build_test_attr_report
---
...
MaxConstTemp.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxConstTemp:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxConstTemp.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxConstTemp:new_value(...)
...
function MaxConstTemp:read(device)
...
function MaxConstTemp:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxConstTemp:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxConstTemp, {__call = MaxConstTemp.new_value})
return MaxConstTemp
