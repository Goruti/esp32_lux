...
--- @field public NAME string "MinConstFlow" the name of this attribute
...
function MinConstFlow:augment_type(base_type_obj)
...
function MinConstFlow.pretty_print(value_obj)
  MinConstFlow.base_type.pretty_print(value_obj)
end

--- @function MinConstFlow:build_test_attr_report
---
...
MinConstFlow.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinConstFlow:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinConstFlow.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinConstFlow:new_value(...)
...
function MinConstFlow:read(device)
...
function MinConstFlow:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinConstFlow:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinConstFlow, {__call = MinConstFlow.new_value})
return MinConstFlow
