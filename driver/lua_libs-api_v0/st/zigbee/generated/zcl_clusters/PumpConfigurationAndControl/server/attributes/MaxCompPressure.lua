...
function MaxCompPressure.pretty_print(value_obj)
  MaxCompPressure.base_type.pretty_print(value_obj)
end

--- @function MaxCompPressure:build_test_attr_report
---
...
MaxCompPressure.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxCompPressure:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxCompPressure.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxCompPressure:new_value(...)
...
function MaxCompPressure:read(device)
...
function MaxCompPressure:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxCompPressure:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxCompPressure, {__call = MaxCompPressure.new_value})
