...
--- @field public NAME string "MaxConstSpeed" the name of this attribute
...
function MaxConstSpeed:augment_type(base_type_obj)
...
function MaxConstSpeed.pretty_print(value_obj)
  MaxConstSpeed.base_type.pretty_print(value_obj)
end

--- @function MaxConstSpeed:build_test_attr_report
---
...
MaxConstSpeed.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxConstSpeed:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxConstSpeed.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxConstSpeed:new_value(...)
...
function MaxConstSpeed:read(device)
...
function MaxConstSpeed:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxConstSpeed:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxConstSpeed, {__call = MaxConstSpeed.new_value})
