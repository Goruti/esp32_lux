...
function MaxConstPressure.pretty_print(value_obj)
  MaxConstPressure.base_type.pretty_print(value_obj)
end

--- @function MaxConstPressure:build_test_attr_report
---
...
MaxConstPressure.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxConstPressure:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxConstPressure.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxConstPressure:new_value(...)
...
function MaxConstPressure:read(device)
...
function MaxConstPressure:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxConstPressure:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxConstPressure, {__call = MaxConstPressure.new_value})
