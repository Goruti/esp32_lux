...
function MinCompPressure.pretty_print(value_obj)
  MinCompPressure.base_type.pretty_print(value_obj)
end

--- @function MinCompPressure:build_test_attr_report
---
...
MinCompPressure.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinCompPressure:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinCompPressure.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinCompPressure:new_value(...)
...
function MinCompPressure:read(device)
...
function MinCompPressure:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinCompPressure:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinCompPressure, {__call = MinCompPressure.new_value})
