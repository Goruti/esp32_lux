...
--- @field public NAME string "MaxFlow" the name of this attribute
...
function MaxFlow:augment_type(base_type_obj)
...
function MaxFlow.pretty_print(value_obj)
  MaxFlow.base_type.pretty_print(value_obj)
end

--- @function MaxFlow:build_test_attr_report
---
...
MaxFlow.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxFlow:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxFlow.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxFlow:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxFlow:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxFlow, {__call = MaxFlow.new_value})
return MaxFlow
