...
--- @field public NAME string "MaxConstFlow" the name of this attribute
...
function MaxConstFlow:augment_type(base_type_obj)
...
function MaxConstFlow.pretty_print(value_obj)
  MaxConstFlow.base_type.pretty_print(value_obj)
end

--- @function MaxConstFlow:build_test_attr_report
---
...
MaxConstFlow.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxConstFlow:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxConstFlow.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxConstFlow:new_value(...)
...
function MaxConstFlow:read(device)
...
function MaxConstFlow:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxConstFlow:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxConstFlow, {__call = MaxConstFlow.new_value})
return MaxConstFlow
