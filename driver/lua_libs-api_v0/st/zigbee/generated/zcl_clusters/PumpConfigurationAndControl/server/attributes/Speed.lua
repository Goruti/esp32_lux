...
--- @field public NAME string "Speed" the name of this attribute
...
function Speed:augment_type(base_type_obj)
...
function Speed.pretty_print(value_obj)
  Speed.base_type.pretty_print(value_obj)
end

--- @function Speed:build_test_attr_report
---
...
Speed.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Speed:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Speed.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Speed:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
setmetatable(Speed, {__call = Speed.new_value})
return Speed
