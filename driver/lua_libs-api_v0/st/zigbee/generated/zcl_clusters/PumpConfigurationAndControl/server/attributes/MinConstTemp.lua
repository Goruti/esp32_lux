...
--- @field public NAME string "MinConstTemp" the name of this attribute
...
function MinConstTemp:augment_type(base_type_obj)
...
function MinConstTemp.pretty_print(value_obj)
  MinConstTemp.base_type.pretty_print(value_obj)
end

--- @function MinConstTemp:build_test_attr_report
---
...
MinConstTemp.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinConstTemp:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinConstTemp.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinConstTemp:new_value(...)
...
function MinConstTemp:read(device)
...
function MinConstTemp:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinConstTemp:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinConstTemp, {__call = MinConstTemp.new_value})
return MinConstTemp
