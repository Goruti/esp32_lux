...
--- @field public NAME string "MaxSpeed" the name of this attribute
...
function MaxSpeed:augment_type(base_type_obj)
...
function MaxSpeed.pretty_print(value_obj)
  MaxSpeed.base_type.pretty_print(value_obj)
end

--- @function MaxSpeed:build_test_attr_report
---
...
MaxSpeed.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxSpeed:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxSpeed.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxSpeed:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxSpeed:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxSpeed, {__call = MaxSpeed.new_value})
return MaxSpeed
