...
--- @field public NAME string "Capacity" the name of this attribute
...
function Capacity:augment_type(base_type_obj)
...
function Capacity.pretty_print(value_obj)
  Capacity.base_type.pretty_print(value_obj)
end

--- @function Capacity:build_test_attr_report
---
...
Capacity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Capacity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Capacity.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Capacity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Capacity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Capacity, {__call = Capacity.new_value})
return Capacity
