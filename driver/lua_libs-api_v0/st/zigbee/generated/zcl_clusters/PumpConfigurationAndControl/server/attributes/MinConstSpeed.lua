...
--- @field public NAME string "MinConstSpeed" the name of this attribute
...
function MinConstSpeed:augment_type(base_type_obj)
...
function MinConstSpeed.pretty_print(value_obj)
  MinConstSpeed.base_type.pretty_print(value_obj)
end

--- @function MinConstSpeed:build_test_attr_report
---
...
MinConstSpeed.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinConstSpeed:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinConstSpeed.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinConstSpeed:new_value(...)
...
function MinConstSpeed:read(device)
...
function MinConstSpeed:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinConstSpeed:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinConstSpeed, {__call = MinConstSpeed.new_value})
