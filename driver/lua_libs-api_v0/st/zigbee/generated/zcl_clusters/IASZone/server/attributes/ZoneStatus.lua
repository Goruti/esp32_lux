...
--- @field public NAME string "ZoneStatus" the name of this attribute
--- @field public data_type st.zigbee.zcl.types.IasZoneStatus the data type of this attribute
local ZoneStatus = {
  ID = 0x0002,
  NAME = "ZoneStatus",
  base_type = IasZoneStatus,
}

function ZoneStatus:augment_type(base_type_obj)
...
function ZoneStatus.pretty_print(value_obj)
  ZoneStatus.base_type.pretty_print(value_obj)
end

--- @function ZoneStatus:build_test_attr_report
---
--- Build a Rx Zigbee message as if a device reported this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.zcl.types.IasZoneStatus the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an AttributeReport body
ZoneStatus.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ZoneStatus:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.zcl.types.IasZoneStatus the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ZoneStatus.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
--- @return st.zigbee.zcl.types.IasZoneStatus
function ZoneStatus:new_value(...)
...
function ZoneStatus:read(device)
...
--- @param rep_change st.zigbee.zcl.types.IasZoneStatus The amount of change of the attribute to trigger a report
--- @return st.zigbee.ZigbeeMessageTx containing a ConfigureReporting body
function ZoneStatus:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ZoneStatus:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ZoneStatus, {__call = ZoneStatus.new_value})
return ZoneStatus
