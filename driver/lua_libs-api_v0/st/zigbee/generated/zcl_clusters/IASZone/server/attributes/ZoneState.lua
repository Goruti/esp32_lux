...
--- @field public NAME string "ZoneState" the name of this attribute
--- @field public data_type st.zigbee.data_types.Enum8 the data type of this attribute
--- @field public NOT_ENROLLED number 0
--- @field public ENROLLED number 1
local ZoneState = {
  ID = 0x0000,
  NAME = "ZoneState",
...
ZoneState.NOT_ENROLLED = 0x00
ZoneState.ENROLLED     = 0x01


ZoneState.enum_fields = {
    [ZoneState.NOT_ENROLLED] = "NOT_ENROLLED",
...
function ZoneState:augment_type(base_type_obj)
...
function ZoneState.pretty_print(value_obj)
  return string.format("%s: %s[%s]", value_obj.field_name or value_obj.NAME, ZoneState.NAME, ZoneState.enum_fields[value_obj.value])
end

--- @function ZoneState:build_test_attr_report
---
...
ZoneState.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ZoneState:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Enum8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ZoneState.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ZoneState:read(device)
...
function ZoneState:configure_reporting(device, min_rep_int, max_rep_int)
...
function ZoneState:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ZoneState, {__call = ZoneState.new_value})
return ZoneState
