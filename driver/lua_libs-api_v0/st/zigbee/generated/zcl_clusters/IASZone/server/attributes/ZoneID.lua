...
--- @field public NAME string "ZoneID" the name of this attribute
...
function ZoneID:augment_type(base_type_obj)
...
function ZoneID.pretty_print(value_obj)
  ZoneID.base_type.pretty_print(value_obj)
end

--- @function ZoneID:build_test_attr_report
---
...
ZoneID.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ZoneID:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ZoneID.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ZoneID:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ZoneID:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ZoneID, {__call = ZoneID.new_value})
return ZoneID
