...
--- @alias CurrentZoneSensitivityLevel
---
--- @field public ID number 0x0013 the ID of this attribute
--- @field public NAME string "CurrentZoneSensitivityLevel" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local CurrentZoneSensitivityLevel = {
  ID = 0x0013,
  NAME = "CurrentZoneSensitivityLevel",
  base_type = data_types.Uint8,
}

function CurrentZoneSensitivityLevel:augment_type(base_type_obj)
...
function CurrentZoneSensitivityLevel.pretty_print(value_obj)
  CurrentZoneSensitivityLevel.base_type.pretty_print(value_obj)
end

--- @function CurrentZoneSensitivityLevel:build_test_attr_report
---
...
CurrentZoneSensitivityLevel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentZoneSensitivityLevel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentZoneSensitivityLevel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentZoneSensitivityLevel:new_value(...)
...
function CurrentZoneSensitivityLevel:read(device)
...
function CurrentZoneSensitivityLevel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentZoneSensitivityLevel:write(device, value)
...
function CurrentZoneSensitivityLevel:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentZoneSensitivityLevel, {__call = CurrentZoneSensitivityLevel.new_value})
