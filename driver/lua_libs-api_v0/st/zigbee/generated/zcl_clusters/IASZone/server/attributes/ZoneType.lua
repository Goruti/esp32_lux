...
--- @field public data_type st.zigbee.zcl.types.IasZoneType the data type of this attribute
local ZoneType = {
  ID = 0x0001,
  NAME = "ZoneType",
...
--- @param data st.zigbee.zcl.types.IasZoneType the attribute value
...
--- @return st.zigbee.zcl.types.IasZoneType
...
--- @param rep_change st.zigbee.zcl.types.IasZoneType The amount of change of the attribute to trigger a report
