...
--- @field public NAME string "IASCIEAddress" the name of this attribute
...
function IASCIEAddress:augment_type(base_type_obj)
...
function IASCIEAddress.pretty_print(value_obj)
  IASCIEAddress.base_type.pretty_print(value_obj)
end

--- @function IASCIEAddress:build_test_attr_report
---
...
IASCIEAddress.build_test_attr_report = cluster_base.build_test_attr_report

--- @function IASCIEAddress:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.IeeeAddress the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
IASCIEAddress.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function IASCIEAddress:new_value(...)
...
function IASCIEAddress:read(device)
...
function IASCIEAddress:configure_reporting(device, min_rep_int, max_rep_int)
...
function IASCIEAddress:write(device, value)
...
function IASCIEAddress:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(IASCIEAddress, {__call = IASCIEAddress.new_value})
