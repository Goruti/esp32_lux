...
--- @alias NumberOfZoneSensitivityLevelsSupported
---
--- @field public ID number 0x0012 the ID of this attribute
--- @field public NAME string "NumberOfZoneSensitivityLevelsSupported" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local NumberOfZoneSensitivityLevelsSupported = {
  ID = 0x0012,
  NAME = "NumberOfZoneSensitivityLevelsSupported",
  base_type = data_types.Uint8,
}

function NumberOfZoneSensitivityLevelsSupported:augment_type(base_type_obj)
...
function NumberOfZoneSensitivityLevelsSupported.pretty_print(value_obj)
  NumberOfZoneSensitivityLevelsSupported.base_type.pretty_print(value_obj)
end

--- @function NumberOfZoneSensitivityLevelsSupported:build_test_attr_report
---
...
NumberOfZoneSensitivityLevelsSupported.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfZoneSensitivityLevelsSupported:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfZoneSensitivityLevelsSupported.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfZoneSensitivityLevelsSupported:new_value(...)
...
function NumberOfZoneSensitivityLevelsSupported:read(device)
...
function NumberOfZoneSensitivityLevelsSupported:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NumberOfZoneSensitivityLevelsSupported:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NumberOfZoneSensitivityLevelsSupported, {__call = NumberOfZoneSensitivityLevelsSupported.new_value})
