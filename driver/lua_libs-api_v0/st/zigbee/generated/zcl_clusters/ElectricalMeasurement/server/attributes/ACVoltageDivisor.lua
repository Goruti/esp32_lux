...
--- @alias ACVoltageDivisor
---
--- @field public ID number 0x0601 the ID of this attribute
--- @field public NAME string "ACVoltageDivisor" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ACVoltageDivisor = {
  ID = 0x0601,
  NAME = "ACVoltageDivisor",
  base_type = data_types.Uint16,
}

function ACVoltageDivisor:augment_type(base_type_obj)
...
function ACVoltageDivisor.pretty_print(value_obj)
  ACVoltageDivisor.base_type.pretty_print(value_obj)
end

--- @function ACVoltageDivisor:build_test_attr_report
---
...
ACVoltageDivisor.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACVoltageDivisor:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACVoltageDivisor.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACVoltageDivisor:new_value(...)
...
function ACVoltageDivisor:read(device)
...
function ACVoltageDivisor:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACVoltageDivisor:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACVoltageDivisor, {__call = ACVoltageDivisor.new_value})
