...
--- @field public NAME string "DCPowerMin" the name of this attribute
...
function DCPowerMin:augment_type(base_type_obj)
...
function DCPowerMin.pretty_print(value_obj)
  DCPowerMin.base_type.pretty_print(value_obj)
end

--- @function DCPowerMin:build_test_attr_report
---
...
DCPowerMin.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCPowerMin:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCPowerMin.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCPowerMin:read(device)
...
function DCPowerMin:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCPowerMin:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCPowerMin, {__call = DCPowerMin.new_value})
return DCPowerMin
