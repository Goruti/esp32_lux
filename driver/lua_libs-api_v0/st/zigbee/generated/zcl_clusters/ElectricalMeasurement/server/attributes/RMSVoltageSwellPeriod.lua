...
--- @alias RMSVoltageSwellPeriod
---
--- @field public ID number 0x0517 the ID of this attribute
--- @field public NAME string "RMSVoltageSwellPeriod" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSVoltageSwellPeriod = {
  ID = 0x0517,
  NAME = "RMSVoltageSwellPeriod",
  base_type = data_types.Uint16,
}

function RMSVoltageSwellPeriod:augment_type(base_type_obj)
...
function RMSVoltageSwellPeriod.pretty_print(value_obj)
  RMSVoltageSwellPeriod.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageSwellPeriod:build_test_attr_report
---
...
RMSVoltageSwellPeriod.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageSwellPeriod:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageSwellPeriod.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageSwellPeriod:new_value(...)
...
function RMSVoltageSwellPeriod:read(device)
...
function RMSVoltageSwellPeriod:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageSwellPeriod:write(device, value)
...
function RMSVoltageSwellPeriod:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageSwellPeriod, {__call = RMSVoltageSwellPeriod.new_value})
