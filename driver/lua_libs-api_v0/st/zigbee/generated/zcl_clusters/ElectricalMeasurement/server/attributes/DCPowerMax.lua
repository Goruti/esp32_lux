...
--- @field public NAME string "DCPowerMax" the name of this attribute
...
function DCPowerMax:augment_type(base_type_obj)
...
function DCPowerMax.pretty_print(value_obj)
  DCPowerMax.base_type.pretty_print(value_obj)
end

--- @function DCPowerMax:build_test_attr_report
---
...
DCPowerMax.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCPowerMax:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCPowerMax.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCPowerMax:read(device)
...
function DCPowerMax:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCPowerMax:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCPowerMax, {__call = DCPowerMax.new_value})
return DCPowerMax
