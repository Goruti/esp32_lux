...
--- @alias RMSVoltageMinPhC
---
--- @field public ID number 0x0a06 the ID of this attribute
--- @field public NAME string "RMSVoltageMinPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSVoltageMinPhC = {
  ID = 0x0a06,
  NAME = "RMSVoltageMinPhC",
  base_type = data_types.Uint16,
}

function RMSVoltageMinPhC:augment_type(base_type_obj)
...
function RMSVoltageMinPhC.pretty_print(value_obj)
  RMSVoltageMinPhC.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageMinPhC:build_test_attr_report
---
...
RMSVoltageMinPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageMinPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageMinPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageMinPhC:new_value(...)
...
function RMSVoltageMinPhC:read(device)
...
function RMSVoltageMinPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageMinPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageMinPhC, {__call = RMSVoltageMinPhC.new_value})
