...
--- @alias RMSVoltageMax
---
--- @field public ID number 0x0507 the ID of this attribute
--- @field public NAME string "RMSVoltageMax" the name of this attribute
...
function RMSVoltageMax:augment_type(base_type_obj)
...
function RMSVoltageMax.pretty_print(value_obj)
  RMSVoltageMax.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageMax:build_test_attr_report
---
...
RMSVoltageMax.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageMax:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageMax.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageMax:new_value(...)
...
function RMSVoltageMax:read(device)
...
function RMSVoltageMax:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageMax:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageMax, {__call = RMSVoltageMax.new_value})
