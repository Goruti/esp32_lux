...
--- @alias Measured5thHarmonicCurrent
---
--- @field public ID number 0x0309 the ID of this attribute
--- @field public NAME string "Measured5thHarmonicCurrent" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local Measured5thHarmonicCurrent = {
  ID = 0x0309,
  NAME = "Measured5thHarmonicCurrent",
  base_type = data_types.Int16,
}

function Measured5thHarmonicCurrent:augment_type(base_type_obj)
...
function Measured5thHarmonicCurrent.pretty_print(value_obj)
  Measured5thHarmonicCurrent.base_type.pretty_print(value_obj)
end

--- @function Measured5thHarmonicCurrent:build_test_attr_report
---
...
Measured5thHarmonicCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Measured5thHarmonicCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Measured5thHarmonicCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Measured5thHarmonicCurrent:new_value(...)
...
function Measured5thHarmonicCurrent:read(device)
...
function Measured5thHarmonicCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Measured5thHarmonicCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Measured5thHarmonicCurrent, {__call = Measured5thHarmonicCurrent.new_value})
