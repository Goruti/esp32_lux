...
--- @alias MeasuredPhase5thHarmonicCurrent
---
--- @field public ID number 0x030f the ID of this attribute
--- @field public NAME string "MeasuredPhase5thHarmonicCurrent" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local MeasuredPhase5thHarmonicCurrent = {
  ID = 0x030f,
  NAME = "MeasuredPhase5thHarmonicCurrent",
  base_type = data_types.Int16,
}

function MeasuredPhase5thHarmonicCurrent:augment_type(base_type_obj)
...
function MeasuredPhase5thHarmonicCurrent.pretty_print(value_obj)
  MeasuredPhase5thHarmonicCurrent.base_type.pretty_print(value_obj)
end

--- @function MeasuredPhase5thHarmonicCurrent:build_test_attr_report
---
...
MeasuredPhase5thHarmonicCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MeasuredPhase5thHarmonicCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MeasuredPhase5thHarmonicCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MeasuredPhase5thHarmonicCurrent:new_value(...)
...
function MeasuredPhase5thHarmonicCurrent:read(device)
...
function MeasuredPhase5thHarmonicCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MeasuredPhase5thHarmonicCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MeasuredPhase5thHarmonicCurrent, {__call = MeasuredPhase5thHarmonicCurrent.new_value})
