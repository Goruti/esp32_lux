...
--- @alias ApparentPower
---
--- @field public ID number 0x050f the ID of this attribute
--- @field public NAME string "ApparentPower" the name of this attribute
...
function ApparentPower.pretty_print(value_obj)
  ApparentPower.base_type.pretty_print(value_obj)
end

--- @function ApparentPower:build_test_attr_report
---
...
ApparentPower.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ApparentPower:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ApparentPower.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ApparentPower:read(device)
...
function ApparentPower:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
