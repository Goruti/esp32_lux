...
--- @alias RMSCurrentMax
---
--- @field public ID number 0x050a the ID of this attribute
--- @field public NAME string "RMSCurrentMax" the name of this attribute
...
function RMSCurrentMax:augment_type(base_type_obj)
...
function RMSCurrentMax.pretty_print(value_obj)
  RMSCurrentMax.base_type.pretty_print(value_obj)
end

--- @function RMSCurrentMax:build_test_attr_report
---
...
RMSCurrentMax.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSCurrentMax:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSCurrentMax.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSCurrentMax:new_value(...)
...
function RMSCurrentMax:read(device)
...
function RMSCurrentMax:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSCurrentMax:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSCurrentMax, {__call = RMSCurrentMax.new_value})
