...
--- @alias ACCurrentOverload
---
--- @field public ID number 0x0802 the ID of this attribute
--- @field public NAME string "ACCurrentOverload" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ACCurrentOverload = {
  ID = 0x0802,
  NAME = "ACCurrentOverload",
  base_type = data_types.Int16,
}

function ACCurrentOverload:augment_type(base_type_obj)
...
function ACCurrentOverload.pretty_print(value_obj)
  ACCurrentOverload.base_type.pretty_print(value_obj)
end

--- @function ACCurrentOverload:build_test_attr_report
---
...
ACCurrentOverload.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACCurrentOverload:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACCurrentOverload.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACCurrentOverload:new_value(...)
...
function ACCurrentOverload:read(device)
...
function ACCurrentOverload:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACCurrentOverload:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACCurrentOverload, {__call = ACCurrentOverload.new_value})
