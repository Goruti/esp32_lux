...
--- @alias AverageRMSVoltageMeasurementPeriod
---
--- @field public ID number 0x0511 the ID of this attribute
--- @field public NAME string "AverageRMSVoltageMeasurementPeriod" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local AverageRMSVoltageMeasurementPeriod = {
  ID = 0x0511,
  NAME = "AverageRMSVoltageMeasurementPeriod",
  base_type = data_types.Uint16,
}

function AverageRMSVoltageMeasurementPeriod:augment_type(base_type_obj)
...
function AverageRMSVoltageMeasurementPeriod.pretty_print(value_obj)
  AverageRMSVoltageMeasurementPeriod.base_type.pretty_print(value_obj)
end

--- @function AverageRMSVoltageMeasurementPeriod:build_test_attr_report
---
...
AverageRMSVoltageMeasurementPeriod.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSVoltageMeasurementPeriod:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSVoltageMeasurementPeriod.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSVoltageMeasurementPeriod:new_value(...)
...
function AverageRMSVoltageMeasurementPeriod:read(device)
...
function AverageRMSVoltageMeasurementPeriod:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSVoltageMeasurementPeriod:write(device, value)
...
function AverageRMSVoltageMeasurementPeriod:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSVoltageMeasurementPeriod, {__call = AverageRMSVoltageMeasurementPeriod.new_value})
