...
--- @alias RMSVoltageMaxPhC
---
--- @field public ID number 0x0a07 the ID of this attribute
--- @field public NAME string "RMSVoltageMaxPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSVoltageMaxPhC = {
  ID = 0x0a07,
  NAME = "RMSVoltageMaxPhC",
  base_type = data_types.Uint16,
}

function RMSVoltageMaxPhC:augment_type(base_type_obj)
...
function RMSVoltageMaxPhC.pretty_print(value_obj)
  RMSVoltageMaxPhC.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageMaxPhC:build_test_attr_report
---
...
RMSVoltageMaxPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageMaxPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageMaxPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageMaxPhC:new_value(...)
...
function RMSVoltageMaxPhC:read(device)
...
function RMSVoltageMaxPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageMaxPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageMaxPhC, {__call = RMSVoltageMaxPhC.new_value})
