...
--- @alias AverageRMSUnderVoltageCounterPhC
---
--- @field public ID number 0x0a13 the ID of this attribute
--- @field public NAME string "AverageRMSUnderVoltageCounterPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local AverageRMSUnderVoltageCounterPhC = {
  ID = 0x0a13,
  NAME = "AverageRMSUnderVoltageCounterPhC",
  base_type = data_types.Uint16,
}

function AverageRMSUnderVoltageCounterPhC:augment_type(base_type_obj)
...
function AverageRMSUnderVoltageCounterPhC.pretty_print(value_obj)
  AverageRMSUnderVoltageCounterPhC.base_type.pretty_print(value_obj)
end

--- @function AverageRMSUnderVoltageCounterPhC:build_test_attr_report
---
...
AverageRMSUnderVoltageCounterPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSUnderVoltageCounterPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSUnderVoltageCounterPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSUnderVoltageCounterPhC:new_value(...)
...
function AverageRMSUnderVoltageCounterPhC:read(device)
...
function AverageRMSUnderVoltageCounterPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSUnderVoltageCounterPhC:write(device, value)
...
function AverageRMSUnderVoltageCounterPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSUnderVoltageCounterPhC, {__call = AverageRMSUnderVoltageCounterPhC.new_value})
