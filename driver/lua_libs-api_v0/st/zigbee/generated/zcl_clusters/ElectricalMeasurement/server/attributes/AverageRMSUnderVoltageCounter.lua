...
--- @alias AverageRMSUnderVoltageCounter
---
--- @field public ID number 0x0513 the ID of this attribute
--- @field public NAME string "AverageRMSUnderVoltageCounter" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local AverageRMSUnderVoltageCounter = {
  ID = 0x0513,
  NAME = "AverageRMSUnderVoltageCounter",
  base_type = data_types.Uint16,
}

function AverageRMSUnderVoltageCounter:augment_type(base_type_obj)
...
function AverageRMSUnderVoltageCounter.pretty_print(value_obj)
  AverageRMSUnderVoltageCounter.base_type.pretty_print(value_obj)
end

--- @function AverageRMSUnderVoltageCounter:build_test_attr_report
---
...
AverageRMSUnderVoltageCounter.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSUnderVoltageCounter:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSUnderVoltageCounter.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSUnderVoltageCounter:new_value(...)
...
function AverageRMSUnderVoltageCounter:read(device)
...
function AverageRMSUnderVoltageCounter:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSUnderVoltageCounter:write(device, value)
...
function AverageRMSUnderVoltageCounter:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSUnderVoltageCounter, {__call = AverageRMSUnderVoltageCounter.new_value})
