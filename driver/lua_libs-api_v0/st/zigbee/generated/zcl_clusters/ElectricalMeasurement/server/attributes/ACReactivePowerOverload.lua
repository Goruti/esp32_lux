...
--- @alias ACReactivePowerOverload
---
--- @field public ID number 0x0804 the ID of this attribute
--- @field public NAME string "ACReactivePowerOverload" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ACReactivePowerOverload = {
  ID = 0x0804,
  NAME = "ACReactivePowerOverload",
  base_type = data_types.Int16,
}

function ACReactivePowerOverload:augment_type(base_type_obj)
...
function ACReactivePowerOverload.pretty_print(value_obj)
  ACReactivePowerOverload.base_type.pretty_print(value_obj)
end

--- @function ACReactivePowerOverload:build_test_attr_report
---
...
ACReactivePowerOverload.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACReactivePowerOverload:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACReactivePowerOverload.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACReactivePowerOverload:new_value(...)
...
function ACReactivePowerOverload:read(device)
...
function ACReactivePowerOverload:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACReactivePowerOverload:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACReactivePowerOverload, {__call = ACReactivePowerOverload.new_value})
