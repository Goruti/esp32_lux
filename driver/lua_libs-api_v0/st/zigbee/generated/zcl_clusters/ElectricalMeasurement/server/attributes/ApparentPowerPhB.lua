...
--- @alias ApparentPowerPhB
---
--- @field public ID number 0x090f the ID of this attribute
--- @field public NAME string "ApparentPowerPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ApparentPowerPhB = {
  ID = 0x090f,
  NAME = "ApparentPowerPhB",
  base_type = data_types.Uint16,
}

function ApparentPowerPhB:augment_type(base_type_obj)
...
function ApparentPowerPhB.pretty_print(value_obj)
  ApparentPowerPhB.base_type.pretty_print(value_obj)
end

--- @function ApparentPowerPhB:build_test_attr_report
---
...
ApparentPowerPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ApparentPowerPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ApparentPowerPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ApparentPowerPhB:new_value(...)
...
function ApparentPowerPhB:read(device)
...
function ApparentPowerPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ApparentPowerPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ApparentPowerPhB, {__call = ApparentPowerPhB.new_value})
