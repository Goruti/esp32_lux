...
--- @alias AverageRMSVoltageMeasurementPeriodPhB
---
--- @field public ID number 0x0911 the ID of this attribute
--- @field public NAME string "AverageRMSVoltageMeasurementPeriodPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local AverageRMSVoltageMeasurementPeriodPhB = {
  ID = 0x0911,
  NAME = "AverageRMSVoltageMeasurementPeriodPhB",
  base_type = data_types.Uint16,
}

function AverageRMSVoltageMeasurementPeriodPhB:augment_type(base_type_obj)
...
function AverageRMSVoltageMeasurementPeriodPhB.pretty_print(value_obj)
  AverageRMSVoltageMeasurementPeriodPhB.base_type.pretty_print(value_obj)
end

--- @function AverageRMSVoltageMeasurementPeriodPhB:build_test_attr_report
---
...
AverageRMSVoltageMeasurementPeriodPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSVoltageMeasurementPeriodPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSVoltageMeasurementPeriodPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSVoltageMeasurementPeriodPhB:new_value(...)
...
function AverageRMSVoltageMeasurementPeriodPhB:read(device)
...
function AverageRMSVoltageMeasurementPeriodPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSVoltageMeasurementPeriodPhB:write(device, value)
...
function AverageRMSVoltageMeasurementPeriodPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSVoltageMeasurementPeriodPhB, {__call = AverageRMSVoltageMeasurementPeriodPhB.new_value})
