...
--- @field public NAME string "DCPower" the name of this attribute
...
function DCPower:augment_type(base_type_obj)
...
function DCPower.pretty_print(value_obj)
  DCPower.base_type.pretty_print(value_obj)
end

--- @function DCPower:build_test_attr_report
---
...
DCPower.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCPower:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCPower.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCPower:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCPower:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCPower, {__call = DCPower.new_value})
return DCPower
