...
--- @alias Measured3rdHarmonicCurrent
---
--- @field public ID number 0x0308 the ID of this attribute
--- @field public NAME string "Measured3rdHarmonicCurrent" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local Measured3rdHarmonicCurrent = {
  ID = 0x0308,
  NAME = "Measured3rdHarmonicCurrent",
  base_type = data_types.Int16,
}

function Measured3rdHarmonicCurrent:augment_type(base_type_obj)
...
function Measured3rdHarmonicCurrent.pretty_print(value_obj)
  Measured3rdHarmonicCurrent.base_type.pretty_print(value_obj)
end

--- @function Measured3rdHarmonicCurrent:build_test_attr_report
---
...
Measured3rdHarmonicCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Measured3rdHarmonicCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Measured3rdHarmonicCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Measured3rdHarmonicCurrent:new_value(...)
...
function Measured3rdHarmonicCurrent:read(device)
...
function Measured3rdHarmonicCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Measured3rdHarmonicCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Measured3rdHarmonicCurrent, {__call = Measured3rdHarmonicCurrent.new_value})
