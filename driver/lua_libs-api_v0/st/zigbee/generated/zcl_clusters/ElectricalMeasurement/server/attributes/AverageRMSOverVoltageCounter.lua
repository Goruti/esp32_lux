...
--- @alias AverageRMSOverVoltageCounter
---
--- @field public ID number 0x0512 the ID of this attribute
--- @field public NAME string "AverageRMSOverVoltageCounter" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local AverageRMSOverVoltageCounter = {
  ID = 0x0512,
  NAME = "AverageRMSOverVoltageCounter",
  base_type = data_types.Uint16,
}

function AverageRMSOverVoltageCounter:augment_type(base_type_obj)
...
function AverageRMSOverVoltageCounter.pretty_print(value_obj)
  AverageRMSOverVoltageCounter.base_type.pretty_print(value_obj)
end

--- @function AverageRMSOverVoltageCounter:build_test_attr_report
---
...
AverageRMSOverVoltageCounter.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSOverVoltageCounter:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSOverVoltageCounter.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSOverVoltageCounter:new_value(...)
...
function AverageRMSOverVoltageCounter:read(device)
...
function AverageRMSOverVoltageCounter:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSOverVoltageCounter:write(device, value)
...
function AverageRMSOverVoltageCounter:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSOverVoltageCounter, {__call = AverageRMSOverVoltageCounter.new_value})
