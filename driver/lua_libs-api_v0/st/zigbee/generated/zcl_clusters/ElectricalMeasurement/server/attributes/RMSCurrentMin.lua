...
--- @alias RMSCurrentMin
---
--- @field public ID number 0x0509 the ID of this attribute
--- @field public NAME string "RMSCurrentMin" the name of this attribute
...
function RMSCurrentMin:augment_type(base_type_obj)
...
function RMSCurrentMin.pretty_print(value_obj)
  RMSCurrentMin.base_type.pretty_print(value_obj)
end

--- @function RMSCurrentMin:build_test_attr_report
---
...
RMSCurrentMin.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSCurrentMin:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSCurrentMin.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSCurrentMin:new_value(...)
...
function RMSCurrentMin:read(device)
...
function RMSCurrentMin:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSCurrentMin:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSCurrentMin, {__call = RMSCurrentMin.new_value})
