...
--- @alias RMSCurrentMaxPhC
---
--- @field public ID number 0x0a0a the ID of this attribute
--- @field public NAME string "RMSCurrentMaxPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSCurrentMaxPhC = {
  ID = 0x0a0a,
  NAME = "RMSCurrentMaxPhC",
  base_type = data_types.Uint16,
}

function RMSCurrentMaxPhC:augment_type(base_type_obj)
...
function RMSCurrentMaxPhC.pretty_print(value_obj)
  RMSCurrentMaxPhC.base_type.pretty_print(value_obj)
end

--- @function RMSCurrentMaxPhC:build_test_attr_report
---
...
RMSCurrentMaxPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSCurrentMaxPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSCurrentMaxPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSCurrentMaxPhC:new_value(...)
...
function RMSCurrentMaxPhC:read(device)
...
function RMSCurrentMaxPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSCurrentMaxPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSCurrentMaxPhC, {__call = RMSCurrentMaxPhC.new_value})
