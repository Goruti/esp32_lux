...
--- @alias ACPowerDivisor
---
--- @field public ID number 0x0605 the ID of this attribute
--- @field public NAME string "ACPowerDivisor" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ACPowerDivisor = {
  ID = 0x0605,
  NAME = "ACPowerDivisor",
  base_type = data_types.Uint16,
}

function ACPowerDivisor:augment_type(base_type_obj)
...
function ACPowerDivisor.pretty_print(value_obj)
  ACPowerDivisor.base_type.pretty_print(value_obj)
end

--- @function ACPowerDivisor:build_test_attr_report
---
...
ACPowerDivisor.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACPowerDivisor:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACPowerDivisor.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACPowerDivisor:new_value(...)
...
function ACPowerDivisor:read(device)
...
function ACPowerDivisor:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACPowerDivisor:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACPowerDivisor, {__call = ACPowerDivisor.new_value})
