...
--- @alias DCCurrentOverload
---
--- @field public ID number 0x0702 the ID of this attribute
--- @field public NAME string "DCCurrentOverload" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local DCCurrentOverload = {
  ID = 0x0702,
  NAME = "DCCurrentOverload",
  base_type = data_types.Int16,
}

function DCCurrentOverload:augment_type(base_type_obj)
...
function DCCurrentOverload.pretty_print(value_obj)
  DCCurrentOverload.base_type.pretty_print(value_obj)
end

--- @function DCCurrentOverload:build_test_attr_report
---
...
DCCurrentOverload.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCCurrentOverload:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCCurrentOverload.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCCurrentOverload:new_value(...)
...
function DCCurrentOverload:read(device)
...
function DCCurrentOverload:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCCurrentOverload:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCCurrentOverload, {__call = DCCurrentOverload.new_value})
