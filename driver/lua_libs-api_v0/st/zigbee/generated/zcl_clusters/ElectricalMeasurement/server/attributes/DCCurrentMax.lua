...
--- @field public NAME string "DCCurrentMax" the name of this attribute
...
function DCCurrentMax:augment_type(base_type_obj)
...
function DCCurrentMax.pretty_print(value_obj)
  DCCurrentMax.base_type.pretty_print(value_obj)
end

--- @function DCCurrentMax:build_test_attr_report
---
...
DCCurrentMax.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCCurrentMax:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCCurrentMax.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCCurrentMax:new_value(...)
...
function DCCurrentMax:read(device)
...
function DCCurrentMax:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCCurrentMax:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCCurrentMax, {__call = DCCurrentMax.new_value})
return DCCurrentMax
