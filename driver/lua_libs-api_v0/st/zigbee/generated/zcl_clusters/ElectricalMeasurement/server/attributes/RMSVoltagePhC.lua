...
--- @alias RMSVoltagePhC
---
--- @field public ID number 0x0a05 the ID of this attribute
--- @field public NAME string "RMSVoltagePhC" the name of this attribute
...
function RMSVoltagePhC:augment_type(base_type_obj)
...
function RMSVoltagePhC.pretty_print(value_obj)
  RMSVoltagePhC.base_type.pretty_print(value_obj)
end

--- @function RMSVoltagePhC:build_test_attr_report
---
...
RMSVoltagePhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltagePhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltagePhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltagePhC:new_value(...)
...
function RMSVoltagePhC:read(device)
...
function RMSVoltagePhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltagePhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltagePhC, {__call = RMSVoltagePhC.new_value})
