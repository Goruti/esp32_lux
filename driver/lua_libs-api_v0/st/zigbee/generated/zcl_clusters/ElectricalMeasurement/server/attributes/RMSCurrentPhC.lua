...
--- @alias RMSCurrentPhC
---
--- @field public ID number 0x0a08 the ID of this attribute
--- @field public NAME string "RMSCurrentPhC" the name of this attribute
...
function RMSCurrentPhC:augment_type(base_type_obj)
...
function RMSCurrentPhC.pretty_print(value_obj)
  RMSCurrentPhC.base_type.pretty_print(value_obj)
end

--- @function RMSCurrentPhC:build_test_attr_report
---
...
RMSCurrentPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSCurrentPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSCurrentPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSCurrentPhC:new_value(...)
...
function RMSCurrentPhC:read(device)
...
function RMSCurrentPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSCurrentPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSCurrentPhC, {__call = RMSCurrentPhC.new_value})
