...
--- @alias ReactivePower
---
--- @field public ID number 0x050e the ID of this attribute
--- @field public NAME string "ReactivePower" the name of this attribute
...
function ReactivePower:augment_type(base_type_obj)
...
function ReactivePower.pretty_print(value_obj)
  ReactivePower.base_type.pretty_print(value_obj)
end

--- @function ReactivePower:build_test_attr_report
---
...
ReactivePower.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ReactivePower:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ReactivePower.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ReactivePower:new_value(...)
...
function ReactivePower:read(device)
...
function ReactivePower:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ReactivePower:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ReactivePower, {__call = ReactivePower.new_value})
