...
--- @alias Measured1stHarmonicCurrent
---
--- @field public ID number 0x0307 the ID of this attribute
--- @field public NAME string "Measured1stHarmonicCurrent" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local Measured1stHarmonicCurrent = {
  ID = 0x0307,
  NAME = "Measured1stHarmonicCurrent",
  base_type = data_types.Int16,
}

function Measured1stHarmonicCurrent:augment_type(base_type_obj)
...
function Measured1stHarmonicCurrent.pretty_print(value_obj)
  Measured1stHarmonicCurrent.base_type.pretty_print(value_obj)
end

--- @function Measured1stHarmonicCurrent:build_test_attr_report
---
...
Measured1stHarmonicCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Measured1stHarmonicCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Measured1stHarmonicCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Measured1stHarmonicCurrent:new_value(...)
...
function Measured1stHarmonicCurrent:read(device)
...
function Measured1stHarmonicCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Measured1stHarmonicCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Measured1stHarmonicCurrent, {__call = Measured1stHarmonicCurrent.new_value})
