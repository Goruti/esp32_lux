...
--- @alias RMSExtremeOverVoltagePeriod
---
--- @field public ID number 0x0514 the ID of this attribute
--- @field public NAME string "RMSExtremeOverVoltagePeriod" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSExtremeOverVoltagePeriod = {
  ID = 0x0514,
  NAME = "RMSExtremeOverVoltagePeriod",
  base_type = data_types.Uint16,
}

function RMSExtremeOverVoltagePeriod:augment_type(base_type_obj)
...
function RMSExtremeOverVoltagePeriod.pretty_print(value_obj)
  RMSExtremeOverVoltagePeriod.base_type.pretty_print(value_obj)
end

--- @function RMSExtremeOverVoltagePeriod:build_test_attr_report
---
...
RMSExtremeOverVoltagePeriod.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSExtremeOverVoltagePeriod:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSExtremeOverVoltagePeriod.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSExtremeOverVoltagePeriod:new_value(...)
...
function RMSExtremeOverVoltagePeriod:read(device)
...
function RMSExtremeOverVoltagePeriod:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSExtremeOverVoltagePeriod:write(device, value)
...
function RMSExtremeOverVoltagePeriod:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSExtremeOverVoltagePeriod, {__call = RMSExtremeOverVoltagePeriod.new_value})
