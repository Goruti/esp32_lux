...
--- @alias DCCurrentDivisor
---
--- @field public ID number 0x0203 the ID of this attribute
--- @field public NAME string "DCCurrentDivisor" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local DCCurrentDivisor = {
  ID = 0x0203,
  NAME = "DCCurrentDivisor",
  base_type = data_types.Uint16,
}

function DCCurrentDivisor:augment_type(base_type_obj)
...
function DCCurrentDivisor.pretty_print(value_obj)
  DCCurrentDivisor.base_type.pretty_print(value_obj)
end

--- @function DCCurrentDivisor:build_test_attr_report
---
...
DCCurrentDivisor.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCCurrentDivisor:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCCurrentDivisor.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCCurrentDivisor:new_value(...)
...
function DCCurrentDivisor:read(device)
...
function DCCurrentDivisor:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCCurrentDivisor:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCCurrentDivisor, {__call = DCCurrentDivisor.new_value})
