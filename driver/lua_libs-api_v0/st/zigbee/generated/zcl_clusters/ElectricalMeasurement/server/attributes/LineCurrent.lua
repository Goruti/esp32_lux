...
--- @alias LineCurrent
---
--- @field public ID number 0x0501 the ID of this attribute
--- @field public NAME string "LineCurrent" the name of this attribute
...
function LineCurrent:augment_type(base_type_obj)
...
function LineCurrent.pretty_print(value_obj)
  LineCurrent.base_type.pretty_print(value_obj)
end

--- @function LineCurrent:build_test_attr_report
---
...
LineCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LineCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LineCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LineCurrent:new_value(...)
...
function LineCurrent:read(device)
...
function LineCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LineCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LineCurrent, {__call = LineCurrent.new_value})
return LineCurrent
