...
--- @field public NAME string "DCCurrent" the name of this attribute
...
function DCCurrent:augment_type(base_type_obj)
...
function DCCurrent.pretty_print(value_obj)
  DCCurrent.base_type.pretty_print(value_obj)
end

--- @function DCCurrent:build_test_attr_report
---
...
DCCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCCurrent:read(device)
...
function DCCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCCurrent, {__call = DCCurrent.new_value})
return DCCurrent
