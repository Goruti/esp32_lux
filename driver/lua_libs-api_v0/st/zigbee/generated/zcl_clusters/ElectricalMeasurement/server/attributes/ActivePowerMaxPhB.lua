...
--- @alias ActivePowerMaxPhB
---
--- @field public ID number 0x090d the ID of this attribute
--- @field public NAME string "ActivePowerMaxPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ActivePowerMaxPhB = {
  ID = 0x090d,
  NAME = "ActivePowerMaxPhB",
  base_type = data_types.Int16,
}

function ActivePowerMaxPhB:augment_type(base_type_obj)
...
function ActivePowerMaxPhB.pretty_print(value_obj)
  ActivePowerMaxPhB.base_type.pretty_print(value_obj)
end

--- @function ActivePowerMaxPhB:build_test_attr_report
---
...
ActivePowerMaxPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActivePowerMaxPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActivePowerMaxPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActivePowerMaxPhB:new_value(...)
...
function ActivePowerMaxPhB:read(device)
...
function ActivePowerMaxPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ActivePowerMaxPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ActivePowerMaxPhB, {__call = ActivePowerMaxPhB.new_value})
