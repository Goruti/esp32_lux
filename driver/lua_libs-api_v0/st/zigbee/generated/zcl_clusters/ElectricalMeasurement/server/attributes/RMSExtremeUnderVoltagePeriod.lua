...
--- @alias RMSExtremeUnderVoltagePeriod
---
--- @field public ID number 0x0515 the ID of this attribute
--- @field public NAME string "RMSExtremeUnderVoltagePeriod" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSExtremeUnderVoltagePeriod = {
  ID = 0x0515,
  NAME = "RMSExtremeUnderVoltagePeriod",
  base_type = data_types.Uint16,
}

function RMSExtremeUnderVoltagePeriod:augment_type(base_type_obj)
...
function RMSExtremeUnderVoltagePeriod.pretty_print(value_obj)
  RMSExtremeUnderVoltagePeriod.base_type.pretty_print(value_obj)
end

--- @function RMSExtremeUnderVoltagePeriod:build_test_attr_report
---
...
RMSExtremeUnderVoltagePeriod.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSExtremeUnderVoltagePeriod:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSExtremeUnderVoltagePeriod.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSExtremeUnderVoltagePeriod:new_value(...)
...
function RMSExtremeUnderVoltagePeriod:read(device)
...
function RMSExtremeUnderVoltagePeriod:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSExtremeUnderVoltagePeriod:write(device, value)
...
function RMSExtremeUnderVoltagePeriod:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSExtremeUnderVoltagePeriod, {__call = RMSExtremeUnderVoltagePeriod.new_value})
