...
--- @alias DCCurrentMultiplier
---
--- @field public ID number 0x0202 the ID of this attribute
--- @field public NAME string "DCCurrentMultiplier" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local DCCurrentMultiplier = {
  ID = 0x0202,
  NAME = "DCCurrentMultiplier",
  base_type = data_types.Uint16,
}

function DCCurrentMultiplier:augment_type(base_type_obj)
...
function DCCurrentMultiplier.pretty_print(value_obj)
  DCCurrentMultiplier.base_type.pretty_print(value_obj)
end

--- @function DCCurrentMultiplier:build_test_attr_report
---
...
DCCurrentMultiplier.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCCurrentMultiplier:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCCurrentMultiplier.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCCurrentMultiplier:new_value(...)
...
function DCCurrentMultiplier:read(device)
...
function DCCurrentMultiplier:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCCurrentMultiplier:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCCurrentMultiplier, {__call = DCCurrentMultiplier.new_value})
