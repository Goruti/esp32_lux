...
--- @alias RMSCurrentMaxPhB
---
--- @field public ID number 0x090a the ID of this attribute
--- @field public NAME string "RMSCurrentMaxPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSCurrentMaxPhB = {
  ID = 0x090a,
  NAME = "RMSCurrentMaxPhB",
  base_type = data_types.Uint16,
}

function RMSCurrentMaxPhB:augment_type(base_type_obj)
...
function RMSCurrentMaxPhB.pretty_print(value_obj)
  RMSCurrentMaxPhB.base_type.pretty_print(value_obj)
end

--- @function RMSCurrentMaxPhB:build_test_attr_report
---
...
RMSCurrentMaxPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSCurrentMaxPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSCurrentMaxPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSCurrentMaxPhB:new_value(...)
...
function RMSCurrentMaxPhB:read(device)
...
function RMSCurrentMaxPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSCurrentMaxPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSCurrentMaxPhB, {__call = RMSCurrentMaxPhB.new_value})
