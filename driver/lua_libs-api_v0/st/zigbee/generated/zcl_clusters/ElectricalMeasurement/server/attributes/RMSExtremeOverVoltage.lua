...
--- @alias RMSExtremeOverVoltage
---
--- @field public ID number 0x0807 the ID of this attribute
--- @field public NAME string "RMSExtremeOverVoltage" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local RMSExtremeOverVoltage = {
  ID = 0x0807,
  NAME = "RMSExtremeOverVoltage",
  base_type = data_types.Int16,
}

function RMSExtremeOverVoltage:augment_type(base_type_obj)
...
function RMSExtremeOverVoltage.pretty_print(value_obj)
  RMSExtremeOverVoltage.base_type.pretty_print(value_obj)
end

--- @function RMSExtremeOverVoltage:build_test_attr_report
---
...
RMSExtremeOverVoltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSExtremeOverVoltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSExtremeOverVoltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSExtremeOverVoltage:new_value(...)
...
function RMSExtremeOverVoltage:read(device)
...
function RMSExtremeOverVoltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSExtremeOverVoltage:write(device, value)
...
function RMSExtremeOverVoltage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSExtremeOverVoltage, {__call = RMSExtremeOverVoltage.new_value})
