...
--- @alias NeutralCurrent
---
--- @field public ID number 0x0303 the ID of this attribute
--- @field public NAME string "NeutralCurrent" the name of this attribute
...
function NeutralCurrent.pretty_print(value_obj)
  NeutralCurrent.base_type.pretty_print(value_obj)
end

--- @function NeutralCurrent:build_test_attr_report
---
...
NeutralCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NeutralCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NeutralCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NeutralCurrent:read(device)
...
function NeutralCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
