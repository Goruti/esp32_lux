...
--- @alias RMSVoltage
---
--- @field public ID number 0x0505 the ID of this attribute
--- @field public NAME string "RMSVoltage" the name of this attribute
...
function RMSVoltage:augment_type(base_type_obj)
...
function RMSVoltage.pretty_print(value_obj)
  RMSVoltage.base_type.pretty_print(value_obj)
end

--- @function RMSVoltage:build_test_attr_report
---
...
RMSVoltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltage:read(device)
...
function RMSVoltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
setmetatable(RMSVoltage, {__call = RMSVoltage.new_value})
return RMSVoltage
