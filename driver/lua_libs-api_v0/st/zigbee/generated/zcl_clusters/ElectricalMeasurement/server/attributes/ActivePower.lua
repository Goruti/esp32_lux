...
--- @alias ActivePower
---
--- @field public ID number 0x050b the ID of this attribute
--- @field public NAME string "ActivePower" the name of this attribute
...
function ActivePower.pretty_print(value_obj)
  ActivePower.base_type.pretty_print(value_obj)
end

--- @function ActivePower:build_test_attr_report
---
...
ActivePower.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActivePower:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActivePower.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActivePower:read(device)
...
function ActivePower:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
