...
--- @alias ActiveCurrentPhB
---
--- @field public ID number 0x0902 the ID of this attribute
--- @field public NAME string "ActiveCurrentPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ActiveCurrentPhB = {
  ID = 0x0902,
  NAME = "ActiveCurrentPhB",
  base_type = data_types.Int16,
}

function ActiveCurrentPhB:augment_type(base_type_obj)
...
function ActiveCurrentPhB.pretty_print(value_obj)
  ActiveCurrentPhB.base_type.pretty_print(value_obj)
end

--- @function ActiveCurrentPhB:build_test_attr_report
---
...
ActiveCurrentPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActiveCurrentPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActiveCurrentPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActiveCurrentPhB:new_value(...)
...
function ActiveCurrentPhB:read(device)
...
function ActiveCurrentPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ActiveCurrentPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ActiveCurrentPhB, {__call = ActiveCurrentPhB.new_value})
