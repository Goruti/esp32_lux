...
--- @alias ACVoltageOverload
---
--- @field public ID number 0x0801 the ID of this attribute
--- @field public NAME string "ACVoltageOverload" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ACVoltageOverload = {
  ID = 0x0801,
  NAME = "ACVoltageOverload",
  base_type = data_types.Int16,
}

function ACVoltageOverload:augment_type(base_type_obj)
...
function ACVoltageOverload.pretty_print(value_obj)
  ACVoltageOverload.base_type.pretty_print(value_obj)
end

--- @function ACVoltageOverload:build_test_attr_report
---
...
ACVoltageOverload.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACVoltageOverload:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACVoltageOverload.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACVoltageOverload:new_value(...)
...
function ACVoltageOverload:read(device)
...
function ACVoltageOverload:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACVoltageOverload:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACVoltageOverload, {__call = ACVoltageOverload.new_value})
