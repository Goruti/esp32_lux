...
--- @alias ACFrequencyDivisor
---
--- @field public ID number 0x0401 the ID of this attribute
--- @field public NAME string "ACFrequencyDivisor" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ACFrequencyDivisor = {
  ID = 0x0401,
  NAME = "ACFrequencyDivisor",
  base_type = data_types.Uint16,
}

function ACFrequencyDivisor:augment_type(base_type_obj)
...
function ACFrequencyDivisor.pretty_print(value_obj)
  ACFrequencyDivisor.base_type.pretty_print(value_obj)
end

--- @function ACFrequencyDivisor:build_test_attr_report
---
...
ACFrequencyDivisor.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACFrequencyDivisor:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACFrequencyDivisor.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACFrequencyDivisor:new_value(...)
...
function ACFrequencyDivisor:read(device)
...
function ACFrequencyDivisor:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACFrequencyDivisor:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACFrequencyDivisor, {__call = ACFrequencyDivisor.new_value})
