...
--- @alias ActivePowerPhB
---
--- @field public ID number 0x090b the ID of this attribute
--- @field public NAME string "ActivePowerPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ActivePowerPhB = {
  ID = 0x090b,
  NAME = "ActivePowerPhB",
  base_type = data_types.Int16,
}

function ActivePowerPhB:augment_type(base_type_obj)
...
function ActivePowerPhB.pretty_print(value_obj)
  ActivePowerPhB.base_type.pretty_print(value_obj)
end

--- @function ActivePowerPhB:build_test_attr_report
---
...
ActivePowerPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActivePowerPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActivePowerPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActivePowerPhB:new_value(...)
...
function ActivePowerPhB:read(device)
...
function ActivePowerPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ActivePowerPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ActivePowerPhB, {__call = ActivePowerPhB.new_value})
