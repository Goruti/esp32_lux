...
--- @alias ActivePowerMinPhC
---
--- @field public ID number 0x0a0c the ID of this attribute
--- @field public NAME string "ActivePowerMinPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ActivePowerMinPhC = {
  ID = 0x0a0c,
  NAME = "ActivePowerMinPhC",
  base_type = data_types.Int16,
}

function ActivePowerMinPhC:augment_type(base_type_obj)
...
function ActivePowerMinPhC.pretty_print(value_obj)
  ActivePowerMinPhC.base_type.pretty_print(value_obj)
end

--- @function ActivePowerMinPhC:build_test_attr_report
---
...
ActivePowerMinPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActivePowerMinPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActivePowerMinPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActivePowerMinPhC:new_value(...)
...
function ActivePowerMinPhC:read(device)
...
function ActivePowerMinPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ActivePowerMinPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ActivePowerMinPhC, {__call = ActivePowerMinPhC.new_value})
