...
--- @alias RMSVoltageMaxPhB
---
--- @field public ID number 0x0907 the ID of this attribute
--- @field public NAME string "RMSVoltageMaxPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSVoltageMaxPhB = {
  ID = 0x0907,
  NAME = "RMSVoltageMaxPhB",
  base_type = data_types.Uint16,
}

function RMSVoltageMaxPhB:augment_type(base_type_obj)
...
function RMSVoltageMaxPhB.pretty_print(value_obj)
  RMSVoltageMaxPhB.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageMaxPhB:build_test_attr_report
---
...
RMSVoltageMaxPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageMaxPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageMaxPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageMaxPhB:new_value(...)
...
function RMSVoltageMaxPhB:read(device)
...
function RMSVoltageMaxPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageMaxPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageMaxPhB, {__call = RMSVoltageMaxPhB.new_value})
