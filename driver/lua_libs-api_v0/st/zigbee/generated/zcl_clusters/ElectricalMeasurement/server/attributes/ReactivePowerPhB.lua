...
--- @alias ReactivePowerPhB
---
--- @field public ID number 0x090e the ID of this attribute
--- @field public NAME string "ReactivePowerPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ReactivePowerPhB = {
  ID = 0x090e,
  NAME = "ReactivePowerPhB",
  base_type = data_types.Int16,
}

function ReactivePowerPhB:augment_type(base_type_obj)
...
function ReactivePowerPhB.pretty_print(value_obj)
  ReactivePowerPhB.base_type.pretty_print(value_obj)
end

--- @function ReactivePowerPhB:build_test_attr_report
---
...
ReactivePowerPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ReactivePowerPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ReactivePowerPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ReactivePowerPhB:new_value(...)
...
function ReactivePowerPhB:read(device)
...
function ReactivePowerPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ReactivePowerPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ReactivePowerPhB, {__call = ReactivePowerPhB.new_value})
