...
function ACFrequencyMultiplier.pretty_print(value_obj)
  ACFrequencyMultiplier.base_type.pretty_print(value_obj)
end

--- @function ACFrequencyMultiplier:build_test_attr_report
---
...
ACFrequencyMultiplier.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACFrequencyMultiplier:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACFrequencyMultiplier.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACFrequencyMultiplier:new_value(...)
...
function ACFrequencyMultiplier:read(device)
...
function ACFrequencyMultiplier:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACFrequencyMultiplier:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACFrequencyMultiplier, {__call = ACFrequencyMultiplier.new_value})
