...
--- @alias RMSVoltageSag
---
--- @field public ID number 0x0809 the ID of this attribute
--- @field public NAME string "RMSVoltageSag" the name of this attribute
...
function RMSVoltageSag:augment_type(base_type_obj)
...
function RMSVoltageSag.pretty_print(value_obj)
  RMSVoltageSag.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageSag:build_test_attr_report
---
...
RMSVoltageSag.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageSag:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageSag.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageSag:new_value(...)
...
function RMSVoltageSag:read(device)
...
function RMSVoltageSag:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageSag:write(device, value)
...
function RMSVoltageSag:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageSag, {__call = RMSVoltageSag.new_value})
