...
--- @alias ACActivePowerOverload
---
--- @field public ID number 0x0803 the ID of this attribute
--- @field public NAME string "ACActivePowerOverload" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ACActivePowerOverload = {
  ID = 0x0803,
  NAME = "ACActivePowerOverload",
  base_type = data_types.Int16,
}

function ACActivePowerOverload:augment_type(base_type_obj)
...
function ACActivePowerOverload.pretty_print(value_obj)
  ACActivePowerOverload.base_type.pretty_print(value_obj)
end

--- @function ACActivePowerOverload:build_test_attr_report
---
...
ACActivePowerOverload.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACActivePowerOverload:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACActivePowerOverload.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACActivePowerOverload:new_value(...)
...
function ACActivePowerOverload:read(device)
...
function ACActivePowerOverload:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACActivePowerOverload:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACActivePowerOverload, {__call = ACActivePowerOverload.new_value})
