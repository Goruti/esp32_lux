...
--- @alias LineCurrentPhB
---
--- @field public ID number 0x0901 the ID of this attribute
--- @field public NAME string "LineCurrentPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local LineCurrentPhB = {
  ID = 0x0901,
  NAME = "LineCurrentPhB",
  base_type = data_types.Uint16,
}

function LineCurrentPhB:augment_type(base_type_obj)
...
function LineCurrentPhB.pretty_print(value_obj)
  LineCurrentPhB.base_type.pretty_print(value_obj)
end

--- @function LineCurrentPhB:build_test_attr_report
---
...
LineCurrentPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LineCurrentPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LineCurrentPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LineCurrentPhB:new_value(...)
...
function LineCurrentPhB:read(device)
...
function LineCurrentPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LineCurrentPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LineCurrentPhB, {__call = LineCurrentPhB.new_value})
