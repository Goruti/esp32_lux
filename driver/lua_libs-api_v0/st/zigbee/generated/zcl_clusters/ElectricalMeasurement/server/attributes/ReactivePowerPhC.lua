...
--- @alias ReactivePowerPhC
---
--- @field public ID number 0x0a0e the ID of this attribute
--- @field public NAME string "ReactivePowerPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ReactivePowerPhC = {
  ID = 0x0a0e,
  NAME = "ReactivePowerPhC",
  base_type = data_types.Int16,
}

function ReactivePowerPhC:augment_type(base_type_obj)
...
function ReactivePowerPhC.pretty_print(value_obj)
  ReactivePowerPhC.base_type.pretty_print(value_obj)
end

--- @function ReactivePowerPhC:build_test_attr_report
---
...
ReactivePowerPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ReactivePowerPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ReactivePowerPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ReactivePowerPhC:new_value(...)
...
function ReactivePowerPhC:read(device)
...
function ReactivePowerPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ReactivePowerPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ReactivePowerPhC, {__call = ReactivePowerPhC.new_value})
