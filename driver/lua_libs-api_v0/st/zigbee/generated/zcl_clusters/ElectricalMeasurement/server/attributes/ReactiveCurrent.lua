...
--- @alias ReactiveCurrent
---
--- @field public ID number 0x0503 the ID of this attribute
--- @field public NAME string "ReactiveCurrent" the name of this attribute
...
function ReactiveCurrent.pretty_print(value_obj)
  ReactiveCurrent.base_type.pretty_print(value_obj)
end

--- @function ReactiveCurrent:build_test_attr_report
---
...
ReactiveCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ReactiveCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ReactiveCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ReactiveCurrent:read(device)
...
function ReactiveCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
