...
--- @alias AverageRMSVoltageMeasurementPeriodPhC
---
--- @field public ID number 0x0a11 the ID of this attribute
--- @field public NAME string "AverageRMSVoltageMeasurementPeriodPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local AverageRMSVoltageMeasurementPeriodPhC = {
  ID = 0x0a11,
  NAME = "AverageRMSVoltageMeasurementPeriodPhC",
  base_type = data_types.Uint16,
}

function AverageRMSVoltageMeasurementPeriodPhC:augment_type(base_type_obj)
...
function AverageRMSVoltageMeasurementPeriodPhC.pretty_print(value_obj)
  AverageRMSVoltageMeasurementPeriodPhC.base_type.pretty_print(value_obj)
end

--- @function AverageRMSVoltageMeasurementPeriodPhC:build_test_attr_report
---
...
AverageRMSVoltageMeasurementPeriodPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSVoltageMeasurementPeriodPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSVoltageMeasurementPeriodPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSVoltageMeasurementPeriodPhC:new_value(...)
...
function AverageRMSVoltageMeasurementPeriodPhC:read(device)
...
function AverageRMSVoltageMeasurementPeriodPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSVoltageMeasurementPeriodPhC:write(device, value)
...
function AverageRMSVoltageMeasurementPeriodPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSVoltageMeasurementPeriodPhC, {__call = AverageRMSVoltageMeasurementPeriodPhC.new_value})
