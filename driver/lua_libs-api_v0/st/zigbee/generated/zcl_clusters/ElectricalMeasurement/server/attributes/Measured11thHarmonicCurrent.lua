...
--- @alias Measured11thHarmonicCurrent
---
--- @field public ID number 0x030c the ID of this attribute
--- @field public NAME string "Measured11thHarmonicCurrent" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local Measured11thHarmonicCurrent = {
  ID = 0x030c,
  NAME = "Measured11thHarmonicCurrent",
  base_type = data_types.Int16,
}

function Measured11thHarmonicCurrent:augment_type(base_type_obj)
...
function Measured11thHarmonicCurrent.pretty_print(value_obj)
  Measured11thHarmonicCurrent.base_type.pretty_print(value_obj)
end

--- @function Measured11thHarmonicCurrent:build_test_attr_report
---
...
Measured11thHarmonicCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Measured11thHarmonicCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Measured11thHarmonicCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Measured11thHarmonicCurrent:new_value(...)
...
function Measured11thHarmonicCurrent:read(device)
...
function Measured11thHarmonicCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Measured11thHarmonicCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Measured11thHarmonicCurrent, {__call = Measured11thHarmonicCurrent.new_value})
