...
--- @alias AverageRMSOverVoltageCounterPhB
---
--- @field public ID number 0x0912 the ID of this attribute
--- @field public NAME string "AverageRMSOverVoltageCounterPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local AverageRMSOverVoltageCounterPhB = {
  ID = 0x0912,
  NAME = "AverageRMSOverVoltageCounterPhB",
  base_type = data_types.Uint16,
}

function AverageRMSOverVoltageCounterPhB:augment_type(base_type_obj)
...
function AverageRMSOverVoltageCounterPhB.pretty_print(value_obj)
  AverageRMSOverVoltageCounterPhB.base_type.pretty_print(value_obj)
end

--- @function AverageRMSOverVoltageCounterPhB:build_test_attr_report
---
...
AverageRMSOverVoltageCounterPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSOverVoltageCounterPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSOverVoltageCounterPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSOverVoltageCounterPhB:new_value(...)
...
function AverageRMSOverVoltageCounterPhB:read(device)
...
function AverageRMSOverVoltageCounterPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSOverVoltageCounterPhB:write(device, value)
...
function AverageRMSOverVoltageCounterPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSOverVoltageCounterPhB, {__call = AverageRMSOverVoltageCounterPhB.new_value})
