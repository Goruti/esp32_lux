...
--- @alias ActivePowerPhC
---
--- @field public ID number 0x0a0b the ID of this attribute
--- @field public NAME string "ActivePowerPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ActivePowerPhC = {
  ID = 0x0a0b,
  NAME = "ActivePowerPhC",
  base_type = data_types.Int16,
}

function ActivePowerPhC:augment_type(base_type_obj)
...
function ActivePowerPhC.pretty_print(value_obj)
  ActivePowerPhC.base_type.pretty_print(value_obj)
end

--- @function ActivePowerPhC:build_test_attr_report
---
...
ActivePowerPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActivePowerPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActivePowerPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActivePowerPhC:new_value(...)
...
function ActivePowerPhC:read(device)
...
function ActivePowerPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ActivePowerPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ActivePowerPhC, {__call = ActivePowerPhC.new_value})
