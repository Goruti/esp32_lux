...
--- @alias Measured9thHarmonicCurrent
---
--- @field public ID number 0x030b the ID of this attribute
--- @field public NAME string "Measured9thHarmonicCurrent" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local Measured9thHarmonicCurrent = {
  ID = 0x030b,
  NAME = "Measured9thHarmonicCurrent",
  base_type = data_types.Int16,
}

function Measured9thHarmonicCurrent:augment_type(base_type_obj)
...
function Measured9thHarmonicCurrent.pretty_print(value_obj)
  Measured9thHarmonicCurrent.base_type.pretty_print(value_obj)
end

--- @function Measured9thHarmonicCurrent:build_test_attr_report
---
...
Measured9thHarmonicCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Measured9thHarmonicCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Measured9thHarmonicCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Measured9thHarmonicCurrent:new_value(...)
...
function Measured9thHarmonicCurrent:read(device)
...
function Measured9thHarmonicCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Measured9thHarmonicCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Measured9thHarmonicCurrent, {__call = Measured9thHarmonicCurrent.new_value})
