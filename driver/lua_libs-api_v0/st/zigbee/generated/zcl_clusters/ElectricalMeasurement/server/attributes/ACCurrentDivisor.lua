...
--- @alias ACCurrentDivisor
---
--- @field public ID number 0x0603 the ID of this attribute
--- @field public NAME string "ACCurrentDivisor" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ACCurrentDivisor = {
  ID = 0x0603,
  NAME = "ACCurrentDivisor",
  base_type = data_types.Uint16,
}

function ACCurrentDivisor:augment_type(base_type_obj)
...
function ACCurrentDivisor.pretty_print(value_obj)
  ACCurrentDivisor.base_type.pretty_print(value_obj)
end

--- @function ACCurrentDivisor:build_test_attr_report
---
...
ACCurrentDivisor.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACCurrentDivisor:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACCurrentDivisor.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACCurrentDivisor:new_value(...)
...
function ACCurrentDivisor:read(device)
...
function ACCurrentDivisor:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACCurrentDivisor:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACCurrentDivisor, {__call = ACCurrentDivisor.new_value})
