...
--- @alias ReactiveCurrentPhC
---
--- @field public ID number 0x0a03 the ID of this attribute
--- @field public NAME string "ReactiveCurrentPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ReactiveCurrentPhC = {
  ID = 0x0a03,
  NAME = "ReactiveCurrentPhC",
  base_type = data_types.Int16,
}

function ReactiveCurrentPhC:augment_type(base_type_obj)
...
function ReactiveCurrentPhC.pretty_print(value_obj)
  ReactiveCurrentPhC.base_type.pretty_print(value_obj)
end

--- @function ReactiveCurrentPhC:build_test_attr_report
---
...
ReactiveCurrentPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ReactiveCurrentPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ReactiveCurrentPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ReactiveCurrentPhC:new_value(...)
...
function ReactiveCurrentPhC:read(device)
...
function ReactiveCurrentPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ReactiveCurrentPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ReactiveCurrentPhC, {__call = ReactiveCurrentPhC.new_value})
