...
--- @field public NAME string "DCVoltageMin" the name of this attribute
...
function DCVoltageMin:augment_type(base_type_obj)
...
function DCVoltageMin.pretty_print(value_obj)
  DCVoltageMin.base_type.pretty_print(value_obj)
end

--- @function DCVoltageMin:build_test_attr_report
---
...
DCVoltageMin.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCVoltageMin:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCVoltageMin.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCVoltageMin:new_value(...)
...
function DCVoltageMin:read(device)
...
function DCVoltageMin:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCVoltageMin:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCVoltageMin, {__call = DCVoltageMin.new_value})
return DCVoltageMin
