...
--- @alias DCPowerDivisor
---
--- @field public ID number 0x0205 the ID of this attribute
--- @field public NAME string "DCPowerDivisor" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local DCPowerDivisor = {
  ID = 0x0205,
  NAME = "DCPowerDivisor",
  base_type = data_types.Uint16,
}

function DCPowerDivisor:augment_type(base_type_obj)
...
function DCPowerDivisor.pretty_print(value_obj)
  DCPowerDivisor.base_type.pretty_print(value_obj)
end

--- @function DCPowerDivisor:build_test_attr_report
---
...
DCPowerDivisor.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCPowerDivisor:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCPowerDivisor.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCPowerDivisor:new_value(...)
...
function DCPowerDivisor:read(device)
...
function DCPowerDivisor:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCPowerDivisor:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCPowerDivisor, {__call = DCPowerDivisor.new_value})
