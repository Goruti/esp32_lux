...
--- @alias RMSExtremeUnderVoltage
---
--- @field public ID number 0x0808 the ID of this attribute
--- @field public NAME string "RMSExtremeUnderVoltage" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local RMSExtremeUnderVoltage = {
  ID = 0x0808,
  NAME = "RMSExtremeUnderVoltage",
  base_type = data_types.Int16,
}

function RMSExtremeUnderVoltage:augment_type(base_type_obj)
...
function RMSExtremeUnderVoltage.pretty_print(value_obj)
  RMSExtremeUnderVoltage.base_type.pretty_print(value_obj)
end

--- @function RMSExtremeUnderVoltage:build_test_attr_report
---
...
RMSExtremeUnderVoltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSExtremeUnderVoltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSExtremeUnderVoltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSExtremeUnderVoltage:new_value(...)
...
function RMSExtremeUnderVoltage:read(device)
...
function RMSExtremeUnderVoltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
---
--- @param device st.zigbee.Device
--- @param value st.zigbee.data_types.Int16 the value to write
function RMSExtremeUnderVoltage:write(device, value)
...
function RMSExtremeUnderVoltage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSExtremeUnderVoltage, {__call = RMSExtremeUnderVoltage.new_value})
