...
--- @alias DCVoltageDivisor
---
--- @field public ID number 0x0201 the ID of this attribute
--- @field public NAME string "DCVoltageDivisor" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local DCVoltageDivisor = {
  ID = 0x0201,
  NAME = "DCVoltageDivisor",
  base_type = data_types.Uint16,
}

function DCVoltageDivisor:augment_type(base_type_obj)
...
function DCVoltageDivisor.pretty_print(value_obj)
  DCVoltageDivisor.base_type.pretty_print(value_obj)
end

--- @function DCVoltageDivisor:build_test_attr_report
---
...
DCVoltageDivisor.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCVoltageDivisor:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCVoltageDivisor.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCVoltageDivisor:new_value(...)
...
function DCVoltageDivisor:read(device)
...
function DCVoltageDivisor:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCVoltageDivisor:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCVoltageDivisor, {__call = DCVoltageDivisor.new_value})
