...
--- @alias RMSVoltageSwell
---
--- @field public ID number 0x080a the ID of this attribute
--- @field public NAME string "RMSVoltageSwell" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local RMSVoltageSwell = {
  ID = 0x080a,
  NAME = "RMSVoltageSwell",
  base_type = data_types.Int16,
}

function RMSVoltageSwell:augment_type(base_type_obj)
...
function RMSVoltageSwell.pretty_print(value_obj)
  RMSVoltageSwell.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageSwell:build_test_attr_report
---
...
RMSVoltageSwell.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageSwell:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageSwell.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageSwell:new_value(...)
...
function RMSVoltageSwell:read(device)
...
function RMSVoltageSwell:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageSwell:write(device, value)
...
function RMSVoltageSwell:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageSwell, {__call = RMSVoltageSwell.new_value})
