...
--- @alias RMSCurrentMinPhC
---
--- @field public ID number 0x0a09 the ID of this attribute
--- @field public NAME string "RMSCurrentMinPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSCurrentMinPhC = {
  ID = 0x0a09,
  NAME = "RMSCurrentMinPhC",
  base_type = data_types.Uint16,
}

function RMSCurrentMinPhC:augment_type(base_type_obj)
...
function RMSCurrentMinPhC.pretty_print(value_obj)
  RMSCurrentMinPhC.base_type.pretty_print(value_obj)
end

--- @function RMSCurrentMinPhC:build_test_attr_report
---
...
RMSCurrentMinPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSCurrentMinPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSCurrentMinPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSCurrentMinPhC:new_value(...)
...
function RMSCurrentMinPhC:read(device)
...
function RMSCurrentMinPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSCurrentMinPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSCurrentMinPhC, {__call = RMSCurrentMinPhC.new_value})
