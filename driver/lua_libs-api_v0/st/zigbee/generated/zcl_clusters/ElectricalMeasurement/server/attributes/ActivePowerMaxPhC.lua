...
--- @alias ActivePowerMaxPhC
---
--- @field public ID number 0x0a0d the ID of this attribute
--- @field public NAME string "ActivePowerMaxPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ActivePowerMaxPhC = {
  ID = 0x0a0d,
  NAME = "ActivePowerMaxPhC",
  base_type = data_types.Int16,
}

function ActivePowerMaxPhC:augment_type(base_type_obj)
...
function ActivePowerMaxPhC.pretty_print(value_obj)
  ActivePowerMaxPhC.base_type.pretty_print(value_obj)
end

--- @function ActivePowerMaxPhC:build_test_attr_report
---
...
ActivePowerMaxPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActivePowerMaxPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActivePowerMaxPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActivePowerMaxPhC:new_value(...)
...
function ActivePowerMaxPhC:read(device)
...
function ActivePowerMaxPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ActivePowerMaxPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ActivePowerMaxPhC, {__call = ActivePowerMaxPhC.new_value})
