...
--- @alias RMSVoltageMin
---
--- @field public ID number 0x0506 the ID of this attribute
--- @field public NAME string "RMSVoltageMin" the name of this attribute
...
function RMSVoltageMin:augment_type(base_type_obj)
...
function RMSVoltageMin.pretty_print(value_obj)
  RMSVoltageMin.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageMin:build_test_attr_report
---
...
RMSVoltageMin.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageMin:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageMin.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageMin:new_value(...)
...
function RMSVoltageMin:read(device)
...
function RMSVoltageMin:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageMin:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageMin, {__call = RMSVoltageMin.new_value})
