...
--- @alias RMSCurrentPhB
---
--- @field public ID number 0x0908 the ID of this attribute
--- @field public NAME string "RMSCurrentPhB" the name of this attribute
...
function RMSCurrentPhB:augment_type(base_type_obj)
...
function RMSCurrentPhB.pretty_print(value_obj)
  RMSCurrentPhB.base_type.pretty_print(value_obj)
end

--- @function RMSCurrentPhB:build_test_attr_report
---
...
RMSCurrentPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSCurrentPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSCurrentPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSCurrentPhB:new_value(...)
...
function RMSCurrentPhB:read(device)
...
function RMSCurrentPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSCurrentPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSCurrentPhB, {__call = RMSCurrentPhB.new_value})
