...
--- @field public NAME string "DCVoltageMax" the name of this attribute
...
function DCVoltageMax:augment_type(base_type_obj)
...
function DCVoltageMax.pretty_print(value_obj)
  DCVoltageMax.base_type.pretty_print(value_obj)
end

--- @function DCVoltageMax:build_test_attr_report
---
...
DCVoltageMax.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCVoltageMax:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCVoltageMax.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCVoltageMax:new_value(...)
...
function DCVoltageMax:read(device)
...
function DCVoltageMax:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCVoltageMax:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCVoltageMax, {__call = DCVoltageMax.new_value})
return DCVoltageMax
