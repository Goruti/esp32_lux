...
--- @alias RMSVoltageSagPeriodPhB
---
--- @field public ID number 0x0916 the ID of this attribute
--- @field public NAME string "RMSVoltageSagPeriodPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSVoltageSagPeriodPhB = {
  ID = 0x0916,
  NAME = "RMSVoltageSagPeriodPhB",
  base_type = data_types.Uint16,
}

function RMSVoltageSagPeriodPhB:augment_type(base_type_obj)
...
function RMSVoltageSagPeriodPhB.pretty_print(value_obj)
  RMSVoltageSagPeriodPhB.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageSagPeriodPhB:build_test_attr_report
---
...
RMSVoltageSagPeriodPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageSagPeriodPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageSagPeriodPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageSagPeriodPhB:new_value(...)
...
function RMSVoltageSagPeriodPhB:read(device)
...
function RMSVoltageSagPeriodPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageSagPeriodPhB:write(device, value)
...
function RMSVoltageSagPeriodPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageSagPeriodPhB, {__call = RMSVoltageSagPeriodPhB.new_value})
