...
--- @alias ACCurrentMultiplier
---
--- @field public ID number 0x0602 the ID of this attribute
--- @field public NAME string "ACCurrentMultiplier" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ACCurrentMultiplier = {
  ID = 0x0602,
  NAME = "ACCurrentMultiplier",
  base_type = data_types.Uint16,
}

function ACCurrentMultiplier:augment_type(base_type_obj)
...
function ACCurrentMultiplier.pretty_print(value_obj)
  ACCurrentMultiplier.base_type.pretty_print(value_obj)
end

--- @function ACCurrentMultiplier:build_test_attr_report
---
...
ACCurrentMultiplier.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACCurrentMultiplier:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACCurrentMultiplier.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACCurrentMultiplier:new_value(...)
...
function ACCurrentMultiplier:read(device)
...
function ACCurrentMultiplier:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACCurrentMultiplier:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACCurrentMultiplier, {__call = ACCurrentMultiplier.new_value})
