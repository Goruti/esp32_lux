...
--- @alias ApparentPowerPhC
---
--- @field public ID number 0x0a0f the ID of this attribute
--- @field public NAME string "ApparentPowerPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ApparentPowerPhC = {
  ID = 0x0a0f,
  NAME = "ApparentPowerPhC",
  base_type = data_types.Uint16,
}

function ApparentPowerPhC:augment_type(base_type_obj)
...
function ApparentPowerPhC.pretty_print(value_obj)
  ApparentPowerPhC.base_type.pretty_print(value_obj)
end

--- @function ApparentPowerPhC:build_test_attr_report
---
...
ApparentPowerPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ApparentPowerPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ApparentPowerPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ApparentPowerPhC:new_value(...)
...
function ApparentPowerPhC:read(device)
...
function ApparentPowerPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ApparentPowerPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ApparentPowerPhC, {__call = ApparentPowerPhC.new_value})
