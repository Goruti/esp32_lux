...
--- @alias DCPowerMultiplier
---
--- @field public ID number 0x0204 the ID of this attribute
--- @field public NAME string "DCPowerMultiplier" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local DCPowerMultiplier = {
  ID = 0x0204,
  NAME = "DCPowerMultiplier",
  base_type = data_types.Uint16,
}

function DCPowerMultiplier:augment_type(base_type_obj)
...
function DCPowerMultiplier.pretty_print(value_obj)
  DCPowerMultiplier.base_type.pretty_print(value_obj)
end

--- @function DCPowerMultiplier:build_test_attr_report
---
...
DCPowerMultiplier.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCPowerMultiplier:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCPowerMultiplier.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCPowerMultiplier:new_value(...)
...
function DCPowerMultiplier:read(device)
...
function DCPowerMultiplier:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCPowerMultiplier:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCPowerMultiplier, {__call = DCPowerMultiplier.new_value})
