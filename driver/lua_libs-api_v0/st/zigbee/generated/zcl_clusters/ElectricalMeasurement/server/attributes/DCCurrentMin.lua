...
--- @field public NAME string "DCCurrentMin" the name of this attribute
...
function DCCurrentMin:augment_type(base_type_obj)
...
function DCCurrentMin.pretty_print(value_obj)
  DCCurrentMin.base_type.pretty_print(value_obj)
end

--- @function DCCurrentMin:build_test_attr_report
---
...
DCCurrentMin.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCCurrentMin:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCCurrentMin.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCCurrentMin:new_value(...)
...
function DCCurrentMin:read(device)
...
function DCCurrentMin:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCCurrentMin:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCCurrentMin, {__call = DCCurrentMin.new_value})
return DCCurrentMin
