...
--- @alias RMSExtremeOverVoltagePeriodPhB
---
--- @field public ID number 0x0914 the ID of this attribute
--- @field public NAME string "RMSExtremeOverVoltagePeriodPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSExtremeOverVoltagePeriodPhB = {
  ID = 0x0914,
  NAME = "RMSExtremeOverVoltagePeriodPhB",
  base_type = data_types.Uint16,
}

function RMSExtremeOverVoltagePeriodPhB:augment_type(base_type_obj)
...
function RMSExtremeOverVoltagePeriodPhB.pretty_print(value_obj)
  RMSExtremeOverVoltagePeriodPhB.base_type.pretty_print(value_obj)
end

--- @function RMSExtremeOverVoltagePeriodPhB:build_test_attr_report
---
...
RMSExtremeOverVoltagePeriodPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSExtremeOverVoltagePeriodPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSExtremeOverVoltagePeriodPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSExtremeOverVoltagePeriodPhB:new_value(...)
...
function RMSExtremeOverVoltagePeriodPhB:read(device)
...
function RMSExtremeOverVoltagePeriodPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSExtremeOverVoltagePeriodPhB:write(device, value)
...
function RMSExtremeOverVoltagePeriodPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSExtremeOverVoltagePeriodPhB, {__call = RMSExtremeOverVoltagePeriodPhB.new_value})
