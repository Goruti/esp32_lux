...
--- @alias PowerDivisor
---
--- @field public ID number 0x0403 the ID of this attribute
--- @field public NAME string "PowerDivisor" the name of this attribute
...
function PowerDivisor:augment_type(base_type_obj)
...
function PowerDivisor.pretty_print(value_obj)
  PowerDivisor.base_type.pretty_print(value_obj)
end

--- @function PowerDivisor:build_test_attr_report
---
...
PowerDivisor.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PowerDivisor:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PowerDivisor.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PowerDivisor:new_value(...)
...
function PowerDivisor:read(device)
...
function PowerDivisor:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PowerDivisor:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PowerDivisor, {__call = PowerDivisor.new_value})
return PowerDivisor
