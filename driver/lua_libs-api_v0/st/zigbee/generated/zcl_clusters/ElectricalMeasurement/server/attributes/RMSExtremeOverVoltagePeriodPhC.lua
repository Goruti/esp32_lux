...
--- @alias RMSExtremeOverVoltagePeriodPhC
---
--- @field public ID number 0x0a14 the ID of this attribute
--- @field public NAME string "RMSExtremeOverVoltagePeriodPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSExtremeOverVoltagePeriodPhC = {
  ID = 0x0a14,
  NAME = "RMSExtremeOverVoltagePeriodPhC",
  base_type = data_types.Uint16,
}

function RMSExtremeOverVoltagePeriodPhC:augment_type(base_type_obj)
...
function RMSExtremeOverVoltagePeriodPhC.pretty_print(value_obj)
  RMSExtremeOverVoltagePeriodPhC.base_type.pretty_print(value_obj)
end

--- @function RMSExtremeOverVoltagePeriodPhC:build_test_attr_report
---
...
RMSExtremeOverVoltagePeriodPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSExtremeOverVoltagePeriodPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSExtremeOverVoltagePeriodPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSExtremeOverVoltagePeriodPhC:new_value(...)
...
function RMSExtremeOverVoltagePeriodPhC:read(device)
...
function RMSExtremeOverVoltagePeriodPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSExtremeOverVoltagePeriodPhC:write(device, value)
...
function RMSExtremeOverVoltagePeriodPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSExtremeOverVoltagePeriodPhC, {__call = RMSExtremeOverVoltagePeriodPhC.new_value})
