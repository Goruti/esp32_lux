...
--- @alias ACFrequency
---
--- @field public ID number 0x0300 the ID of this attribute
--- @field public NAME string "ACFrequency" the name of this attribute
...
function ACFrequency:augment_type(base_type_obj)
...
function ACFrequency.pretty_print(value_obj)
  ACFrequency.base_type.pretty_print(value_obj)
end

--- @function ACFrequency:build_test_attr_report
---
...
ACFrequency.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACFrequency:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACFrequency.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACFrequency:new_value(...)
...
function ACFrequency:read(device)
...
function ACFrequency:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACFrequency:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACFrequency, {__call = ACFrequency.new_value})
return ACFrequency
