...
--- @alias MeasuredPhase1stHarmonicCurrent
---
--- @field public ID number 0x030d the ID of this attribute
--- @field public NAME string "MeasuredPhase1stHarmonicCurrent" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local MeasuredPhase1stHarmonicCurrent = {
  ID = 0x030d,
  NAME = "MeasuredPhase1stHarmonicCurrent",
  base_type = data_types.Int16,
}

function MeasuredPhase1stHarmonicCurrent:augment_type(base_type_obj)
...
function MeasuredPhase1stHarmonicCurrent.pretty_print(value_obj)
  MeasuredPhase1stHarmonicCurrent.base_type.pretty_print(value_obj)
end

--- @function MeasuredPhase1stHarmonicCurrent:build_test_attr_report
---
...
MeasuredPhase1stHarmonicCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MeasuredPhase1stHarmonicCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MeasuredPhase1stHarmonicCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MeasuredPhase1stHarmonicCurrent:new_value(...)
...
function MeasuredPhase1stHarmonicCurrent:read(device)
...
function MeasuredPhase1stHarmonicCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MeasuredPhase1stHarmonicCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MeasuredPhase1stHarmonicCurrent, {__call = MeasuredPhase1stHarmonicCurrent.new_value})
