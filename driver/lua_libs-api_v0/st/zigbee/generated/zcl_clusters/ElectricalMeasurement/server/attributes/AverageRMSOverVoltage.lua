...
--- @alias AverageRMSOverVoltage
---
--- @field public ID number 0x0805 the ID of this attribute
--- @field public NAME string "AverageRMSOverVoltage" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local AverageRMSOverVoltage = {
  ID = 0x0805,
  NAME = "AverageRMSOverVoltage",
  base_type = data_types.Int16,
}

function AverageRMSOverVoltage:augment_type(base_type_obj)
...
function AverageRMSOverVoltage.pretty_print(value_obj)
  AverageRMSOverVoltage.base_type.pretty_print(value_obj)
end

--- @function AverageRMSOverVoltage:build_test_attr_report
---
...
AverageRMSOverVoltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSOverVoltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSOverVoltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSOverVoltage:new_value(...)
...
function AverageRMSOverVoltage:read(device)
...
function AverageRMSOverVoltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSOverVoltage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSOverVoltage, {__call = AverageRMSOverVoltage.new_value})
