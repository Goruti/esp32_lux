...
--- @alias AverageRMSOverVoltageCounterPhC
---
--- @field public ID number 0x0a12 the ID of this attribute
--- @field public NAME string "AverageRMSOverVoltageCounterPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local AverageRMSOverVoltageCounterPhC = {
  ID = 0x0a12,
  NAME = "AverageRMSOverVoltageCounterPhC",
  base_type = data_types.Uint16,
}

function AverageRMSOverVoltageCounterPhC:augment_type(base_type_obj)
...
function AverageRMSOverVoltageCounterPhC.pretty_print(value_obj)
  AverageRMSOverVoltageCounterPhC.base_type.pretty_print(value_obj)
end

--- @function AverageRMSOverVoltageCounterPhC:build_test_attr_report
---
...
AverageRMSOverVoltageCounterPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSOverVoltageCounterPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSOverVoltageCounterPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSOverVoltageCounterPhC:new_value(...)
...
function AverageRMSOverVoltageCounterPhC:read(device)
...
function AverageRMSOverVoltageCounterPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSOverVoltageCounterPhC:write(device, value)
...
function AverageRMSOverVoltageCounterPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSOverVoltageCounterPhC, {__call = AverageRMSOverVoltageCounterPhC.new_value})
