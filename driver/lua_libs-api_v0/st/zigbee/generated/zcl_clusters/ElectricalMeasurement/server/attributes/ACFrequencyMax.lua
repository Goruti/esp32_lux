...
function ACFrequencyMax.pretty_print(value_obj)
  ACFrequencyMax.base_type.pretty_print(value_obj)
end

--- @function ACFrequencyMax:build_test_attr_report
---
...
ACFrequencyMax.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACFrequencyMax:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACFrequencyMax.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACFrequencyMax:new_value(...)
...
function ACFrequencyMax:read(device)
...
function ACFrequencyMax:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACFrequencyMax:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACFrequencyMax, {__call = ACFrequencyMax.new_value})
