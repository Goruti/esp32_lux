...
--- @alias RMSCurrentMinPhB
---
--- @field public ID number 0x0909 the ID of this attribute
--- @field public NAME string "RMSCurrentMinPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSCurrentMinPhB = {
  ID = 0x0909,
  NAME = "RMSCurrentMinPhB",
  base_type = data_types.Uint16,
}

function RMSCurrentMinPhB:augment_type(base_type_obj)
...
function RMSCurrentMinPhB.pretty_print(value_obj)
  RMSCurrentMinPhB.base_type.pretty_print(value_obj)
end

--- @function RMSCurrentMinPhB:build_test_attr_report
---
...
RMSCurrentMinPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSCurrentMinPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSCurrentMinPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSCurrentMinPhB:new_value(...)
...
function RMSCurrentMinPhB:read(device)
...
function RMSCurrentMinPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSCurrentMinPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSCurrentMinPhB, {__call = RMSCurrentMinPhB.new_value})
