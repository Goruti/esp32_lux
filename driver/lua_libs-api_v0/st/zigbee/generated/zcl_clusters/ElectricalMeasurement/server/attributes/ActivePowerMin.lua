...
--- @alias ActivePowerMin
---
--- @field public ID number 0x050c the ID of this attribute
--- @field public NAME string "ActivePowerMin" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ActivePowerMin = {
  ID = 0x050c,
  NAME = "ActivePowerMin",
  base_type = data_types.Int16,
}

function ActivePowerMin:augment_type(base_type_obj)
...
function ActivePowerMin.pretty_print(value_obj)
  ActivePowerMin.base_type.pretty_print(value_obj)
end

--- @function ActivePowerMin:build_test_attr_report
---
...
ActivePowerMin.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActivePowerMin:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActivePowerMin.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActivePowerMin:new_value(...)
...
function ActivePowerMin:read(device)
...
function ActivePowerMin:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ActivePowerMin:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ActivePowerMin, {__call = ActivePowerMin.new_value})
