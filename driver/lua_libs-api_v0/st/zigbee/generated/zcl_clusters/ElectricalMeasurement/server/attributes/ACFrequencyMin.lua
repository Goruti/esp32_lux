...
function ACFrequencyMin.pretty_print(value_obj)
  ACFrequencyMin.base_type.pretty_print(value_obj)
end

--- @function ACFrequencyMin:build_test_attr_report
---
...
ACFrequencyMin.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACFrequencyMin:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACFrequencyMin.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACFrequencyMin:new_value(...)
...
function ACFrequencyMin:read(device)
...
function ACFrequencyMin:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACFrequencyMin:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACFrequencyMin, {__call = ACFrequencyMin.new_value})
