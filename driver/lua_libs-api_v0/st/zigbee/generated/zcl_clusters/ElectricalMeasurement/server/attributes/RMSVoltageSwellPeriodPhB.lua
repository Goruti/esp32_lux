...
--- @alias RMSVoltageSwellPeriodPhB
---
--- @field public ID number 0x0917 the ID of this attribute
--- @field public NAME string "RMSVoltageSwellPeriodPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSVoltageSwellPeriodPhB = {
  ID = 0x0917,
  NAME = "RMSVoltageSwellPeriodPhB",
  base_type = data_types.Uint16,
}

function RMSVoltageSwellPeriodPhB:augment_type(base_type_obj)
...
function RMSVoltageSwellPeriodPhB.pretty_print(value_obj)
  RMSVoltageSwellPeriodPhB.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageSwellPeriodPhB:build_test_attr_report
---
...
RMSVoltageSwellPeriodPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageSwellPeriodPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageSwellPeriodPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageSwellPeriodPhB:new_value(...)
...
function RMSVoltageSwellPeriodPhB:read(device)
...
function RMSVoltageSwellPeriodPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageSwellPeriodPhB:write(device, value)
...
function RMSVoltageSwellPeriodPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageSwellPeriodPhB, {__call = RMSVoltageSwellPeriodPhB.new_value})
