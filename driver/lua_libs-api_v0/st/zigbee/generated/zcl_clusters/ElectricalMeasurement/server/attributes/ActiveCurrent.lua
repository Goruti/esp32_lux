...
--- @alias ActiveCurrent
---
--- @field public ID number 0x0502 the ID of this attribute
--- @field public NAME string "ActiveCurrent" the name of this attribute
...
function ActiveCurrent:augment_type(base_type_obj)
...
function ActiveCurrent.pretty_print(value_obj)
  ActiveCurrent.base_type.pretty_print(value_obj)
end

--- @function ActiveCurrent:build_test_attr_report
---
...
ActiveCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActiveCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActiveCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActiveCurrent:read(device)
...
function ActiveCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
setmetatable(ActiveCurrent, {__call = ActiveCurrent.new_value})
