...
--- @alias RMSVoltageMinPhB
---
--- @field public ID number 0x0906 the ID of this attribute
--- @field public NAME string "RMSVoltageMinPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSVoltageMinPhB = {
  ID = 0x0906,
  NAME = "RMSVoltageMinPhB",
  base_type = data_types.Uint16,
}

function RMSVoltageMinPhB:augment_type(base_type_obj)
...
function RMSVoltageMinPhB.pretty_print(value_obj)
  RMSVoltageMinPhB.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageMinPhB:build_test_attr_report
---
...
RMSVoltageMinPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageMinPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageMinPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageMinPhB:new_value(...)
...
function RMSVoltageMinPhB:read(device)
...
function RMSVoltageMinPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageMinPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageMinPhB, {__call = RMSVoltageMinPhB.new_value})
