...
--- @alias RMSVoltageSagPeriod
---
--- @field public ID number 0x0516 the ID of this attribute
--- @field public NAME string "RMSVoltageSagPeriod" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSVoltageSagPeriod = {
  ID = 0x0516,
  NAME = "RMSVoltageSagPeriod",
  base_type = data_types.Uint16,
}

function RMSVoltageSagPeriod:augment_type(base_type_obj)
...
function RMSVoltageSagPeriod.pretty_print(value_obj)
  RMSVoltageSagPeriod.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageSagPeriod:build_test_attr_report
---
...
RMSVoltageSagPeriod.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageSagPeriod:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageSagPeriod.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageSagPeriod:new_value(...)
...
function RMSVoltageSagPeriod:read(device)
...
function RMSVoltageSagPeriod:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageSagPeriod:write(device, value)
...
function RMSVoltageSagPeriod:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageSagPeriod, {__call = RMSVoltageSagPeriod.new_value})
