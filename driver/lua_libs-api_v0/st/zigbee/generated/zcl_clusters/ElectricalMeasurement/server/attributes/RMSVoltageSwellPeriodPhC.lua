...
--- @alias RMSVoltageSwellPeriodPhC
---
--- @field public ID number 0x0a17 the ID of this attribute
--- @field public NAME string "RMSVoltageSwellPeriodPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSVoltageSwellPeriodPhC = {
  ID = 0x0a17,
  NAME = "RMSVoltageSwellPeriodPhC",
  base_type = data_types.Uint16,
}

function RMSVoltageSwellPeriodPhC:augment_type(base_type_obj)
...
function RMSVoltageSwellPeriodPhC.pretty_print(value_obj)
  RMSVoltageSwellPeriodPhC.base_type.pretty_print(value_obj)
end

--- @function RMSVoltageSwellPeriodPhC:build_test_attr_report
---
...
RMSVoltageSwellPeriodPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltageSwellPeriodPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltageSwellPeriodPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltageSwellPeriodPhC:new_value(...)
...
function RMSVoltageSwellPeriodPhC:read(device)
...
function RMSVoltageSwellPeriodPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltageSwellPeriodPhC:write(device, value)
...
function RMSVoltageSwellPeriodPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltageSwellPeriodPhC, {__call = RMSVoltageSwellPeriodPhC.new_value})
