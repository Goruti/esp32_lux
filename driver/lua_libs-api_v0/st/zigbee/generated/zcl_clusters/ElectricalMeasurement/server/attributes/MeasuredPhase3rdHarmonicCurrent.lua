...
--- @alias MeasuredPhase3rdHarmonicCurrent
---
--- @field public ID number 0x030e the ID of this attribute
--- @field public NAME string "MeasuredPhase3rdHarmonicCurrent" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local MeasuredPhase3rdHarmonicCurrent = {
  ID = 0x030e,
  NAME = "MeasuredPhase3rdHarmonicCurrent",
  base_type = data_types.Int16,
}

function MeasuredPhase3rdHarmonicCurrent:augment_type(base_type_obj)
...
function MeasuredPhase3rdHarmonicCurrent.pretty_print(value_obj)
  MeasuredPhase3rdHarmonicCurrent.base_type.pretty_print(value_obj)
end

--- @function MeasuredPhase3rdHarmonicCurrent:build_test_attr_report
---
...
MeasuredPhase3rdHarmonicCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MeasuredPhase3rdHarmonicCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MeasuredPhase3rdHarmonicCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MeasuredPhase3rdHarmonicCurrent:new_value(...)
...
function MeasuredPhase3rdHarmonicCurrent:read(device)
...
function MeasuredPhase3rdHarmonicCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MeasuredPhase3rdHarmonicCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MeasuredPhase3rdHarmonicCurrent, {__call = MeasuredPhase3rdHarmonicCurrent.new_value})
