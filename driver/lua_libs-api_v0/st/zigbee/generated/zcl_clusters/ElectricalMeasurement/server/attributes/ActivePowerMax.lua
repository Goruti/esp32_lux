...
--- @alias ActivePowerMax
---
--- @field public ID number 0x050d the ID of this attribute
--- @field public NAME string "ActivePowerMax" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ActivePowerMax = {
  ID = 0x050d,
  NAME = "ActivePowerMax",
  base_type = data_types.Int16,
}

function ActivePowerMax:augment_type(base_type_obj)
...
function ActivePowerMax.pretty_print(value_obj)
  ActivePowerMax.base_type.pretty_print(value_obj)
end

--- @function ActivePowerMax:build_test_attr_report
---
...
ActivePowerMax.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActivePowerMax:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActivePowerMax.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActivePowerMax:new_value(...)
...
function ActivePowerMax:read(device)
...
function ActivePowerMax:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ActivePowerMax:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ActivePowerMax, {__call = ActivePowerMax.new_value})
