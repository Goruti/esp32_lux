...
--- @alias RMSVoltagePhB
---
--- @field public ID number 0x0905 the ID of this attribute
--- @field public NAME string "RMSVoltagePhB" the name of this attribute
...
function RMSVoltagePhB:augment_type(base_type_obj)
...
function RMSVoltagePhB.pretty_print(value_obj)
  RMSVoltagePhB.base_type.pretty_print(value_obj)
end

--- @function RMSVoltagePhB:build_test_attr_report
---
...
RMSVoltagePhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSVoltagePhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSVoltagePhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSVoltagePhB:new_value(...)
...
function RMSVoltagePhB:read(device)
...
function RMSVoltagePhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSVoltagePhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSVoltagePhB, {__call = RMSVoltagePhB.new_value})
