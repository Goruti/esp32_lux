...
--- @alias MeasuredPhase7thHarmonicCurrent
---
--- @field public ID number 0x0310 the ID of this attribute
--- @field public NAME string "MeasuredPhase7thHarmonicCurrent" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local MeasuredPhase7thHarmonicCurrent = {
  ID = 0x0310,
  NAME = "MeasuredPhase7thHarmonicCurrent",
  base_type = data_types.Int16,
}

function MeasuredPhase7thHarmonicCurrent:augment_type(base_type_obj)
...
function MeasuredPhase7thHarmonicCurrent.pretty_print(value_obj)
  MeasuredPhase7thHarmonicCurrent.base_type.pretty_print(value_obj)
end

--- @function MeasuredPhase7thHarmonicCurrent:build_test_attr_report
---
...
MeasuredPhase7thHarmonicCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MeasuredPhase7thHarmonicCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MeasuredPhase7thHarmonicCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MeasuredPhase7thHarmonicCurrent:new_value(...)
...
function MeasuredPhase7thHarmonicCurrent:read(device)
...
function MeasuredPhase7thHarmonicCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MeasuredPhase7thHarmonicCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MeasuredPhase7thHarmonicCurrent, {__call = MeasuredPhase7thHarmonicCurrent.new_value})
