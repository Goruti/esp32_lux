...
--- @alias AverageRMSUnderVoltageCounterPhB
---
--- @field public ID number 0x0913 the ID of this attribute
--- @field public NAME string "AverageRMSUnderVoltageCounterPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local AverageRMSUnderVoltageCounterPhB = {
  ID = 0x0913,
  NAME = "AverageRMSUnderVoltageCounterPhB",
  base_type = data_types.Uint16,
}

function AverageRMSUnderVoltageCounterPhB:augment_type(base_type_obj)
...
function AverageRMSUnderVoltageCounterPhB.pretty_print(value_obj)
  AverageRMSUnderVoltageCounterPhB.base_type.pretty_print(value_obj)
end

--- @function AverageRMSUnderVoltageCounterPhB:build_test_attr_report
---
...
AverageRMSUnderVoltageCounterPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSUnderVoltageCounterPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSUnderVoltageCounterPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSUnderVoltageCounterPhB:new_value(...)
...
function AverageRMSUnderVoltageCounterPhB:read(device)
...
function AverageRMSUnderVoltageCounterPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSUnderVoltageCounterPhB:write(device, value)
...
function AverageRMSUnderVoltageCounterPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSUnderVoltageCounterPhB, {__call = AverageRMSUnderVoltageCounterPhB.new_value})
