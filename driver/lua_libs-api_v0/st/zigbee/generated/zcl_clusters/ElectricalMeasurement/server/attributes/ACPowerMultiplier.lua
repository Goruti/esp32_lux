...
--- @alias ACPowerMultiplier
---
--- @field public ID number 0x0604 the ID of this attribute
--- @field public NAME string "ACPowerMultiplier" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ACPowerMultiplier = {
  ID = 0x0604,
  NAME = "ACPowerMultiplier",
  base_type = data_types.Uint16,
}

function ACPowerMultiplier:augment_type(base_type_obj)
...
function ACPowerMultiplier.pretty_print(value_obj)
  ACPowerMultiplier.base_type.pretty_print(value_obj)
end

--- @function ACPowerMultiplier:build_test_attr_report
---
...
ACPowerMultiplier.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACPowerMultiplier:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACPowerMultiplier.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACPowerMultiplier:new_value(...)
...
function ACPowerMultiplier:read(device)
...
function ACPowerMultiplier:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACPowerMultiplier:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACPowerMultiplier, {__call = ACPowerMultiplier.new_value})
