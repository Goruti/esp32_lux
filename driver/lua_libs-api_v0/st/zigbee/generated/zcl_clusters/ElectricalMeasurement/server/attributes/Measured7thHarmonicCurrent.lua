...
--- @alias Measured7thHarmonicCurrent
---
--- @field public ID number 0x030a the ID of this attribute
--- @field public NAME string "Measured7thHarmonicCurrent" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local Measured7thHarmonicCurrent = {
  ID = 0x030a,
  NAME = "Measured7thHarmonicCurrent",
  base_type = data_types.Int16,
}

function Measured7thHarmonicCurrent:augment_type(base_type_obj)
...
function Measured7thHarmonicCurrent.pretty_print(value_obj)
  Measured7thHarmonicCurrent.base_type.pretty_print(value_obj)
end

--- @function Measured7thHarmonicCurrent:build_test_attr_report
---
...
Measured7thHarmonicCurrent.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Measured7thHarmonicCurrent:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Measured7thHarmonicCurrent.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Measured7thHarmonicCurrent:new_value(...)
...
function Measured7thHarmonicCurrent:read(device)
...
function Measured7thHarmonicCurrent:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Measured7thHarmonicCurrent:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Measured7thHarmonicCurrent, {__call = Measured7thHarmonicCurrent.new_value})
