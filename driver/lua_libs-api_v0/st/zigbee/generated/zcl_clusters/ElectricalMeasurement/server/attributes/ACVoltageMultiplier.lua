...
--- @alias ACVoltageMultiplier
---
--- @field public ID number 0x0600 the ID of this attribute
--- @field public NAME string "ACVoltageMultiplier" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ACVoltageMultiplier = {
  ID = 0x0600,
  NAME = "ACVoltageMultiplier",
  base_type = data_types.Uint16,
}

function ACVoltageMultiplier:augment_type(base_type_obj)
...
function ACVoltageMultiplier.pretty_print(value_obj)
  ACVoltageMultiplier.base_type.pretty_print(value_obj)
end

--- @function ACVoltageMultiplier:build_test_attr_report
---
...
ACVoltageMultiplier.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACVoltageMultiplier:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACVoltageMultiplier.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACVoltageMultiplier:new_value(...)
...
function ACVoltageMultiplier:read(device)
...
function ACVoltageMultiplier:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACVoltageMultiplier:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACVoltageMultiplier, {__call = ACVoltageMultiplier.new_value})
