...
--- @alias ReactiveCurrentPhB
---
--- @field public ID number 0x0903 the ID of this attribute
--- @field public NAME string "ReactiveCurrentPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ReactiveCurrentPhB = {
  ID = 0x0903,
  NAME = "ReactiveCurrentPhB",
  base_type = data_types.Int16,
}

function ReactiveCurrentPhB:augment_type(base_type_obj)
...
function ReactiveCurrentPhB.pretty_print(value_obj)
  ReactiveCurrentPhB.base_type.pretty_print(value_obj)
end

--- @function ReactiveCurrentPhB:build_test_attr_report
---
...
ReactiveCurrentPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ReactiveCurrentPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ReactiveCurrentPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ReactiveCurrentPhB:new_value(...)
...
function ReactiveCurrentPhB:read(device)
...
function ReactiveCurrentPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ReactiveCurrentPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ReactiveCurrentPhB, {__call = ReactiveCurrentPhB.new_value})
