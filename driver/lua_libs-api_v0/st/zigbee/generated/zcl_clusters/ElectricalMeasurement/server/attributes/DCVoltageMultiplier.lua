...
--- @alias DCVoltageMultiplier
---
--- @field public ID number 0x0200 the ID of this attribute
--- @field public NAME string "DCVoltageMultiplier" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local DCVoltageMultiplier = {
  ID = 0x0200,
  NAME = "DCVoltageMultiplier",
  base_type = data_types.Uint16,
}

function DCVoltageMultiplier:augment_type(base_type_obj)
...
function DCVoltageMultiplier.pretty_print(value_obj)
  DCVoltageMultiplier.base_type.pretty_print(value_obj)
end

--- @function DCVoltageMultiplier:build_test_attr_report
---
...
DCVoltageMultiplier.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCVoltageMultiplier:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCVoltageMultiplier.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCVoltageMultiplier:new_value(...)
...
function DCVoltageMultiplier:read(device)
...
function DCVoltageMultiplier:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCVoltageMultiplier:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCVoltageMultiplier, {__call = DCVoltageMultiplier.new_value})
