...
--- @alias RMSExtremeUnderVoltagePeriodPhC
---
--- @field public ID number 0x0a15 the ID of this attribute
--- @field public NAME string "RMSExtremeUnderVoltagePeriodPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSExtremeUnderVoltagePeriodPhC = {
  ID = 0x0a15,
  NAME = "RMSExtremeUnderVoltagePeriodPhC",
  base_type = data_types.Uint16,
}

function RMSExtremeUnderVoltagePeriodPhC:augment_type(base_type_obj)
...
function RMSExtremeUnderVoltagePeriodPhC.pretty_print(value_obj)
  RMSExtremeUnderVoltagePeriodPhC.base_type.pretty_print(value_obj)
end

--- @function RMSExtremeUnderVoltagePeriodPhC:build_test_attr_report
---
...
RMSExtremeUnderVoltagePeriodPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSExtremeUnderVoltagePeriodPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSExtremeUnderVoltagePeriodPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSExtremeUnderVoltagePeriodPhC:new_value(...)
...
function RMSExtremeUnderVoltagePeriodPhC:read(device)
...
function RMSExtremeUnderVoltagePeriodPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSExtremeUnderVoltagePeriodPhC:write(device, value)
...
function RMSExtremeUnderVoltagePeriodPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSExtremeUnderVoltagePeriodPhC, {__call = RMSExtremeUnderVoltagePeriodPhC.new_value})
