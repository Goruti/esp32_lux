...
--- @alias AverageRMSUnderVoltage
---
--- @field public ID number 0x0806 the ID of this attribute
--- @field public NAME string "AverageRMSUnderVoltage" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local AverageRMSUnderVoltage = {
  ID = 0x0806,
  NAME = "AverageRMSUnderVoltage",
  base_type = data_types.Int16,
}

function AverageRMSUnderVoltage:augment_type(base_type_obj)
...
function AverageRMSUnderVoltage.pretty_print(value_obj)
  AverageRMSUnderVoltage.base_type.pretty_print(value_obj)
end

--- @function AverageRMSUnderVoltage:build_test_attr_report
---
...
AverageRMSUnderVoltage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AverageRMSUnderVoltage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AverageRMSUnderVoltage.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AverageRMSUnderVoltage:new_value(...)
...
function AverageRMSUnderVoltage:read(device)
...
function AverageRMSUnderVoltage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AverageRMSUnderVoltage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AverageRMSUnderVoltage, {__call = AverageRMSUnderVoltage.new_value})
