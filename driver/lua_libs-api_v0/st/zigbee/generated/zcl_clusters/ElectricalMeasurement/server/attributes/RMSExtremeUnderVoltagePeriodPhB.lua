...
--- @alias RMSExtremeUnderVoltagePeriodPhB
---
--- @field public ID number 0x0915 the ID of this attribute
--- @field public NAME string "RMSExtremeUnderVoltagePeriodPhB" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RMSExtremeUnderVoltagePeriodPhB = {
  ID = 0x0915,
  NAME = "RMSExtremeUnderVoltagePeriodPhB",
  base_type = data_types.Uint16,
}

function RMSExtremeUnderVoltagePeriodPhB:augment_type(base_type_obj)
...
function RMSExtremeUnderVoltagePeriodPhB.pretty_print(value_obj)
  RMSExtremeUnderVoltagePeriodPhB.base_type.pretty_print(value_obj)
end

--- @function RMSExtremeUnderVoltagePeriodPhB:build_test_attr_report
---
...
RMSExtremeUnderVoltagePeriodPhB.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RMSExtremeUnderVoltagePeriodPhB:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RMSExtremeUnderVoltagePeriodPhB.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RMSExtremeUnderVoltagePeriodPhB:new_value(...)
...
function RMSExtremeUnderVoltagePeriodPhB:read(device)
...
function RMSExtremeUnderVoltagePeriodPhB:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RMSExtremeUnderVoltagePeriodPhB:write(device, value)
...
function RMSExtremeUnderVoltagePeriodPhB:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RMSExtremeUnderVoltagePeriodPhB, {__call = RMSExtremeUnderVoltagePeriodPhB.new_value})
