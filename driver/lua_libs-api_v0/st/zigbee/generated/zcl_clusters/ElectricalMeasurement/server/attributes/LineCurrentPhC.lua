...
--- @alias LineCurrentPhC
---
--- @field public ID number 0x0a01 the ID of this attribute
--- @field public NAME string "LineCurrentPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local LineCurrentPhC = {
  ID = 0x0a01,
  NAME = "LineCurrentPhC",
  base_type = data_types.Uint16,
}

function LineCurrentPhC:augment_type(base_type_obj)
...
function LineCurrentPhC.pretty_print(value_obj)
  LineCurrentPhC.base_type.pretty_print(value_obj)
end

--- @function LineCurrentPhC:build_test_attr_report
---
...
LineCurrentPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LineCurrentPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LineCurrentPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LineCurrentPhC:new_value(...)
...
function LineCurrentPhC:read(device)
...
function LineCurrentPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LineCurrentPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LineCurrentPhC, {__call = LineCurrentPhC.new_value})
