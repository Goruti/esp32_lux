...
--- @alias ActiveCurrentPhC
---
--- @field public ID number 0x0a02 the ID of this attribute
--- @field public NAME string "ActiveCurrentPhC" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local ActiveCurrentPhC = {
  ID = 0x0a02,
  NAME = "ActiveCurrentPhC",
  base_type = data_types.Int16,
}

function ActiveCurrentPhC:augment_type(base_type_obj)
...
function ActiveCurrentPhC.pretty_print(value_obj)
  ActiveCurrentPhC.base_type.pretty_print(value_obj)
end

--- @function ActiveCurrentPhC:build_test_attr_report
---
...
ActiveCurrentPhC.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ActiveCurrentPhC:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ActiveCurrentPhC.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ActiveCurrentPhC:new_value(...)
...
function ActiveCurrentPhC:read(device)
...
function ActiveCurrentPhC:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ActiveCurrentPhC:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ActiveCurrentPhC, {__call = ActiveCurrentPhC.new_value})
