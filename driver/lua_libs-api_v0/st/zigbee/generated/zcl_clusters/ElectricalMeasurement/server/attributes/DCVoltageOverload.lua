...
--- @alias DCVoltageOverload
---
--- @field public ID number 0x0701 the ID of this attribute
--- @field public NAME string "DCVoltageOverload" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local DCVoltageOverload = {
  ID = 0x0701,
  NAME = "DCVoltageOverload",
  base_type = data_types.Int16,
}

function DCVoltageOverload:augment_type(base_type_obj)
...
function DCVoltageOverload.pretty_print(value_obj)
  DCVoltageOverload.base_type.pretty_print(value_obj)
end

--- @function DCVoltageOverload:build_test_attr_report
---
...
DCVoltageOverload.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DCVoltageOverload:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DCVoltageOverload.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DCVoltageOverload:new_value(...)
...
function DCVoltageOverload:read(device)
...
function DCVoltageOverload:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DCVoltageOverload:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DCVoltageOverload, {__call = DCVoltageOverload.new_value})
