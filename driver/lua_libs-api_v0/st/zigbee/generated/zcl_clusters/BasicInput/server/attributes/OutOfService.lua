...
--- @class st.zigbee.zcl.clusters.BasicInput.OutOfService
--- @alias OutOfService
---
--- @field public ID number 0x0051 the ID of this attribute
--- @field public NAME string "OutOfService" the name of this attribute
...
function OutOfService:augment_type(base_type_obj)
...
function OutOfService.pretty_print(value_obj)
  OutOfService.base_type.pretty_print(value_obj)
end

--- @function OutOfService:build_test_attr_report
---
...
OutOfService.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OutOfService:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OutOfService.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OutOfService:new_value(...)
...
function OutOfService:read(device)
...
function OutOfService:configure_reporting(device, min_rep_int, max_rep_int)
...
function OutOfService:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OutOfService, {__call = OutOfService.new_value})
return OutOfService
