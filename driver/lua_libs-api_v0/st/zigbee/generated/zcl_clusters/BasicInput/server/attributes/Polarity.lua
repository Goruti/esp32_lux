...
--- @class st.zigbee.zcl.clusters.BasicInput.Polarity
--- @alias Polarity
---
--- @field public ID number 0x0054 the ID of this attribute
--- @field public NAME string "Polarity" the name of this attribute
...
function Polarity:augment_type(base_type_obj)
...
function Polarity.pretty_print(value_obj)
  Polarity.base_type.pretty_print(value_obj)
end

--- @function Polarity:build_test_attr_report
---
...
function Polarity:configure_reporting(device, min_rep_int, max_rep_int)
...
function Polarity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Polarity, {__call = Polarity.new_value})
return Polarity
