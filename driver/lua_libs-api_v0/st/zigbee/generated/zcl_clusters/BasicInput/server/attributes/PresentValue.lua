...
--- @class st.zigbee.zcl.clusters.BasicInput.PresentValue
--- @alias PresentValue
---
--- @field public ID number 0x0055 the ID of this attribute
--- @field public NAME string "PresentValue" the name of this attribute
...
function PresentValue:augment_type(base_type_obj)
...
function PresentValue.pretty_print(value_obj)
  PresentValue.base_type.pretty_print(value_obj)
end

--- @function PresentValue:build_test_attr_report
---
...
PresentValue.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PresentValue:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PresentValue.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PresentValue:new_value(...)
...
function PresentValue:read(device)
...
function PresentValue:configure_reporting(device, min_rep_int, max_rep_int)
...
function PresentValue:write(device, value)
...
function PresentValue:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PresentValue, {__call = PresentValue.new_value})
return PresentValue
