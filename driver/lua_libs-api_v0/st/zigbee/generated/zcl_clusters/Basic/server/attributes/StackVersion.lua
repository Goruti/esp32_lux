...
--- @field public NAME string "StackVersion" the name of this attribute
...
function StackVersion:augment_type(base_type_obj)
...
function StackVersion.pretty_print(value_obj)
  StackVersion.base_type.pretty_print(value_obj)
end

--- @function StackVersion:build_test_attr_report
---
...
StackVersion.build_test_attr_report = cluster_base.build_test_attr_report

--- @function StackVersion:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
StackVersion.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function StackVersion:new_value(...)
...
function StackVersion:read(device)
...
function StackVersion:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function StackVersion:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(StackVersion, {__call = StackVersion.new_value})
return StackVersion
