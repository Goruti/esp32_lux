...
--- @field public NAME string "HWVersion" the name of this attribute
...
function HWVersion:augment_type(base_type_obj)
...
function HWVersion.pretty_print(value_obj)
  HWVersion.base_type.pretty_print(value_obj)
end

--- @function HWVersion:build_test_attr_report
---
...
HWVersion.build_test_attr_report = cluster_base.build_test_attr_report

--- @function HWVersion:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
HWVersion.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function HWVersion:read(device)
...
function HWVersion:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function HWVersion:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(HWVersion, {__call = HWVersion.new_value})
return HWVersion
