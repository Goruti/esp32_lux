...
--- @field public NAME string "ApplicationVersion" the name of this attribute
...
function ApplicationVersion:augment_type(base_type_obj)
...
function ApplicationVersion.pretty_print(value_obj)
  ApplicationVersion.base_type.pretty_print(value_obj)
end

--- @function ApplicationVersion:build_test_attr_report
---
...
ApplicationVersion.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ApplicationVersion:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ApplicationVersion.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ApplicationVersion:new_value(...)
...
function ApplicationVersion:read(device)
...
function ApplicationVersion:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ApplicationVersion:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ApplicationVersion, {__call = ApplicationVersion.new_value})
