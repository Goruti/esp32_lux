...
--- @field public NAME string "ManufacturerName" the name of this attribute
...
function ManufacturerName:augment_type(base_type_obj)
...
function ManufacturerName.pretty_print(value_obj)
  ManufacturerName.base_type.pretty_print(value_obj)
end

--- @function ManufacturerName:build_test_attr_report
---
...
ManufacturerName.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ManufacturerName:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.CharString the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ManufacturerName.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ManufacturerName:new_value(...)
...
function ManufacturerName:read(device)
...
function ManufacturerName:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ManufacturerName:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ManufacturerName, {__call = ManufacturerName.new_value})
