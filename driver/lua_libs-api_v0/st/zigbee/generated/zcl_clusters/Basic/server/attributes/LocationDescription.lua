...
--- @field public NAME string "LocationDescription" the name of this attribute
...
function LocationDescription:augment_type(base_type_obj)
...
function LocationDescription.pretty_print(value_obj)
  LocationDescription.base_type.pretty_print(value_obj)
end

--- @function LocationDescription:build_test_attr_report
---
...
LocationDescription.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LocationDescription:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.CharString the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LocationDescription.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LocationDescription:new_value(...)
...
function LocationDescription:read(device)
...
function LocationDescription:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LocationDescription:write(device, value)
...
function LocationDescription:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LocationDescription, {__call = LocationDescription.new_value})
