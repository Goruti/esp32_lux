...
--- @field public NAME string "DeviceEnabled" the name of this attribute
...
function DeviceEnabled:augment_type(base_type_obj)
...
function DeviceEnabled.pretty_print(value_obj)
  DeviceEnabled.base_type.pretty_print(value_obj)
end

--- @function DeviceEnabled:build_test_attr_report
---
...
DeviceEnabled.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DeviceEnabled:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DeviceEnabled.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DeviceEnabled:new_value(...)
...
function DeviceEnabled:read(device)
...
function DeviceEnabled:configure_reporting(device, min_rep_int, max_rep_int)
...
function DeviceEnabled:write(device, value)
...
function DeviceEnabled:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DeviceEnabled, {__call = DeviceEnabled.new_value})
