...
--- @field public NAME string "DateCode" the name of this attribute
...
function DateCode:augment_type(base_type_obj)
...
function DateCode.pretty_print(value_obj)
  DateCode.base_type.pretty_print(value_obj)
end

--- @function DateCode:build_test_attr_report
---
...
DateCode.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DateCode:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.CharString the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DateCode.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DateCode:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DateCode:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DateCode, {__call = DateCode.new_value})
return DateCode
