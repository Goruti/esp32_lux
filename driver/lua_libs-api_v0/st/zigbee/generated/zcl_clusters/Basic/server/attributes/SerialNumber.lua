...
--- @field public NAME string "SerialNumber" the name of this attribute
...
function SerialNumber:augment_type(base_type_obj)
...
function SerialNumber.pretty_print(value_obj)
  SerialNumber.base_type.pretty_print(value_obj)
end

--- @function SerialNumber:build_test_attr_report
---
...
SerialNumber.build_test_attr_report = cluster_base.build_test_attr_report

--- @function SerialNumber:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.CharString the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
SerialNumber.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function SerialNumber:new_value(...)
...
function SerialNumber:read(device)
...
function SerialNumber:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function SerialNumber:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(SerialNumber, {__call = SerialNumber.new_value})
return SerialNumber
