...
--- @field public NAME string "ZCLVersion" the name of this attribute
...
function ZCLVersion:augment_type(base_type_obj)
...
function ZCLVersion.pretty_print(value_obj)
  ZCLVersion.base_type.pretty_print(value_obj)
end

--- @function ZCLVersion:build_test_attr_report
---
...
ZCLVersion.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ZCLVersion:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ZCLVersion.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ZCLVersion:read(device)
...
function ZCLVersion:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ZCLVersion:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ZCLVersion, {__call = ZCLVersion.new_value})
return ZCLVersion
