...
--- @field public NAME string "ProductLabel" the name of this attribute
...
function ProductLabel:augment_type(base_type_obj)
...
function ProductLabel.pretty_print(value_obj)
  ProductLabel.base_type.pretty_print(value_obj)
end

--- @function ProductLabel:build_test_attr_report
---
...
ProductLabel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ProductLabel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.CharString the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ProductLabel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ProductLabel:new_value(...)
...
function ProductLabel:read(device)
...
function ProductLabel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ProductLabel:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ProductLabel, {__call = ProductLabel.new_value})
return ProductLabel
