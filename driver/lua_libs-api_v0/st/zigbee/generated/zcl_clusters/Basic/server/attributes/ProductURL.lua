...
--- @field public NAME string "ProductURL" the name of this attribute
...
function ProductURL:augment_type(base_type_obj)
...
function ProductURL.pretty_print(value_obj)
  ProductURL.base_type.pretty_print(value_obj)
end

--- @function ProductURL:build_test_attr_report
---
...
ProductURL.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ProductURL:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.CharString the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ProductURL.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ProductURL:read(device)
...
function ProductURL:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ProductURL:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ProductURL, {__call = ProductURL.new_value})
return ProductURL
