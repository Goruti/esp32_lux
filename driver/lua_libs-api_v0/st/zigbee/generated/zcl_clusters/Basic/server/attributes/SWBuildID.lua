...
--- @field public NAME string "SWBuildID" the name of this attribute
...
function SWBuildID:augment_type(base_type_obj)
...
function SWBuildID.pretty_print(value_obj)
  SWBuildID.base_type.pretty_print(value_obj)
end

--- @function SWBuildID:build_test_attr_report
---
...
SWBuildID.build_test_attr_report = cluster_base.build_test_attr_report

--- @function SWBuildID:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.CharString the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
SWBuildID.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function SWBuildID:read(device)
...
function SWBuildID:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function SWBuildID:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(SWBuildID, {__call = SWBuildID.new_value})
return SWBuildID
