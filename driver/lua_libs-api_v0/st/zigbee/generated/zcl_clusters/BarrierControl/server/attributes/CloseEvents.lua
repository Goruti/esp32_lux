...
--- @class st.zigbee.zcl.clusters.BarrierControl.CloseEvents
--- @alias CloseEvents
---
--- @field public ID number 0x0005 the ID of this attribute
--- @field public NAME string "CloseEvents" the name of this attribute
...
function CloseEvents:augment_type(base_type_obj)
...
function CloseEvents.pretty_print(value_obj)
  CloseEvents.base_type.pretty_print(value_obj)
end

--- @function CloseEvents:build_test_attr_report
---
...
CloseEvents.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CloseEvents:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CloseEvents.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the CloseEvents(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function CloseEvents:new_value(...)
...
function CloseEvents:read(device)
...
function CloseEvents:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CloseEvents:write(device, value)
...
function CloseEvents:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CloseEvents, {__call = CloseEvents.new_value})
return CloseEvents
