...
--- @class st.zigbee.zcl.clusters.BarrierControl.OpenEvents
--- @alias OpenEvents
---
--- @field public ID number 0x0004 the ID of this attribute
--- @field public NAME string "OpenEvents" the name of this attribute
...
function OpenEvents:augment_type(base_type_obj)
...
function OpenEvents.pretty_print(value_obj)
  OpenEvents.base_type.pretty_print(value_obj)
end

--- @function OpenEvents:build_test_attr_report
---
...
OpenEvents.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OpenEvents:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OpenEvents.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the OpenEvents(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function OpenEvents:new_value(...)
...
function OpenEvents:read(device)
...
function OpenEvents:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OpenEvents:write(device, value)
...
function OpenEvents:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OpenEvents, {__call = OpenEvents.new_value})
return OpenEvents
