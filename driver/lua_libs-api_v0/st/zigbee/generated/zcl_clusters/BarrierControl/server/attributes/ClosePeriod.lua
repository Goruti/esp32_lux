...
--- @class st.zigbee.zcl.clusters.BarrierControl.ClosePeriod
--- @alias ClosePeriod
---
--- @field public ID number 0x0009 the ID of this attribute
--- @field public NAME string "ClosePeriod" the name of this attribute
...
function ClosePeriod:augment_type(base_type_obj)
...
function ClosePeriod.pretty_print(value_obj)
  ClosePeriod.base_type.pretty_print(value_obj)
end

--- @function ClosePeriod:build_test_attr_report
---
...
ClosePeriod.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ClosePeriod:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ClosePeriod.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the ClosePeriod(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function ClosePeriod:new_value(...)
...
function ClosePeriod:read(device)
...
function ClosePeriod:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ClosePeriod:write(device, value)
...
function ClosePeriod:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ClosePeriod, {__call = ClosePeriod.new_value})
return ClosePeriod
