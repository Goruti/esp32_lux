...
--- @class st.zigbee.zcl.clusters.BarrierControl.BarrierPosition
--- @alias BarrierPosition
---
--- @field public ID number 0x000A the ID of this attribute
--- @field public NAME string "BarrierPosition" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local BarrierPosition = {
  ID = 0x000A,
  NAME = "BarrierPosition",
  base_type = data_types.Uint8,
}

function BarrierPosition:augment_type(base_type_obj)
...
function BarrierPosition.pretty_print(value_obj)
  BarrierPosition.base_type.pretty_print(value_obj)
end

--- @function BarrierPosition:build_test_attr_report
---
...
BarrierPosition.build_test_attr_report = cluster_base.build_test_attr_report

--- @function BarrierPosition:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
BarrierPosition.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the BarrierPosition(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function BarrierPosition:new_value(...)
...
function BarrierPosition:read(device)
...
function BarrierPosition:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function BarrierPosition:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(BarrierPosition, {__call = BarrierPosition.new_value})
