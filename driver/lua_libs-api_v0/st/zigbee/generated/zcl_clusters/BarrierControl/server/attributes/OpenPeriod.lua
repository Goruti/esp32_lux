...
--- @class st.zigbee.zcl.clusters.BarrierControl.OpenPeriod
--- @alias OpenPeriod
---
--- @field public ID number 0x0008 the ID of this attribute
--- @field public NAME string "OpenPeriod" the name of this attribute
...
function OpenPeriod:augment_type(base_type_obj)
...
function OpenPeriod.pretty_print(value_obj)
  OpenPeriod.base_type.pretty_print(value_obj)
end

--- @function OpenPeriod:build_test_attr_report
---
...
OpenPeriod.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OpenPeriod:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OpenPeriod.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OpenPeriod:read(device)
...
function OpenPeriod:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OpenPeriod:write(device, value)
...
function OpenPeriod:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OpenPeriod, {__call = OpenPeriod.new_value})
return OpenPeriod
