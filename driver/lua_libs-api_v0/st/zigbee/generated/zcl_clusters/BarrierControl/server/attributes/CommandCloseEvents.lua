...
--- @class st.zigbee.zcl.clusters.BarrierControl.CommandCloseEvents
--- @alias CommandCloseEvents
---
--- @field public ID number 0x0007 the ID of this attribute
--- @field public NAME string "CommandCloseEvents" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local CommandCloseEvents = {
  ID = 0x0007,
  NAME = "CommandCloseEvents",
  base_type = data_types.Uint16,
}

function CommandCloseEvents:augment_type(base_type_obj)
...
function CommandCloseEvents.pretty_print(value_obj)
  CommandCloseEvents.base_type.pretty_print(value_obj)
end

--- @function CommandCloseEvents:build_test_attr_report
---
...
CommandCloseEvents.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CommandCloseEvents:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CommandCloseEvents.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the CommandCloseEvents(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function CommandCloseEvents:new_value(...)
...
function CommandCloseEvents:read(device)
...
function CommandCloseEvents:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CommandCloseEvents:write(device, value)
...
function CommandCloseEvents:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CommandCloseEvents, {__call = CommandCloseEvents.new_value})
