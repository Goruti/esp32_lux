...
--- @alias PhysicalClosedLimit
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "PhysicalClosedLimit" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PhysicalClosedLimit = {
  ID = 0x0000,
  NAME = "PhysicalClosedLimit",
  base_type = data_types.Uint16,
}

function PhysicalClosedLimit:augment_type(base_type_obj)
...
function PhysicalClosedLimit.pretty_print(value_obj)
  PhysicalClosedLimit.base_type.pretty_print(value_obj)
end

--- @function PhysicalClosedLimit:build_test_attr_report
---
...
PhysicalClosedLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PhysicalClosedLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PhysicalClosedLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PhysicalClosedLimit:new_value(...)
...
function PhysicalClosedLimit:read(device)
...
function PhysicalClosedLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PhysicalClosedLimit:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PhysicalClosedLimit, {__call = PhysicalClosedLimit.new_value})
