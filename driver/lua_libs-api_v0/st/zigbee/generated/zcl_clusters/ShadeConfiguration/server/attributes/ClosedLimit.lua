...
--- @field public NAME string "ClosedLimit" the name of this attribute
...
function ClosedLimit:augment_type(base_type_obj)
...
function ClosedLimit.pretty_print(value_obj)
  ClosedLimit.base_type.pretty_print(value_obj)
end

--- @function ClosedLimit:build_test_attr_report
---
...
ClosedLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ClosedLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ClosedLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ClosedLimit:new_value(...)
...
function ClosedLimit:read(device)
...
function ClosedLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ClosedLimit:write(device, value)
...
function ClosedLimit:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ClosedLimit, {__call = ClosedLimit.new_value})
return ClosedLimit
