...
--- @field public CONFIGURE number 1
local Mode = {
  ID = 0x0011,
  NAME = "Mode",
...
function Mode.pretty_print(value_obj)
  return string.format("%s: %s[%s]", value_obj.field_name or value_obj.NAME, Mode.NAME, Mode.enum_fields[value_obj.value])
end
...
function Mode:write(device, value)
