...
--- @field public NAME string "MotorStepSize" the name of this attribute
...
function MotorStepSize:augment_type(base_type_obj)
...
function MotorStepSize.pretty_print(value_obj)
  MotorStepSize.base_type.pretty_print(value_obj)
end

--- @function MotorStepSize:build_test_attr_report
---
...
MotorStepSize.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MotorStepSize:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MotorStepSize.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MotorStepSize:new_value(...)
...
function MotorStepSize:read(device)
...
function MotorStepSize:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MotorStepSize:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MotorStepSize, {__call = MotorStepSize.new_value})
