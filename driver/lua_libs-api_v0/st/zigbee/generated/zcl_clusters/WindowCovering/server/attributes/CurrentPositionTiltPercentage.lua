...
--- @alias CurrentPositionTiltPercentage
---
--- @field public ID number 0x0009 the ID of this attribute
--- @field public NAME string "CurrentPositionTiltPercentage" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local CurrentPositionTiltPercentage = {
  ID = 0x0009,
  NAME = "CurrentPositionTiltPercentage",
  base_type = data_types.Uint8,
}

function CurrentPositionTiltPercentage:augment_type(base_type_obj)
...
function CurrentPositionTiltPercentage.pretty_print(value_obj)
  CurrentPositionTiltPercentage.base_type.pretty_print(value_obj)
end

--- @function CurrentPositionTiltPercentage:build_test_attr_report
---
...
CurrentPositionTiltPercentage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentPositionTiltPercentage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentPositionTiltPercentage.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentPositionTiltPercentage:new_value(...)
...
function CurrentPositionTiltPercentage:read(device)
...
function CurrentPositionTiltPercentage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentPositionTiltPercentage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentPositionTiltPercentage, {__call = CurrentPositionTiltPercentage.new_value})
