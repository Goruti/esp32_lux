...
function NumberOfActuationsLift.pretty_print(value_obj)
  NumberOfActuationsLift.base_type.pretty_print(value_obj)
end

--- @function NumberOfActuationsLift:build_test_attr_report
---
...
NumberOfActuationsLift.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfActuationsLift:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfActuationsLift.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfActuationsLift:new_value(...)
...
function NumberOfActuationsLift:read(device)
...
function NumberOfActuationsLift:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NumberOfActuationsLift:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NumberOfActuationsLift, {__call = NumberOfActuationsLift.new_value})
