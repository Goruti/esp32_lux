...
function InstalledOpenLimitLift.pretty_print(value_obj)
  InstalledOpenLimitLift.base_type.pretty_print(value_obj)
end

--- @function InstalledOpenLimitLift:build_test_attr_report
---
...
InstalledOpenLimitLift.build_test_attr_report = cluster_base.build_test_attr_report

--- @function InstalledOpenLimitLift:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
InstalledOpenLimitLift.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function InstalledOpenLimitLift:new_value(...)
...
function InstalledOpenLimitLift:read(device)
...
function InstalledOpenLimitLift:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function InstalledOpenLimitLift:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(InstalledOpenLimitLift, {__call = InstalledOpenLimitLift.new_value})
