...
--- @alias CurrentPositionLiftPercentage
---
--- @field public ID number 0x0008 the ID of this attribute
--- @field public NAME string "CurrentPositionLiftPercentage" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local CurrentPositionLiftPercentage = {
  ID = 0x0008,
  NAME = "CurrentPositionLiftPercentage",
  base_type = data_types.Uint8,
}

function CurrentPositionLiftPercentage:augment_type(base_type_obj)
...
function CurrentPositionLiftPercentage.pretty_print(value_obj)
  CurrentPositionLiftPercentage.base_type.pretty_print(value_obj)
end

--- @function CurrentPositionLiftPercentage:build_test_attr_report
---
...
CurrentPositionLiftPercentage.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentPositionLiftPercentage:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentPositionLiftPercentage.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentPositionLiftPercentage:new_value(...)
...
function CurrentPositionLiftPercentage:read(device)
...
function CurrentPositionLiftPercentage:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentPositionLiftPercentage:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentPositionLiftPercentage, {__call = CurrentPositionLiftPercentage.new_value})
