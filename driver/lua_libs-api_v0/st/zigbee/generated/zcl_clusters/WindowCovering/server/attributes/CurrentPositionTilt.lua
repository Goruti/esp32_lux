...
function CurrentPositionTilt.pretty_print(value_obj)
  CurrentPositionTilt.base_type.pretty_print(value_obj)
end

--- @function CurrentPositionTilt:build_test_attr_report
---
...
CurrentPositionTilt.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentPositionTilt:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentPositionTilt.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentPositionTilt:new_value(...)
...
function CurrentPositionTilt:read(device)
...
function CurrentPositionTilt:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentPositionTilt:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentPositionTilt, {__call = CurrentPositionTilt.new_value})
