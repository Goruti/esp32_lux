...
--- @field public NAME string "VelocityLift" the name of this attribute
...
function VelocityLift:augment_type(base_type_obj)
...
function VelocityLift.pretty_print(value_obj)
  VelocityLift.base_type.pretty_print(value_obj)
end

--- @function VelocityLift:build_test_attr_report
---
...
VelocityLift.build_test_attr_report = cluster_base.build_test_attr_report

--- @function VelocityLift:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
VelocityLift.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function VelocityLift:new_value(...)
...
function VelocityLift:read(device)
...
function VelocityLift:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function VelocityLift:write(device, value)
...
function VelocityLift:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(VelocityLift, {__call = VelocityLift.new_value})
return VelocityLift
