...
function CurrentPositionLift.pretty_print(value_obj)
  CurrentPositionLift.base_type.pretty_print(value_obj)
end

--- @function CurrentPositionLift:build_test_attr_report
---
...
CurrentPositionLift.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentPositionLift:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentPositionLift.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentPositionLift:new_value(...)
...
function CurrentPositionLift:read(device)
...
function CurrentPositionLift:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentPositionLift:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentPositionLift, {__call = CurrentPositionLift.new_value})
