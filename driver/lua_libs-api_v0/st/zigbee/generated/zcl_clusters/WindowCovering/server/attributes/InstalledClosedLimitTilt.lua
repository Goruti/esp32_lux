...
--- @alias InstalledClosedLimitTilt
---
--- @field public ID number 0x0013 the ID of this attribute
--- @field public NAME string "InstalledClosedLimitTilt" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local InstalledClosedLimitTilt = {
  ID = 0x0013,
  NAME = "InstalledClosedLimitTilt",
  base_type = data_types.Uint16,
}

function InstalledClosedLimitTilt:augment_type(base_type_obj)
...
function InstalledClosedLimitTilt.pretty_print(value_obj)
  InstalledClosedLimitTilt.base_type.pretty_print(value_obj)
end

--- @function InstalledClosedLimitTilt:build_test_attr_report
---
...
InstalledClosedLimitTilt.build_test_attr_report = cluster_base.build_test_attr_report

--- @function InstalledClosedLimitTilt:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
InstalledClosedLimitTilt.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function InstalledClosedLimitTilt:new_value(...)
...
function InstalledClosedLimitTilt:read(device)
...
function InstalledClosedLimitTilt:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function InstalledClosedLimitTilt:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(InstalledClosedLimitTilt, {__call = InstalledClosedLimitTilt.new_value})
