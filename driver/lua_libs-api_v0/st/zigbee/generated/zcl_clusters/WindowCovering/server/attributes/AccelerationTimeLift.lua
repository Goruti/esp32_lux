...
function AccelerationTimeLift.pretty_print(value_obj)
  AccelerationTimeLift.base_type.pretty_print(value_obj)
end

--- @function AccelerationTimeLift:build_test_attr_report
---
...
AccelerationTimeLift.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AccelerationTimeLift:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AccelerationTimeLift.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AccelerationTimeLift:new_value(...)
...
function AccelerationTimeLift:read(device)
...
function AccelerationTimeLift:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AccelerationTimeLift:write(device, value)
...
function AccelerationTimeLift:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AccelerationTimeLift, {__call = AccelerationTimeLift.new_value})
