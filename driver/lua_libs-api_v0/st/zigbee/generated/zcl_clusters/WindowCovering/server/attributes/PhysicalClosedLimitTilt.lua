...
--- @alias PhysicalClosedLimitTilt
---
--- @field public ID number 0x0002 the ID of this attribute
--- @field public NAME string "PhysicalClosedLimitTilt" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PhysicalClosedLimitTilt = {
  ID = 0x0002,
  NAME = "PhysicalClosedLimitTilt",
  base_type = data_types.Uint16,
}

function PhysicalClosedLimitTilt:augment_type(base_type_obj)
...
function PhysicalClosedLimitTilt.pretty_print(value_obj)
  PhysicalClosedLimitTilt.base_type.pretty_print(value_obj)
end

--- @function PhysicalClosedLimitTilt:build_test_attr_report
---
...
PhysicalClosedLimitTilt.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PhysicalClosedLimitTilt:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PhysicalClosedLimitTilt.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PhysicalClosedLimitTilt:new_value(...)
...
function PhysicalClosedLimitTilt:read(device)
...
function PhysicalClosedLimitTilt:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PhysicalClosedLimitTilt:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PhysicalClosedLimitTilt, {__call = PhysicalClosedLimitTilt.new_value})
