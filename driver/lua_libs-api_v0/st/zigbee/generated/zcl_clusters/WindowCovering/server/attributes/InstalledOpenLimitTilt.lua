...
function InstalledOpenLimitTilt.pretty_print(value_obj)
  InstalledOpenLimitTilt.base_type.pretty_print(value_obj)
end

--- @function InstalledOpenLimitTilt:build_test_attr_report
---
...
InstalledOpenLimitTilt.build_test_attr_report = cluster_base.build_test_attr_report

--- @function InstalledOpenLimitTilt:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
InstalledOpenLimitTilt.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function InstalledOpenLimitTilt:new_value(...)
...
function InstalledOpenLimitTilt:read(device)
...
function InstalledOpenLimitTilt:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function InstalledOpenLimitTilt:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(InstalledOpenLimitTilt, {__call = InstalledOpenLimitTilt.new_value})
