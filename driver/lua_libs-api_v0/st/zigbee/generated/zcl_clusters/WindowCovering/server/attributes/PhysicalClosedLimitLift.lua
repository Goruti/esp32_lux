...
--- @alias PhysicalClosedLimitLift
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "PhysicalClosedLimitLift" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PhysicalClosedLimitLift = {
  ID = 0x0001,
  NAME = "PhysicalClosedLimitLift",
  base_type = data_types.Uint16,
}

function PhysicalClosedLimitLift:augment_type(base_type_obj)
...
function PhysicalClosedLimitLift.pretty_print(value_obj)
  PhysicalClosedLimitLift.base_type.pretty_print(value_obj)
end

--- @function PhysicalClosedLimitLift:build_test_attr_report
---
...
PhysicalClosedLimitLift.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PhysicalClosedLimitLift:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PhysicalClosedLimitLift.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PhysicalClosedLimitLift:new_value(...)
...
function PhysicalClosedLimitLift:read(device)
...
function PhysicalClosedLimitLift:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PhysicalClosedLimitLift:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PhysicalClosedLimitLift, {__call = PhysicalClosedLimitLift.new_value})
