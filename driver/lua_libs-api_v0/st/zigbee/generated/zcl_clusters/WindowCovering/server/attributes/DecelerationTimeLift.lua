...
function DecelerationTimeLift.pretty_print(value_obj)
  DecelerationTimeLift.base_type.pretty_print(value_obj)
end

--- @function DecelerationTimeLift:build_test_attr_report
---
...
DecelerationTimeLift.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DecelerationTimeLift:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DecelerationTimeLift.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DecelerationTimeLift:new_value(...)
...
function DecelerationTimeLift:read(device)
...
function DecelerationTimeLift:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DecelerationTimeLift:write(device, value)
...
function DecelerationTimeLift:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DecelerationTimeLift, {__call = DecelerationTimeLift.new_value})
