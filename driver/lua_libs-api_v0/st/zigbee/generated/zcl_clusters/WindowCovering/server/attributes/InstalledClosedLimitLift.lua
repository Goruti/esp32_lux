...
--- @alias InstalledClosedLimitLift
---
--- @field public ID number 0x0011 the ID of this attribute
--- @field public NAME string "InstalledClosedLimitLift" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local InstalledClosedLimitLift = {
  ID = 0x0011,
  NAME = "InstalledClosedLimitLift",
  base_type = data_types.Uint16,
}

function InstalledClosedLimitLift:augment_type(base_type_obj)
...
function InstalledClosedLimitLift.pretty_print(value_obj)
  InstalledClosedLimitLift.base_type.pretty_print(value_obj)
end

--- @function InstalledClosedLimitLift:build_test_attr_report
---
...
InstalledClosedLimitLift.build_test_attr_report = cluster_base.build_test_attr_report

--- @function InstalledClosedLimitLift:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
InstalledClosedLimitLift.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function InstalledClosedLimitLift:new_value(...)
...
function InstalledClosedLimitLift:read(device)
...
function InstalledClosedLimitLift:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function InstalledClosedLimitLift:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(InstalledClosedLimitLift, {__call = InstalledClosedLimitLift.new_value})
