...
--- @field public UP number 0
--- @field public DOWN number 1
local MoveStepMode = {}
local new_mt = EnumABC.new_mt({NAME = "MoveStepMode", ID = data_types.name_to_id_map["Enum8"]}, 1)
...
new_mt.__index.UP   = 0x00
new_mt.__index.DOWN = 0x01

setmetatable(MoveStepMode, new_mt)
