...
--- @field public NAME string "MaxFrequency" the name of this attribute
...
function MaxFrequency:augment_type(base_type_obj)
...
function MaxFrequency.pretty_print(value_obj)
  MaxFrequency.base_type.pretty_print(value_obj)
end

--- @function MaxFrequency:build_test_attr_report
---
...
MaxFrequency.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxFrequency:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxFrequency.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxFrequency:new_value(...)
...
function MaxFrequency:read(device)
...
function MaxFrequency:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxFrequency:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxFrequency, {__call = MaxFrequency.new_value})
return MaxFrequency
