...
function OnTransitionTime.pretty_print(value_obj)
  OnTransitionTime.base_type.pretty_print(value_obj)
end

--- @function OnTransitionTime:build_test_attr_report
---
...
OnTransitionTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OnTransitionTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OnTransitionTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OnTransitionTime:new_value(...)
...
function OnTransitionTime:read(device)
...
function OnTransitionTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OnTransitionTime:write(device, value)
...
function OnTransitionTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OnTransitionTime, {__call = OnTransitionTime.new_value})
