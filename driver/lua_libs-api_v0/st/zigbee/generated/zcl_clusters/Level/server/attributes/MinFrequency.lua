...
--- @field public NAME string "MinFrequency" the name of this attribute
...
function MinFrequency:augment_type(base_type_obj)
...
function MinFrequency.pretty_print(value_obj)
  MinFrequency.base_type.pretty_print(value_obj)
end

--- @function MinFrequency:build_test_attr_report
---
...
MinFrequency.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinFrequency:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinFrequency.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinFrequency:new_value(...)
...
function MinFrequency:read(device)
...
function MinFrequency:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinFrequency:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinFrequency, {__call = MinFrequency.new_value})
return MinFrequency
