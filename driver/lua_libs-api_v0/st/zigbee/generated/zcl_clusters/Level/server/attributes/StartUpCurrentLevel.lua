...
function StartUpCurrentLevel.pretty_print(value_obj)
  StartUpCurrentLevel.base_type.pretty_print(value_obj)
end

--- @function StartUpCurrentLevel:build_test_attr_report
---
...
StartUpCurrentLevel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function StartUpCurrentLevel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
StartUpCurrentLevel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function StartUpCurrentLevel:new_value(...)
...
function StartUpCurrentLevel:read(device)
...
function StartUpCurrentLevel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function StartUpCurrentLevel:write(device, value)
...
function StartUpCurrentLevel:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(StartUpCurrentLevel, {__call = StartUpCurrentLevel.new_value})
