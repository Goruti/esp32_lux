...
--- @field public NAME string "OnLevel" the name of this attribute
...
function OnLevel:augment_type(base_type_obj)
...
function OnLevel.pretty_print(value_obj)
  OnLevel.base_type.pretty_print(value_obj)
end

--- @function OnLevel:build_test_attr_report
---
...
OnLevel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OnLevel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OnLevel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OnLevel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OnLevel:write(device, value)
...
function OnLevel:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OnLevel, {__call = OnLevel.new_value})
return OnLevel
