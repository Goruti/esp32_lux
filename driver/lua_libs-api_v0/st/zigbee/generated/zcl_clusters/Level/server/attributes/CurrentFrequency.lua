...
--- @field public NAME string "CurrentFrequency" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local CurrentFrequency = {
  ID = 0x0004,
  NAME = "CurrentFrequency",
  base_type = data_types.Uint16,
}

function CurrentFrequency:augment_type(base_type_obj)
...
function CurrentFrequency.pretty_print(value_obj)
  CurrentFrequency.base_type.pretty_print(value_obj)
end

--- @function CurrentFrequency:build_test_attr_report
---
...
CurrentFrequency.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentFrequency:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentFrequency.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentFrequency:new_value(...)
...
function CurrentFrequency:read(device)
...
function CurrentFrequency:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentFrequency:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentFrequency, {__call = CurrentFrequency.new_value})
