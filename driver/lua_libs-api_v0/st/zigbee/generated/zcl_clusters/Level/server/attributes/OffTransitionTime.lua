...
function OffTransitionTime.pretty_print(value_obj)
  OffTransitionTime.base_type.pretty_print(value_obj)
end

--- @function OffTransitionTime:build_test_attr_report
---
...
OffTransitionTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OffTransitionTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OffTransitionTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OffTransitionTime:new_value(...)
...
function OffTransitionTime:read(device)
...
function OffTransitionTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OffTransitionTime:write(device, value)
...
function OffTransitionTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OffTransitionTime, {__call = OffTransitionTime.new_value})
