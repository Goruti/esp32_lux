...
function OnOffTransitionTime.pretty_print(value_obj)
  OnOffTransitionTime.base_type.pretty_print(value_obj)
end

--- @function OnOffTransitionTime:build_test_attr_report
---
...
OnOffTransitionTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OnOffTransitionTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OnOffTransitionTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OnOffTransitionTime:new_value(...)
...
function OnOffTransitionTime:read(device)
...
function OnOffTransitionTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OnOffTransitionTime:write(device, value)
...
function OnOffTransitionTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OnOffTransitionTime, {__call = OnOffTransitionTime.new_value})
