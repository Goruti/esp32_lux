...
--- @field public NAME string "CurrentLevel" the name of this attribute
...
function CurrentLevel:augment_type(base_type_obj)
...
function CurrentLevel.pretty_print(value_obj)
  CurrentLevel.base_type.pretty_print(value_obj)
end

--- @function CurrentLevel:build_test_attr_report
---
...
CurrentLevel.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentLevel:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentLevel.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentLevel:read(device)
...
function CurrentLevel:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
setmetatable(CurrentLevel, {__call = CurrentLevel.new_value})
return CurrentLevel
