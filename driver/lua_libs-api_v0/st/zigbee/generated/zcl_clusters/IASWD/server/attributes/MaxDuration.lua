...
--- @field public NAME string "MaxDuration" the name of this attribute
...
function MaxDuration:augment_type(base_type_obj)
...
function MaxDuration.pretty_print(value_obj)
  MaxDuration.base_type.pretty_print(value_obj)
end

--- @function MaxDuration:build_test_attr_report
---
...
MaxDuration.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxDuration:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxDuration.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxDuration:new_value(...)
...
function MaxDuration:read(device)
...
function MaxDuration:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxDuration:write(device, value)
...
function MaxDuration:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxDuration, {__call = MaxDuration.new_value})
return MaxDuration
