...
local WarningMode = {}
local new_mt = EnumABC.new_mt({NAME = "WarningMode", ID = data_types.name_to_id_map["Enum8"]}, 1)
...
setmetatable(WarningMode, new_mt)
