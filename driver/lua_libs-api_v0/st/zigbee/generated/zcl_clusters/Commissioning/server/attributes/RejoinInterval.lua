...
function RejoinInterval.pretty_print(value_obj)
  RejoinInterval.base_type.pretty_print(value_obj)
end

--- @function RejoinInterval:build_test_attr_report
---
...
RejoinInterval.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RejoinInterval:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RejoinInterval.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RejoinInterval:new_value(...)
...
function RejoinInterval:read(device)
...
function RejoinInterval:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RejoinInterval:write(device, value)
...
function RejoinInterval:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RejoinInterval, {__call = RejoinInterval.new_value})
