...
--- @field public NAME string "ExtendedPANId" the name of this attribute
...
function ExtendedPANId:augment_type(base_type_obj)
...
function ExtendedPANId.pretty_print(value_obj)
  ExtendedPANId.base_type.pretty_print(value_obj)
end

--- @function ExtendedPANId:build_test_attr_report
---
...
ExtendedPANId.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ExtendedPANId:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.IeeeAddress the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ExtendedPANId.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ExtendedPANId:new_value(...)
...
function ExtendedPANId:read(device)
...
function ExtendedPANId:configure_reporting(device, min_rep_int, max_rep_int)
...
function ExtendedPANId:write(device, value)
...
function ExtendedPANId:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ExtendedPANId, {__call = ExtendedPANId.new_value})
