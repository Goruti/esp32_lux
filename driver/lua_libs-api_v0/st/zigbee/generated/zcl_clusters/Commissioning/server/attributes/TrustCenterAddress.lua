...
--- @alias TrustCenterAddress
---
--- @field public ID number 0x0010 the ID of this attribute
--- @field public NAME string "TrustCenterAddress" the name of this attribute
--- @field public data_type st.zigbee.data_types.IeeeAddress the data type of this attribute
local TrustCenterAddress = {
  ID = 0x0010,
  NAME = "TrustCenterAddress",
  base_type = data_types.IeeeAddress,
}

function TrustCenterAddress:augment_type(base_type_obj)
...
function TrustCenterAddress.pretty_print(value_obj)
  TrustCenterAddress.base_type.pretty_print(value_obj)
end

--- @function TrustCenterAddress:build_test_attr_report
---
--- Build a Rx Zigbee message as if a device reported this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.IeeeAddress the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an AttributeReport body
TrustCenterAddress.build_test_attr_report = cluster_base.build_test_attr_report

--- @function TrustCenterAddress:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.IeeeAddress the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
TrustCenterAddress.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
--- @return st.zigbee.data_types.IeeeAddress
function TrustCenterAddress:new_value(...)
...
function TrustCenterAddress:read(device)
...
function TrustCenterAddress:configure_reporting(device, min_rep_int, max_rep_int)
...
---
--- @param device st.zigbee.Device
--- @param value st.zigbee.data_types.IeeeAddress the value to write
function TrustCenterAddress:write(device, value)
...
function TrustCenterAddress:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(TrustCenterAddress, {__call = TrustCenterAddress.new_value})
