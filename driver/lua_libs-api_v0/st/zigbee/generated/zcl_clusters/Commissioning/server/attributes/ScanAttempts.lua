...
--- @field public NAME string "ScanAttempts" the name of this attribute
...
function ScanAttempts:augment_type(base_type_obj)
...
function ScanAttempts.pretty_print(value_obj)
  ScanAttempts.base_type.pretty_print(value_obj)
end

--- @function ScanAttempts:build_test_attr_report
---
...
ScanAttempts.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ScanAttempts:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ScanAttempts.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ScanAttempts:new_value(...)
...
function ScanAttempts:read(device)
...
function ScanAttempts:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ScanAttempts:write(device, value)
...
function ScanAttempts:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ScanAttempts, {__call = ScanAttempts.new_value})
return ScanAttempts
