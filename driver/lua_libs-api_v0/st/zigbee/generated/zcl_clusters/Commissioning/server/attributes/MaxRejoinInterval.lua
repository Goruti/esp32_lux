...
--- @alias MaxRejoinInterval
---
--- @field public ID number 0x0023 the ID of this attribute
--- @field public NAME string "MaxRejoinInterval" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local MaxRejoinInterval = {
  ID = 0x0023,
  NAME = "MaxRejoinInterval",
  base_type = data_types.Uint16,
}

function MaxRejoinInterval:augment_type(base_type_obj)
...
function MaxRejoinInterval.pretty_print(value_obj)
  MaxRejoinInterval.base_type.pretty_print(value_obj)
end

--- @function MaxRejoinInterval:build_test_attr_report
---
...
MaxRejoinInterval.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxRejoinInterval:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxRejoinInterval.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxRejoinInterval:new_value(...)
...
function MaxRejoinInterval:read(device)
...
function MaxRejoinInterval:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxRejoinInterval:write(device, value)
...
function MaxRejoinInterval:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxRejoinInterval, {__call = MaxRejoinInterval.new_value})
