...
--- @alias ConcentratorRadius
---
--- @field public ID number 0x0041 the ID of this attribute
--- @field public NAME string "ConcentratorRadius" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local ConcentratorRadius = {
  ID = 0x0041,
  NAME = "ConcentratorRadius",
  base_type = data_types.Uint8,
}

function ConcentratorRadius:augment_type(base_type_obj)
...
function ConcentratorRadius.pretty_print(value_obj)
  ConcentratorRadius.base_type.pretty_print(value_obj)
end

--- @function ConcentratorRadius:build_test_attr_report
---
...
ConcentratorRadius.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ConcentratorRadius:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ConcentratorRadius.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ConcentratorRadius:new_value(...)
...
function ConcentratorRadius:read(device)
...
function ConcentratorRadius:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ConcentratorRadius:write(device, value)
...
function ConcentratorRadius:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ConcentratorRadius, {__call = ConcentratorRadius.new_value})
