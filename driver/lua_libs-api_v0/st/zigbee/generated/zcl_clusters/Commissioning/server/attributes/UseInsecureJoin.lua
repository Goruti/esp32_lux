...
--- @alias UseInsecureJoin
---
--- @field public ID number 0x0013 the ID of this attribute
--- @field public NAME string "UseInsecureJoin" the name of this attribute
--- @field public data_type st.zigbee.data_types.Boolean the data type of this attribute
local UseInsecureJoin = {
  ID = 0x0013,
  NAME = "UseInsecureJoin",
  base_type = data_types.Boolean,
}

function UseInsecureJoin:augment_type(base_type_obj)
...
function UseInsecureJoin.pretty_print(value_obj)
  UseInsecureJoin.base_type.pretty_print(value_obj)
end

--- @function UseInsecureJoin:build_test_attr_report
---
...
UseInsecureJoin.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UseInsecureJoin:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UseInsecureJoin.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UseInsecureJoin:new_value(...)
...
function UseInsecureJoin:read(device)
...
function UseInsecureJoin:configure_reporting(device, min_rep_int, max_rep_int)
...
function UseInsecureJoin:write(device, value)
...
function UseInsecureJoin:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(UseInsecureJoin, {__call = UseInsecureJoin.new_value})
