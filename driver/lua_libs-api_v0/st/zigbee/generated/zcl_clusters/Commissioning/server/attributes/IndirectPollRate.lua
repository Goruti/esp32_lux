...
--- @alias IndirectPollRate
---
--- @field public ID number 0x0030 the ID of this attribute
--- @field public NAME string "IndirectPollRate" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local IndirectPollRate = {
  ID = 0x0030,
  NAME = "IndirectPollRate",
  base_type = data_types.Uint16,
}

function IndirectPollRate:augment_type(base_type_obj)
...
function IndirectPollRate.pretty_print(value_obj)
  IndirectPollRate.base_type.pretty_print(value_obj)
end

--- @function IndirectPollRate:build_test_attr_report
---
...
IndirectPollRate.build_test_attr_report = cluster_base.build_test_attr_report

--- @function IndirectPollRate:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
IndirectPollRate.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function IndirectPollRate:new_value(...)
...
function IndirectPollRate:read(device)
...
function IndirectPollRate:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function IndirectPollRate:write(device, value)
...
function IndirectPollRate:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(IndirectPollRate, {__call = IndirectPollRate.new_value})
