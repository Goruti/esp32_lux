...
--- @alias ParentRetryThreshold
---
--- @field public ID number 0x0031 the ID of this attribute
--- @field public NAME string "ParentRetryThreshold" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local ParentRetryThreshold = {
  ID = 0x0031,
  NAME = "ParentRetryThreshold",
  base_type = data_types.Uint8,
}

function ParentRetryThreshold:augment_type(base_type_obj)
...
function ParentRetryThreshold.pretty_print(value_obj)
  ParentRetryThreshold.base_type.pretty_print(value_obj)
end

--- @function ParentRetryThreshold:build_test_attr_report
---
...
ParentRetryThreshold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ParentRetryThreshold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ParentRetryThreshold.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ParentRetryThreshold:new_value(...)
...
function ParentRetryThreshold:read(device)
...
function ParentRetryThreshold:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ParentRetryThreshold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ParentRetryThreshold, {__call = ParentRetryThreshold.new_value})
