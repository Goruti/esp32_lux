...
--- @alias ConcentratorDiscoveryTime
---
--- @field public ID number 0x0042 the ID of this attribute
--- @field public NAME string "ConcentratorDiscoveryTime" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local ConcentratorDiscoveryTime = {
  ID = 0x0042,
  NAME = "ConcentratorDiscoveryTime",
  base_type = data_types.Uint8,
}

function ConcentratorDiscoveryTime:augment_type(base_type_obj)
...
function ConcentratorDiscoveryTime.pretty_print(value_obj)
  ConcentratorDiscoveryTime.base_type.pretty_print(value_obj)
end

--- @function ConcentratorDiscoveryTime:build_test_attr_report
---
...
ConcentratorDiscoveryTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ConcentratorDiscoveryTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ConcentratorDiscoveryTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ConcentratorDiscoveryTime:new_value(...)
...
function ConcentratorDiscoveryTime:read(device)
...
function ConcentratorDiscoveryTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ConcentratorDiscoveryTime:write(device, value)
...
function ConcentratorDiscoveryTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ConcentratorDiscoveryTime, {__call = ConcentratorDiscoveryTime.new_value})
