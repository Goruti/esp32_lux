...
--- @alias TimeBetweenScans
---
--- @field public ID number 0x0021 the ID of this attribute
--- @field public NAME string "TimeBetweenScans" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local TimeBetweenScans = {
  ID = 0x0021,
  NAME = "TimeBetweenScans",
  base_type = data_types.Uint16,
}

function TimeBetweenScans:augment_type(base_type_obj)
...
function TimeBetweenScans.pretty_print(value_obj)
  TimeBetweenScans.base_type.pretty_print(value_obj)
end

--- @function TimeBetweenScans:build_test_attr_report
---
...
TimeBetweenScans.build_test_attr_report = cluster_base.build_test_attr_report

--- @function TimeBetweenScans:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
TimeBetweenScans.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function TimeBetweenScans:new_value(...)
...
function TimeBetweenScans:read(device)
...
function TimeBetweenScans:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function TimeBetweenScans:write(device, value)
...
function TimeBetweenScans:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(TimeBetweenScans, {__call = TimeBetweenScans.new_value})
