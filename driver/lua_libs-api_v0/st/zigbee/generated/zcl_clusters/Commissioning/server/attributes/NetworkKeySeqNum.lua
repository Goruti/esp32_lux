...
--- @alias NetworkKeySeqNum
---
--- @field public ID number 0x0015 the ID of this attribute
--- @field public NAME string "NetworkKeySeqNum" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local NetworkKeySeqNum = {
  ID = 0x0015,
  NAME = "NetworkKeySeqNum",
  base_type = data_types.Uint8,
}

function NetworkKeySeqNum:augment_type(base_type_obj)
...
function NetworkKeySeqNum.pretty_print(value_obj)
  NetworkKeySeqNum.base_type.pretty_print(value_obj)
end

--- @function NetworkKeySeqNum:build_test_attr_report
---
...
NetworkKeySeqNum.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NetworkKeySeqNum:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NetworkKeySeqNum.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NetworkKeySeqNum:new_value(...)
...
function NetworkKeySeqNum:read(device)
...
function NetworkKeySeqNum:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NetworkKeySeqNum:write(device, value)
...
function NetworkKeySeqNum:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NetworkKeySeqNum, {__call = NetworkKeySeqNum.new_value})
