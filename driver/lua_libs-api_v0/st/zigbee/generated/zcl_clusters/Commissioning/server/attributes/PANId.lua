...
--- @field public NAME string "PANId" the name of this attribute
...
function PANId:augment_type(base_type_obj)
...
function PANId.pretty_print(value_obj)
  PANId.base_type.pretty_print(value_obj)
end

--- @function PANId:build_test_attr_report
---
...
PANId.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PANId:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PANId.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PANId:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PANId:write(device, value)
...
function PANId:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PANId, {__call = PANId.new_value})
return PANId
