...
--- @alias NetworkKeyType
---
--- @field public ID number 0x0016 the ID of this attribute
--- @field public NAME string "NetworkKeyType" the name of this attribute
--- @field public data_type st.zigbee.data_types.Enum8 the data type of this attribute
--- @field public STANDARD_KEY number 1
local NetworkKeyType = {
  ID = 0x0016,
  NAME = "NetworkKeyType",
  base_type = data_types.Enum8,
}

NetworkKeyType.STANDARD_KEY = 0x01


NetworkKeyType.enum_fields = {
    [NetworkKeyType.STANDARD_KEY] = "STANDARD_KEY",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.zigbee.data_types.Enum8 the base data type object to add functionality to
function NetworkKeyType:augment_type(base_type_obj)
...
function NetworkKeyType.pretty_print(value_obj)
  return string.format("%s: %s[%s]", value_obj.field_name or value_obj.NAME, NetworkKeyType.NAME, NetworkKeyType.enum_fields[value_obj.value])
end

--- @function NetworkKeyType:build_test_attr_report
---
...
NetworkKeyType.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NetworkKeyType:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Enum8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NetworkKeyType.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NetworkKeyType:new_value(...)
...
function NetworkKeyType:read(device)
...
function NetworkKeyType:configure_reporting(device, min_rep_int, max_rep_int)
...
function NetworkKeyType:write(device, value)
...
function NetworkKeyType:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NetworkKeyType, {__call = NetworkKeyType.new_value})
