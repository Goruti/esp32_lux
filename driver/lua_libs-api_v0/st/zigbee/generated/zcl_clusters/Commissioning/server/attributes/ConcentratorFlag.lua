...
--- @alias ConcentratorFlag
---
--- @field public ID number 0x0040 the ID of this attribute
--- @field public NAME string "ConcentratorFlag" the name of this attribute
--- @field public data_type st.zigbee.data_types.Boolean the data type of this attribute
local ConcentratorFlag = {
  ID = 0x0040,
  NAME = "ConcentratorFlag",
  base_type = data_types.Boolean,
}

function ConcentratorFlag:augment_type(base_type_obj)
...
function ConcentratorFlag.pretty_print(value_obj)
  ConcentratorFlag.base_type.pretty_print(value_obj)
end

--- @function ConcentratorFlag:build_test_attr_report
---
...
ConcentratorFlag.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ConcentratorFlag:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ConcentratorFlag.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ConcentratorFlag:new_value(...)
...
function ConcentratorFlag:read(device)
...
function ConcentratorFlag:configure_reporting(device, min_rep_int, max_rep_int)
...
function ConcentratorFlag:write(device, value)
...
function ConcentratorFlag:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ConcentratorFlag, {__call = ConcentratorFlag.new_value})
