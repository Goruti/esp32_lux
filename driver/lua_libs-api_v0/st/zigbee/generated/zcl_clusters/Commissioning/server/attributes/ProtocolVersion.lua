...
--- @field public NAME string "ProtocolVersion" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
--- @field public ZIGBEE2006OR_LATER number 2
...
ProtocolVersion.ZIGBEE2006OR_LATER = 0x02


ProtocolVersion.enum_fields = {
    [ProtocolVersion.ZIGBEE2006OR_LATER] = "ZIGBEE2006OR_LATER",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.zigbee.data_types.Uint8 the base data type object to add functionality to
function ProtocolVersion:augment_type(base_type_obj)
...
function ProtocolVersion.pretty_print(value_obj)
  return string.format("%s: %s[%s]", value_obj.field_name or value_obj.NAME, ProtocolVersion.NAME, ProtocolVersion.enum_fields[value_obj.value])
end

--- @function ProtocolVersion:build_test_attr_report
---
...
ProtocolVersion.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ProtocolVersion:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ProtocolVersion.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ProtocolVersion:new_value(...)
...
function ProtocolVersion:read(device)
...
function ProtocolVersion:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ProtocolVersion:write(device, value)
...
function ProtocolVersion:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ProtocolVersion, {__call = ProtocolVersion.new_value})
