...
--- @alias NetworkManagerAddress
---
--- @field public ID number 0x0017 the ID of this attribute
--- @field public NAME string "NetworkManagerAddress" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local NetworkManagerAddress = {
  ID = 0x0017,
  NAME = "NetworkManagerAddress",
  base_type = data_types.Uint16,
}

function NetworkManagerAddress:augment_type(base_type_obj)
...
function NetworkManagerAddress.pretty_print(value_obj)
  NetworkManagerAddress.base_type.pretty_print(value_obj)
end

--- @function NetworkManagerAddress:build_test_attr_report
---
...
NetworkManagerAddress.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NetworkManagerAddress:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NetworkManagerAddress.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NetworkManagerAddress:new_value(...)
...
function NetworkManagerAddress:read(device)
...
function NetworkManagerAddress:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NetworkManagerAddress:write(device, value)
...
function NetworkManagerAddress:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NetworkManagerAddress, {__call = NetworkManagerAddress.new_value})
