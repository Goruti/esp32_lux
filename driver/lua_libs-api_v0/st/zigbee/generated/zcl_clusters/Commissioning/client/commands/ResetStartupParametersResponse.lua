...
ResetStartupParametersResponse._serialize = utils.serialize_from_fields
...
function ResetStartupParametersResponse.deserialize(buf)
  ...
  for _, v in ipairs(ResetStartupParametersResponse.args_def) do
    ...
    elseif not v.optional then
      log.debug("Missing command arg " .. v.name .. " for deserializing ResetStartupParametersResponse")
    end
  end
