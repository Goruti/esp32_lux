...
--- @class st.zigbee.zcl.clusters.Diagnostics.PHYToMACQueueLimitReached
--- @alias PHYToMACQueueLimitReached
---
--- @field public ID number 0x0119 the ID of this attribute
--- @field public NAME string "PHYToMACQueueLimitReached" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PHYToMACQueueLimitReached = {
  ID = 0x0119,
  NAME = "PHYToMACQueueLimitReached",
  base_type = data_types.Uint16,
}

function PHYToMACQueueLimitReached:augment_type(base_type_obj)
...
function PHYToMACQueueLimitReached.pretty_print(value_obj)
  PHYToMACQueueLimitReached.base_type.pretty_print(value_obj)
end

--- @function PHYToMACQueueLimitReached:build_test_attr_report
---
...
PHYToMACQueueLimitReached.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PHYToMACQueueLimitReached:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PHYToMACQueueLimitReached.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the PHYToMACQueueLimitReached(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function PHYToMACQueueLimitReached:new_value(...)
...
function PHYToMACQueueLimitReached:read(device)
...
function PHYToMACQueueLimitReached:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PHYToMACQueueLimitReached:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PHYToMACQueueLimitReached, {__call = PHYToMACQueueLimitReached.new_value})
