...
--- @class st.zigbee.zcl.clusters.Diagnostics.PersistentMemoryWrites
--- @alias PersistentMemoryWrites
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "PersistentMemoryWrites" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PersistentMemoryWrites = {
  ID = 0x0001,
  NAME = "PersistentMemoryWrites",
  base_type = data_types.Uint16,
}

function PersistentMemoryWrites:augment_type(base_type_obj)
...
function PersistentMemoryWrites.pretty_print(value_obj)
  PersistentMemoryWrites.base_type.pretty_print(value_obj)
end

--- @function PersistentMemoryWrites:build_test_attr_report
---
...
PersistentMemoryWrites.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PersistentMemoryWrites:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PersistentMemoryWrites.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the PersistentMemoryWrites(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function PersistentMemoryWrites:new_value(...)
...
function PersistentMemoryWrites:read(device)
...
function PersistentMemoryWrites:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PersistentMemoryWrites:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PersistentMemoryWrites, {__call = PersistentMemoryWrites.new_value})
