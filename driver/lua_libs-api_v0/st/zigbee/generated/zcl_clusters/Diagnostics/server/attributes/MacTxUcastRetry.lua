...
--- @class st.zigbee.zcl.clusters.Diagnostics.MacTxUcastRetry
--- @alias MacTxUcastRetry
---
--- @field public ID number 0x0104 the ID of this attribute
--- @field public NAME string "MacTxUcastRetry" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local MacTxUcastRetry = {
  ID = 0x0104,
  NAME = "MacTxUcastRetry",
  base_type = data_types.Uint16,
}

function MacTxUcastRetry:augment_type(base_type_obj)
...
function MacTxUcastRetry.pretty_print(value_obj)
  MacTxUcastRetry.base_type.pretty_print(value_obj)
end

--- @function MacTxUcastRetry:build_test_attr_report
---
...
MacTxUcastRetry.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MacTxUcastRetry:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MacTxUcastRetry.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MacTxUcastRetry(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function MacTxUcastRetry:new_value(...)
...
function MacTxUcastRetry:read(device)
...
function MacTxUcastRetry:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MacTxUcastRetry:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MacTxUcastRetry, {__call = MacTxUcastRetry.new_value})
