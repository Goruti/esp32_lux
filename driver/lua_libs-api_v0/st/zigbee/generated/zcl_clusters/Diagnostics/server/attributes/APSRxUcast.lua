...
--- @class st.zigbee.zcl.clusters.Diagnostics.APSRxUcast
--- @alias APSRxUcast
---
--- @field public ID number 0x0108 the ID of this attribute
--- @field public NAME string "APSRxUcast" the name of this attribute
...
function APSRxUcast:augment_type(base_type_obj)
...
function APSRxUcast.pretty_print(value_obj)
  APSRxUcast.base_type.pretty_print(value_obj)
end

--- @function APSRxUcast:build_test_attr_report
---
...
APSRxUcast.build_test_attr_report = cluster_base.build_test_attr_report

--- @function APSRxUcast:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
APSRxUcast.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the APSRxUcast(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function APSRxUcast:new_value(...)
...
function APSRxUcast:read(device)
...
function APSRxUcast:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function APSRxUcast:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(APSRxUcast, {__call = APSRxUcast.new_value})
return APSRxUcast
