...
--- @class st.zigbee.zcl.clusters.Diagnostics.MacTxUcastFail
--- @alias MacTxUcastFail
---
--- @field public ID number 0x0105 the ID of this attribute
--- @field public NAME string "MacTxUcastFail" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local MacTxUcastFail = {
  ID = 0x0105,
  NAME = "MacTxUcastFail",
  base_type = data_types.Uint16,
}

function MacTxUcastFail:augment_type(base_type_obj)
...
function MacTxUcastFail.pretty_print(value_obj)
  MacTxUcastFail.base_type.pretty_print(value_obj)
end

--- @function MacTxUcastFail:build_test_attr_report
---
...
MacTxUcastFail.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MacTxUcastFail:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MacTxUcastFail.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MacTxUcastFail(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function MacTxUcastFail:new_value(...)
...
function MacTxUcastFail:read(device)
...
function MacTxUcastFail:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MacTxUcastFail:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MacTxUcastFail, {__call = MacTxUcastFail.new_value})
