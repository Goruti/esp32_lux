...
--- @class st.zigbee.zcl.clusters.Diagnostics.JoinIndication
--- @alias JoinIndication
---
--- @field public ID number 0x0110 the ID of this attribute
--- @field public NAME string "JoinIndication" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local JoinIndication = {
  ID = 0x0110,
  NAME = "JoinIndication",
  base_type = data_types.Uint16,
}

function JoinIndication:augment_type(base_type_obj)
...
function JoinIndication.pretty_print(value_obj)
  JoinIndication.base_type.pretty_print(value_obj)
end

--- @function JoinIndication:build_test_attr_report
---
...
JoinIndication.build_test_attr_report = cluster_base.build_test_attr_report

--- @function JoinIndication:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
JoinIndication.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the JoinIndication(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function JoinIndication:new_value(...)
...
function JoinIndication:read(device)
...
function JoinIndication:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function JoinIndication:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(JoinIndication, {__call = JoinIndication.new_value})
