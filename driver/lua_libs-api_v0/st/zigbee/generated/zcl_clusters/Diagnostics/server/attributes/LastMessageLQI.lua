...
--- @class st.zigbee.zcl.clusters.Diagnostics.LastMessageLQI
--- @alias LastMessageLQI
---
--- @field public ID number 0x011C the ID of this attribute
--- @field public NAME string "LastMessageLQI" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local LastMessageLQI = {
  ID = 0x011C,
  NAME = "LastMessageLQI",
  base_type = data_types.Uint8,
}

function LastMessageLQI:augment_type(base_type_obj)
...
function LastMessageLQI.pretty_print(value_obj)
  LastMessageLQI.base_type.pretty_print(value_obj)
end

--- @function LastMessageLQI:build_test_attr_report
---
...
LastMessageLQI.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LastMessageLQI:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LastMessageLQI.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint8 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the LastMessageLQI(...) syntax
---
--- @vararg vararg the values needed to construct a Uint8
--- @return st.zigbee.data_types.Uint8
function LastMessageLQI:new_value(...)
...
function LastMessageLQI:read(device)
...
function LastMessageLQI:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LastMessageLQI:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LastMessageLQI, {__call = LastMessageLQI.new_value})
