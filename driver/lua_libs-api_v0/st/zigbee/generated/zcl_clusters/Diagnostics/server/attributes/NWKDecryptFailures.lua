...
--- @class st.zigbee.zcl.clusters.Diagnostics.NWKDecryptFailures
--- @alias NWKDecryptFailures
---
--- @field public ID number 0x0115 the ID of this attribute
--- @field public NAME string "NWKDecryptFailures" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local NWKDecryptFailures = {
  ID = 0x0115,
  NAME = "NWKDecryptFailures",
  base_type = data_types.Uint16,
}

function NWKDecryptFailures:augment_type(base_type_obj)
...
function NWKDecryptFailures.pretty_print(value_obj)
  NWKDecryptFailures.base_type.pretty_print(value_obj)
end

--- @function NWKDecryptFailures:build_test_attr_report
---
...
NWKDecryptFailures.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NWKDecryptFailures:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NWKDecryptFailures.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the NWKDecryptFailures(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function NWKDecryptFailures:new_value(...)
...
function NWKDecryptFailures:read(device)
...
function NWKDecryptFailures:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NWKDecryptFailures:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NWKDecryptFailures, {__call = NWKDecryptFailures.new_value})
