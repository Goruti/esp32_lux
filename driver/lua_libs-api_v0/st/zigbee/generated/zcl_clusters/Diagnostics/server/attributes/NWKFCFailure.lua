...
--- @class st.zigbee.zcl.clusters.Diagnostics.NWKFCFailure
--- @alias NWKFCFailure
---
--- @field public ID number 0x0112 the ID of this attribute
--- @field public NAME string "NWKFCFailure" the name of this attribute
...
function NWKFCFailure:augment_type(base_type_obj)
...
function NWKFCFailure.pretty_print(value_obj)
  NWKFCFailure.base_type.pretty_print(value_obj)
end

--- @function NWKFCFailure:build_test_attr_report
---
...
NWKFCFailure.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NWKFCFailure:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NWKFCFailure.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the NWKFCFailure(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function NWKFCFailure:new_value(...)
...
function NWKFCFailure:read(device)
...
function NWKFCFailure:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NWKFCFailure:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NWKFCFailure, {__call = NWKFCFailure.new_value})
return NWKFCFailure
