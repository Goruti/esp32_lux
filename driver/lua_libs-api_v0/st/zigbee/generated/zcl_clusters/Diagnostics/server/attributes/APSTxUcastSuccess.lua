...
--- @class st.zigbee.zcl.clusters.Diagnostics.APSTxUcastSuccess
--- @alias APSTxUcastSuccess
---
--- @field public ID number 0x0109 the ID of this attribute
--- @field public NAME string "APSTxUcastSuccess" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local APSTxUcastSuccess = {
  ID = 0x0109,
  NAME = "APSTxUcastSuccess",
  base_type = data_types.Uint16,
}

function APSTxUcastSuccess:augment_type(base_type_obj)
...
function APSTxUcastSuccess.pretty_print(value_obj)
  APSTxUcastSuccess.base_type.pretty_print(value_obj)
end

--- @function APSTxUcastSuccess:build_test_attr_report
---
...
APSTxUcastSuccess.build_test_attr_report = cluster_base.build_test_attr_report

--- @function APSTxUcastSuccess:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
APSTxUcastSuccess.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the APSTxUcastSuccess(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function APSTxUcastSuccess:new_value(...)
...
function APSTxUcastSuccess:read(device)
...
function APSTxUcastSuccess:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function APSTxUcastSuccess:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(APSTxUcastSuccess, {__call = APSTxUcastSuccess.new_value})
