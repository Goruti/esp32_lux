...
--- @class st.zigbee.zcl.clusters.Diagnostics.APSTxBcast
--- @alias APSTxBcast
---
--- @field public ID number 0x0107 the ID of this attribute
--- @field public NAME string "APSTxBcast" the name of this attribute
...
function APSTxBcast:augment_type(base_type_obj)
...
function APSTxBcast.pretty_print(value_obj)
  APSTxBcast.base_type.pretty_print(value_obj)
end

--- @function APSTxBcast:build_test_attr_report
---
...
APSTxBcast.build_test_attr_report = cluster_base.build_test_attr_report

--- @function APSTxBcast:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
APSTxBcast.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the APSTxBcast(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function APSTxBcast:new_value(...)
...
function APSTxBcast:read(device)
...
function APSTxBcast:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function APSTxBcast:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(APSTxBcast, {__call = APSTxBcast.new_value})
return APSTxBcast
