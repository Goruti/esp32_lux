...
--- @class st.zigbee.zcl.clusters.Diagnostics.APSTxUcastFail
--- @alias APSTxUcastFail
---
--- @field public ID number 0x010B the ID of this attribute
--- @field public NAME string "APSTxUcastFail" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local APSTxUcastFail = {
  ID = 0x010B,
  NAME = "APSTxUcastFail",
  base_type = data_types.Uint16,
}

function APSTxUcastFail:augment_type(base_type_obj)
...
function APSTxUcastFail.pretty_print(value_obj)
  APSTxUcastFail.base_type.pretty_print(value_obj)
end

--- @function APSTxUcastFail:build_test_attr_report
---
...
APSTxUcastFail.build_test_attr_report = cluster_base.build_test_attr_report

--- @function APSTxUcastFail:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
APSTxUcastFail.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the APSTxUcastFail(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function APSTxUcastFail:new_value(...)
...
function APSTxUcastFail:read(device)
...
function APSTxUcastFail:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function APSTxUcastFail:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(APSTxUcastFail, {__call = APSTxUcastFail.new_value})
