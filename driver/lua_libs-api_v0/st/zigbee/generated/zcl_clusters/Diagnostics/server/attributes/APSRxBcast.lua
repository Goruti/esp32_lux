...
--- @class st.zigbee.zcl.clusters.Diagnostics.APSRxBcast
--- @alias APSRxBcast
---
--- @field public ID number 0x0106 the ID of this attribute
--- @field public NAME string "APSRxBcast" the name of this attribute
...
function APSRxBcast:augment_type(base_type_obj)
...
function APSRxBcast.pretty_print(value_obj)
  APSRxBcast.base_type.pretty_print(value_obj)
end

--- @function APSRxBcast:build_test_attr_report
---
...
APSRxBcast.build_test_attr_report = cluster_base.build_test_attr_report

--- @function APSRxBcast:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
APSRxBcast.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the APSRxBcast(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function APSRxBcast:new_value(...)
...
function APSRxBcast:read(device)
...
function APSRxBcast:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function APSRxBcast:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(APSRxBcast, {__call = APSRxBcast.new_value})
return APSRxBcast
