...
--- @class st.zigbee.zcl.clusters.Diagnostics.PacketValidateDropCount
--- @alias PacketValidateDropCount
---
--- @field public ID number 0x011A the ID of this attribute
--- @field public NAME string "PacketValidateDropCount" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PacketValidateDropCount = {
  ID = 0x011A,
  NAME = "PacketValidateDropCount",
  base_type = data_types.Uint16,
}

function PacketValidateDropCount:augment_type(base_type_obj)
...
function PacketValidateDropCount.pretty_print(value_obj)
  PacketValidateDropCount.base_type.pretty_print(value_obj)
end

--- @function PacketValidateDropCount:build_test_attr_report
---
...
PacketValidateDropCount.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PacketValidateDropCount:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PacketValidateDropCount.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the PacketValidateDropCount(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function PacketValidateDropCount:new_value(...)
...
function PacketValidateDropCount:read(device)
...
function PacketValidateDropCount:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PacketValidateDropCount:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PacketValidateDropCount, {__call = PacketValidateDropCount.new_value})
