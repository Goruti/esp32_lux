...
--- @class st.zigbee.zcl.clusters.Diagnostics.ChildMoved
--- @alias ChildMoved
---
--- @field public ID number 0x0111 the ID of this attribute
--- @field public NAME string "ChildMoved" the name of this attribute
...
function ChildMoved:augment_type(base_type_obj)
...
function ChildMoved.pretty_print(value_obj)
  ChildMoved.base_type.pretty_print(value_obj)
end

--- @function ChildMoved:build_test_attr_report
---
...
ChildMoved.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ChildMoved:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ChildMoved.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the ChildMoved(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function ChildMoved:new_value(...)
...
function ChildMoved:read(device)
...
function ChildMoved:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ChildMoved:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ChildMoved, {__call = ChildMoved.new_value})
return ChildMoved
