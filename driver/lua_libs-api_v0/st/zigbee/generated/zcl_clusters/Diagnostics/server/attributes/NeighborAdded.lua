...
--- @class st.zigbee.zcl.clusters.Diagnostics.NeighborAdded
--- @alias NeighborAdded
---
--- @field public ID number 0x010D the ID of this attribute
--- @field public NAME string "NeighborAdded" the name of this attribute
...
function NeighborAdded:augment_type(base_type_obj)
...
function NeighborAdded.pretty_print(value_obj)
  NeighborAdded.base_type.pretty_print(value_obj)
end

--- @function NeighborAdded:build_test_attr_report
---
...
NeighborAdded.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NeighborAdded:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NeighborAdded.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the NeighborAdded(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function NeighborAdded:new_value(...)
...
function NeighborAdded:read(device)
...
function NeighborAdded:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NeighborAdded:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NeighborAdded, {__call = NeighborAdded.new_value})
