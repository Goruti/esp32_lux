...
--- @class st.zigbee.zcl.clusters.Diagnostics.APSTxUcastRetry
--- @alias APSTxUcastRetry
---
--- @field public ID number 0x010A the ID of this attribute
--- @field public NAME string "APSTxUcastRetry" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local APSTxUcastRetry = {
  ID = 0x010A,
  NAME = "APSTxUcastRetry",
  base_type = data_types.Uint16,
}

function APSTxUcastRetry:augment_type(base_type_obj)
...
function APSTxUcastRetry.pretty_print(value_obj)
  APSTxUcastRetry.base_type.pretty_print(value_obj)
end

--- @function APSTxUcastRetry:build_test_attr_report
---
...
APSTxUcastRetry.build_test_attr_report = cluster_base.build_test_attr_report

--- @function APSTxUcastRetry:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
APSTxUcastRetry.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the APSTxUcastRetry(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function APSTxUcastRetry:new_value(...)
...
function APSTxUcastRetry:read(device)
...
function APSTxUcastRetry:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function APSTxUcastRetry:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(APSTxUcastRetry, {__call = APSTxUcastRetry.new_value})
