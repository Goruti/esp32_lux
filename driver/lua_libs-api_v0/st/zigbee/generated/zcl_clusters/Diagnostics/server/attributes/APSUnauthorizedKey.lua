...
--- @class st.zigbee.zcl.clusters.Diagnostics.APSUnauthorizedKey
--- @alias APSUnauthorizedKey
---
--- @field public ID number 0x0114 the ID of this attribute
--- @field public NAME string "APSUnauthorizedKey" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local APSUnauthorizedKey = {
  ID = 0x0114,
  NAME = "APSUnauthorizedKey",
  base_type = data_types.Uint16,
}

function APSUnauthorizedKey:augment_type(base_type_obj)
...
function APSUnauthorizedKey.pretty_print(value_obj)
  APSUnauthorizedKey.base_type.pretty_print(value_obj)
end

--- @function APSUnauthorizedKey:build_test_attr_report
---
...
APSUnauthorizedKey.build_test_attr_report = cluster_base.build_test_attr_report

--- @function APSUnauthorizedKey:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
APSUnauthorizedKey.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the APSUnauthorizedKey(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function APSUnauthorizedKey:new_value(...)
...
function APSUnauthorizedKey:read(device)
...
function APSUnauthorizedKey:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function APSUnauthorizedKey:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(APSUnauthorizedKey, {__call = APSUnauthorizedKey.new_value})
