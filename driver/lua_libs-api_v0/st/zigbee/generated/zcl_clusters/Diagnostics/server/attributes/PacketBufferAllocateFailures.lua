...
--- @class st.zigbee.zcl.clusters.Diagnostics.PacketBufferAllocateFailures
--- @alias PacketBufferAllocateFailures
---
--- @field public ID number 0x0117 the ID of this attribute
--- @field public NAME string "PacketBufferAllocateFailures" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local PacketBufferAllocateFailures = {
  ID = 0x0117,
  NAME = "PacketBufferAllocateFailures",
  base_type = data_types.Uint16,
}

function PacketBufferAllocateFailures:augment_type(base_type_obj)
...
function PacketBufferAllocateFailures.pretty_print(value_obj)
  PacketBufferAllocateFailures.base_type.pretty_print(value_obj)
end

--- @function PacketBufferAllocateFailures:build_test_attr_report
---
...
PacketBufferAllocateFailures.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PacketBufferAllocateFailures:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PacketBufferAllocateFailures.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the PacketBufferAllocateFailures(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function PacketBufferAllocateFailures:new_value(...)
...
function PacketBufferAllocateFailures:read(device)
...
function PacketBufferAllocateFailures:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PacketBufferAllocateFailures:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PacketBufferAllocateFailures, {__call = PacketBufferAllocateFailures.new_value})
