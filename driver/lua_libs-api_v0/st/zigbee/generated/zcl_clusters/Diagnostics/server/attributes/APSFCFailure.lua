...
--- @class st.zigbee.zcl.clusters.Diagnostics.APSFCFailure
--- @alias APSFCFailure
---
--- @field public ID number 0x0113 the ID of this attribute
--- @field public NAME string "APSFCFailure" the name of this attribute
...
function APSFCFailure:augment_type(base_type_obj)
...
function APSFCFailure.pretty_print(value_obj)
  APSFCFailure.base_type.pretty_print(value_obj)
end

--- @function APSFCFailure:build_test_attr_report
---
...
APSFCFailure.build_test_attr_report = cluster_base.build_test_attr_report

--- @function APSFCFailure:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
APSFCFailure.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the APSFCFailure(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function APSFCFailure:new_value(...)
...
function APSFCFailure:read(device)
...
function APSFCFailure:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function APSFCFailure:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(APSFCFailure, {__call = APSFCFailure.new_value})
return APSFCFailure
