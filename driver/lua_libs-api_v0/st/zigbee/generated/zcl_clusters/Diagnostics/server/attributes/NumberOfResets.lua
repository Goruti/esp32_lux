...
--- @class st.zigbee.zcl.clusters.Diagnostics.NumberOfResets
--- @alias NumberOfResets
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "NumberOfResets" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local NumberOfResets = {
  ID = 0x0000,
  NAME = "NumberOfResets",
  base_type = data_types.Uint16,
}

function NumberOfResets:augment_type(base_type_obj)
...
function NumberOfResets.pretty_print(value_obj)
  NumberOfResets.base_type.pretty_print(value_obj)
end

--- @function NumberOfResets:build_test_attr_report
---
...
NumberOfResets.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfResets:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfResets.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the NumberOfResets(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function NumberOfResets:new_value(...)
...
function NumberOfResets:read(device)
...
function NumberOfResets:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NumberOfResets:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NumberOfResets, {__call = NumberOfResets.new_value})
