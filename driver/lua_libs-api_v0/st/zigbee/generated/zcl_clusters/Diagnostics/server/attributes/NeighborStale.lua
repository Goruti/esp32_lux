...
--- @class st.zigbee.zcl.clusters.Diagnostics.NeighborStale
--- @alias NeighborStale
---
--- @field public ID number 0x010F the ID of this attribute
--- @field public NAME string "NeighborStale" the name of this attribute
...
function NeighborStale:augment_type(base_type_obj)
...
function NeighborStale.pretty_print(value_obj)
  NeighborStale.base_type.pretty_print(value_obj)
end

--- @function NeighborStale:build_test_attr_report
---
...
NeighborStale.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NeighborStale:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NeighborStale.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the NeighborStale(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function NeighborStale:new_value(...)
...
function NeighborStale:read(device)
...
function NeighborStale:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NeighborStale:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NeighborStale, {__call = NeighborStale.new_value})
