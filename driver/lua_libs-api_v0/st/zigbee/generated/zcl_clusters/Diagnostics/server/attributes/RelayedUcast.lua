...
--- @class st.zigbee.zcl.clusters.Diagnostics.RelayedUcast
--- @alias RelayedUcast
---
--- @field public ID number 0x0118 the ID of this attribute
--- @field public NAME string "RelayedUcast" the name of this attribute
...
function RelayedUcast:augment_type(base_type_obj)
...
function RelayedUcast.pretty_print(value_obj)
  RelayedUcast.base_type.pretty_print(value_obj)
end

--- @function RelayedUcast:build_test_attr_report
---
...
RelayedUcast.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RelayedUcast:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RelayedUcast.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the RelayedUcast(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function RelayedUcast:new_value(...)
...
function RelayedUcast:read(device)
...
function RelayedUcast:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RelayedUcast:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RelayedUcast, {__call = RelayedUcast.new_value})
return RelayedUcast
