...
--- @class st.zigbee.zcl.clusters.Diagnostics.APSDecryptFailures
--- @alias APSDecryptFailures
---
--- @field public ID number 0x0116 the ID of this attribute
--- @field public NAME string "APSDecryptFailures" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local APSDecryptFailures = {
  ID = 0x0116,
  NAME = "APSDecryptFailures",
  base_type = data_types.Uint16,
}

function APSDecryptFailures:augment_type(base_type_obj)
...
function APSDecryptFailures.pretty_print(value_obj)
  APSDecryptFailures.base_type.pretty_print(value_obj)
end

--- @function APSDecryptFailures:build_test_attr_report
---
...
APSDecryptFailures.build_test_attr_report = cluster_base.build_test_attr_report

--- @function APSDecryptFailures:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
APSDecryptFailures.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the APSDecryptFailures(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function APSDecryptFailures:new_value(...)
...
function APSDecryptFailures:read(device)
...
function APSDecryptFailures:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function APSDecryptFailures:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(APSDecryptFailures, {__call = APSDecryptFailures.new_value})
