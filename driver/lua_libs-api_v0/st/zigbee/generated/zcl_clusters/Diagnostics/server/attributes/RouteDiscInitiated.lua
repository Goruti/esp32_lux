...
--- @class st.zigbee.zcl.clusters.Diagnostics.RouteDiscInitiated
--- @alias RouteDiscInitiated
---
--- @field public ID number 0x010C the ID of this attribute
--- @field public NAME string "RouteDiscInitiated" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local RouteDiscInitiated = {
  ID = 0x010C,
  NAME = "RouteDiscInitiated",
  base_type = data_types.Uint16,
}

function RouteDiscInitiated:augment_type(base_type_obj)
...
function RouteDiscInitiated.pretty_print(value_obj)
  RouteDiscInitiated.base_type.pretty_print(value_obj)
end

--- @function RouteDiscInitiated:build_test_attr_report
---
...
RouteDiscInitiated.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RouteDiscInitiated:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RouteDiscInitiated.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the RouteDiscInitiated(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function RouteDiscInitiated:new_value(...)
...
function RouteDiscInitiated:read(device)
...
function RouteDiscInitiated:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RouteDiscInitiated:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RouteDiscInitiated, {__call = RouteDiscInitiated.new_value})
