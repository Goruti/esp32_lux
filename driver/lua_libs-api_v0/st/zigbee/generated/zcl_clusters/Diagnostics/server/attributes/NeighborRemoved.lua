...
--- @class st.zigbee.zcl.clusters.Diagnostics.NeighborRemoved
--- @alias NeighborRemoved
---
--- @field public ID number 0x010E the ID of this attribute
--- @field public NAME string "NeighborRemoved" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local NeighborRemoved = {
  ID = 0x010E,
  NAME = "NeighborRemoved",
  base_type = data_types.Uint16,
}

function NeighborRemoved:augment_type(base_type_obj)
...
function NeighborRemoved.pretty_print(value_obj)
  NeighborRemoved.base_type.pretty_print(value_obj)
end

--- @function NeighborRemoved:build_test_attr_report
---
...
NeighborRemoved.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NeighborRemoved:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NeighborRemoved.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the NeighborRemoved(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function NeighborRemoved:new_value(...)
...
function NeighborRemoved:read(device)
...
function NeighborRemoved:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NeighborRemoved:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NeighborRemoved, {__call = NeighborRemoved.new_value})
