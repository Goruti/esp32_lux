...
--- @alias TemperatureSetpointHoldDuration
---
--- @field public ID number 0x0024 the ID of this attribute
--- @field public NAME string "TemperatureSetpointHoldDuration" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local TemperatureSetpointHoldDuration = {
  ID = 0x0024,
  NAME = "TemperatureSetpointHoldDuration",
  base_type = data_types.Uint16,
}

function TemperatureSetpointHoldDuration:augment_type(base_type_obj)
...
function TemperatureSetpointHoldDuration.pretty_print(value_obj)
  TemperatureSetpointHoldDuration.base_type.pretty_print(value_obj)
end

--- @function TemperatureSetpointHoldDuration:build_test_attr_report
---
...
TemperatureSetpointHoldDuration.build_test_attr_report = cluster_base.build_test_attr_report

--- @function TemperatureSetpointHoldDuration:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
TemperatureSetpointHoldDuration.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function TemperatureSetpointHoldDuration:new_value(...)
...
function TemperatureSetpointHoldDuration:read(device)
...
function TemperatureSetpointHoldDuration:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function TemperatureSetpointHoldDuration:write(device, value)
...
function TemperatureSetpointHoldDuration:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(TemperatureSetpointHoldDuration, {__call = TemperatureSetpointHoldDuration.new_value})
