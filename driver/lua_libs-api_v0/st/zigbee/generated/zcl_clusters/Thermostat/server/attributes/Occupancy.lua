...
--- @function Occupancy:is_occupied_set
--- @return boolean True if the value of OCCUPIED is non-zero
Occupancy.is_occupied_set = function(self)
  return (self.value & self.OCCUPIED) ~= 0
end
 
--- @function Occupancy:set_occupied
--- Set the value of the bit in the OCCUPIED field to 1
Occupancy.set_occupied = function(self)
  self.value = self.value | self.OCCUPIED
end

--- @function Occupancy:unset_occupied
--- Set the value of the bits in the OCCUPIED field to 0
Occupancy.unset_occupied = function(self)
  self.value = self.value & (~self.OCCUPIED & self.BASE_MASK)
end


Occupancy.mask_methods = {
  is_occupied_set = Occupancy.is_occupied_set,
  set_occupied = Occupancy.set_occupied,
  unset_occupied = Occupancy.unset_occupied,
}
