...
function MinCoolSetpointLimit.pretty_print(value_obj)
  MinCoolSetpointLimit.base_type.pretty_print(value_obj)
end

--- @function MinCoolSetpointLimit:build_test_attr_report
---
...
MinCoolSetpointLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinCoolSetpointLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinCoolSetpointLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinCoolSetpointLimit:new_value(...)
...
function MinCoolSetpointLimit:read(device)
...
function MinCoolSetpointLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinCoolSetpointLimit:write(device, value)
...
function MinCoolSetpointLimit:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinCoolSetpointLimit, {__call = MinCoolSetpointLimit.new_value})
