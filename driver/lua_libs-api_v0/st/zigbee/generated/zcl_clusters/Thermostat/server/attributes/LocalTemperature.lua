...
--- @field public NAME string "LocalTemperature" the name of this attribute
...
function LocalTemperature:augment_type(base_type_obj)
...
function LocalTemperature.pretty_print(value_obj)
  LocalTemperature.base_type.pretty_print(value_obj)
end

--- @function LocalTemperature:build_test_attr_report
---
...
LocalTemperature.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LocalTemperature:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LocalTemperature.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LocalTemperature:new_value(...)
...
function LocalTemperature:read(device)
...
function LocalTemperature:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LocalTemperature:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LocalTemperature, {__call = LocalTemperature.new_value})
