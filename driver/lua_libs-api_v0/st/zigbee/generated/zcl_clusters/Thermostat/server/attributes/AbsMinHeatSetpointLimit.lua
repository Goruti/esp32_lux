...
--- @field public NAME string "AbsMinHeatSetpointLimit" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local AbsMinHeatSetpointLimit = {
  ID = 0x0003,
  NAME = "AbsMinHeatSetpointLimit",
  base_type = data_types.Int16,
}

function AbsMinHeatSetpointLimit:augment_type(base_type_obj)
...
function AbsMinHeatSetpointLimit.pretty_print(value_obj)
  AbsMinHeatSetpointLimit.base_type.pretty_print(value_obj)
end

--- @function AbsMinHeatSetpointLimit:build_test_attr_report
---
...
AbsMinHeatSetpointLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AbsMinHeatSetpointLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AbsMinHeatSetpointLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AbsMinHeatSetpointLimit:new_value(...)
...
function AbsMinHeatSetpointLimit:read(device)
...
function AbsMinHeatSetpointLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AbsMinHeatSetpointLimit:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AbsMinHeatSetpointLimit, {__call = AbsMinHeatSetpointLimit.new_value})
