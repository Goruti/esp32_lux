...
function MaxCoolSetpointLimit.pretty_print(value_obj)
  MaxCoolSetpointLimit.base_type.pretty_print(value_obj)
end

--- @function MaxCoolSetpointLimit:build_test_attr_report
---
...
MaxCoolSetpointLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxCoolSetpointLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxCoolSetpointLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxCoolSetpointLimit:new_value(...)
...
function MaxCoolSetpointLimit:read(device)
...
function MaxCoolSetpointLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxCoolSetpointLimit:write(device, value)
...
function MaxCoolSetpointLimit:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxCoolSetpointLimit, {__call = MaxCoolSetpointLimit.new_value})
