...
function PIHeatingDemand.pretty_print(value_obj)
  PIHeatingDemand.base_type.pretty_print(value_obj)
end

--- @function PIHeatingDemand:build_test_attr_report
---
...
PIHeatingDemand.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PIHeatingDemand:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PIHeatingDemand.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PIHeatingDemand:new_value(...)
...
function PIHeatingDemand:read(device)
...
function PIHeatingDemand:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PIHeatingDemand:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PIHeatingDemand, {__call = PIHeatingDemand.new_value})
