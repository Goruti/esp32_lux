...
function OccupiedSetbackMax.pretty_print(value_obj)
  OccupiedSetbackMax.base_type.pretty_print(value_obj)
end

--- @function OccupiedSetbackMax:build_test_attr_report
---
...
OccupiedSetbackMax.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OccupiedSetbackMax:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OccupiedSetbackMax.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OccupiedSetbackMax:new_value(...)
...
function OccupiedSetbackMax:read(device)
...
function OccupiedSetbackMax:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OccupiedSetbackMax:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OccupiedSetbackMax, {__call = OccupiedSetbackMax.new_value})
