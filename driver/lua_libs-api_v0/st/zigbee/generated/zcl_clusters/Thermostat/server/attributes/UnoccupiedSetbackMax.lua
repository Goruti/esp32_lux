...
function UnoccupiedSetbackMax.pretty_print(value_obj)
  UnoccupiedSetbackMax.base_type.pretty_print(value_obj)
end

--- @function UnoccupiedSetbackMax:build_test_attr_report
---
...
UnoccupiedSetbackMax.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UnoccupiedSetbackMax:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UnoccupiedSetbackMax.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UnoccupiedSetbackMax:new_value(...)
...
function UnoccupiedSetbackMax:read(device)
...
function UnoccupiedSetbackMax:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function UnoccupiedSetbackMax:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(UnoccupiedSetbackMax, {__call = UnoccupiedSetbackMax.new_value})
