...
--- @field public NAME string "OccupiedCoolingSetpoint" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local OccupiedCoolingSetpoint = {
  ID = 0x0011,
  NAME = "OccupiedCoolingSetpoint",
  base_type = data_types.Int16,
}

function OccupiedCoolingSetpoint:augment_type(base_type_obj)
...
function OccupiedCoolingSetpoint.pretty_print(value_obj)
  OccupiedCoolingSetpoint.base_type.pretty_print(value_obj)
end

--- @function OccupiedCoolingSetpoint:build_test_attr_report
---
...
OccupiedCoolingSetpoint.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OccupiedCoolingSetpoint:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OccupiedCoolingSetpoint.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OccupiedCoolingSetpoint:new_value(...)
...
function OccupiedCoolingSetpoint:read(device)
...
function OccupiedCoolingSetpoint:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OccupiedCoolingSetpoint:write(device, value)
...
function OccupiedCoolingSetpoint:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OccupiedCoolingSetpoint, {__call = OccupiedCoolingSetpoint.new_value})
