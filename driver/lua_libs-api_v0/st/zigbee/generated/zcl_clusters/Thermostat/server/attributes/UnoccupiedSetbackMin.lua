...
function UnoccupiedSetbackMin.pretty_print(value_obj)
  UnoccupiedSetbackMin.base_type.pretty_print(value_obj)
end

--- @function UnoccupiedSetbackMin:build_test_attr_report
---
...
UnoccupiedSetbackMin.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UnoccupiedSetbackMin:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UnoccupiedSetbackMin.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UnoccupiedSetbackMin:new_value(...)
...
function UnoccupiedSetbackMin:read(device)
...
function UnoccupiedSetbackMin:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function UnoccupiedSetbackMin:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(UnoccupiedSetbackMin, {__call = UnoccupiedSetbackMin.new_value})
