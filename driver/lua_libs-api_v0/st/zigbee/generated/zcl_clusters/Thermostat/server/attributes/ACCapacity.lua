...
--- @field public NAME string "ACCapacity" the name of this attribute
...
function ACCapacity:augment_type(base_type_obj)
...
function ACCapacity.pretty_print(value_obj)
  ACCapacity.base_type.pretty_print(value_obj)
end

--- @function ACCapacity:build_test_attr_report
---
...
ACCapacity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACCapacity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACCapacity.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACCapacity:read(device)
...
function ACCapacity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACCapacity:write(device, value)
...
function ACCapacity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACCapacity, {__call = ACCapacity.new_value})
return ACCapacity
