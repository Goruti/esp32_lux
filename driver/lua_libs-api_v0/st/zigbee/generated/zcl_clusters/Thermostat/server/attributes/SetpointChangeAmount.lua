...
function SetpointChangeAmount.pretty_print(value_obj)
  SetpointChangeAmount.base_type.pretty_print(value_obj)
end

--- @function SetpointChangeAmount:build_test_attr_report
---
...
SetpointChangeAmount.build_test_attr_report = cluster_base.build_test_attr_report

--- @function SetpointChangeAmount:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
SetpointChangeAmount.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function SetpointChangeAmount:new_value(...)
...
function SetpointChangeAmount:read(device)
...
function SetpointChangeAmount:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function SetpointChangeAmount:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(SetpointChangeAmount, {__call = SetpointChangeAmount.new_value})
