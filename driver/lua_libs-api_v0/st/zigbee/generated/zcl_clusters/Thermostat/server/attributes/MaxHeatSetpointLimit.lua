...
function MaxHeatSetpointLimit.pretty_print(value_obj)
  MaxHeatSetpointLimit.base_type.pretty_print(value_obj)
end

--- @function MaxHeatSetpointLimit:build_test_attr_report
---
...
MaxHeatSetpointLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MaxHeatSetpointLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MaxHeatSetpointLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MaxHeatSetpointLimit:new_value(...)
...
function MaxHeatSetpointLimit:read(device)
...
function MaxHeatSetpointLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MaxHeatSetpointLimit:write(device, value)
...
function MaxHeatSetpointLimit:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MaxHeatSetpointLimit, {__call = MaxHeatSetpointLimit.new_value})
