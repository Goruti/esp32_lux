...
--- @field public NAME string "AbsMaxCoolSetpointLimit" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local AbsMaxCoolSetpointLimit = {
  ID = 0x0006,
  NAME = "AbsMaxCoolSetpointLimit",
  base_type = data_types.Int16,
}

function AbsMaxCoolSetpointLimit:augment_type(base_type_obj)
...
function AbsMaxCoolSetpointLimit.pretty_print(value_obj)
  AbsMaxCoolSetpointLimit.base_type.pretty_print(value_obj)
end

--- @function AbsMaxCoolSetpointLimit:build_test_attr_report
---
...
AbsMaxCoolSetpointLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AbsMaxCoolSetpointLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AbsMaxCoolSetpointLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AbsMaxCoolSetpointLimit:new_value(...)
...
function AbsMaxCoolSetpointLimit:read(device)
...
function AbsMaxCoolSetpointLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AbsMaxCoolSetpointLimit:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AbsMaxCoolSetpointLimit, {__call = AbsMaxCoolSetpointLimit.new_value})
