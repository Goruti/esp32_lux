...
--- @alias TemperatureSetpointHold
---
--- @field public ID number 0x0023 the ID of this attribute
--- @field public NAME string "TemperatureSetpointHold" the name of this attribute
...
local TemperatureSetpointHold = {
  ID = 0x0023,
  NAME = "TemperatureSetpointHold",
  base_type = data_types.Enum8,
}

TemperatureSetpointHold.SETPOINT_HOLD_OFF = 0x00
TemperatureSetpointHold.SETPOINT_HOLD_ON  = 0x01


TemperatureSetpointHold.enum_fields = {
    [TemperatureSetpointHold.SETPOINT_HOLD_OFF] = "SETPOINT_HOLD_OFF",
    [TemperatureSetpointHold.SETPOINT_HOLD_ON]  = "SETPOINT_HOLD_ON",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.zigbee.data_types.Enum8 the base data type object to add functionality to
function TemperatureSetpointHold:augment_type(base_type_obj)
...
function TemperatureSetpointHold.pretty_print(value_obj)
  return string.format("%s: %s[%s]", value_obj.field_name or value_obj.NAME, TemperatureSetpointHold.NAME, TemperatureSetpointHold.enum_fields[value_obj.value])
end

--- @function TemperatureSetpointHold:build_test_attr_report
---
...
TemperatureSetpointHold.build_test_attr_report = cluster_base.build_test_attr_report

--- @function TemperatureSetpointHold:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Enum8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
TemperatureSetpointHold.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function TemperatureSetpointHold:new_value(...)
...
function TemperatureSetpointHold:read(device)
...
function TemperatureSetpointHold:configure_reporting(device, min_rep_int, max_rep_int)
...
function TemperatureSetpointHold:write(device, value)
...
function TemperatureSetpointHold:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(TemperatureSetpointHold, {__call = TemperatureSetpointHold.new_value})
