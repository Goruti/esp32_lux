...
--- @alias ACRefrigerantType
---
--- @field public ID number 0x0042 the ID of this attribute
--- @field public NAME string "ACRefrigerantType" the name of this attribute
...
local ACRefrigerantType = {
  ID = 0x0042,
  NAME = "ACRefrigerantType",
  base_type = data_types.Enum8,
}

ACRefrigerantType.R22   = 0x01
ACRefrigerantType.R410A = 0x02
ACRefrigerantType.R407C = 0x03


ACRefrigerantType.enum_fields = {
    [ACRefrigerantType.R22]   = "R22",
    [ACRefrigerantType.R410A] = "R410A",
    [ACRefrigerantType.R407C] = "R407C",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.zigbee.data_types.Enum8 the base data type object to add functionality to
function ACRefrigerantType:augment_type(base_type_obj)
...
function ACRefrigerantType.pretty_print(value_obj)
  return string.format("%s: %s[%s]", value_obj.field_name or value_obj.NAME, ACRefrigerantType.NAME, ACRefrigerantType.enum_fields[value_obj.value])
end

--- @function ACRefrigerantType:build_test_attr_report
---
...
ACRefrigerantType.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACRefrigerantType:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Enum8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACRefrigerantType.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACRefrigerantType:new_value(...)
...
function ACRefrigerantType:read(device)
...
function ACRefrigerantType:configure_reporting(device, min_rep_int, max_rep_int)
...
function ACRefrigerantType:write(device, value)
...
function ACRefrigerantType:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACRefrigerantType, {__call = ACRefrigerantType.new_value})
