...
function PICoolingDemand.pretty_print(value_obj)
  PICoolingDemand.base_type.pretty_print(value_obj)
end

--- @function PICoolingDemand:build_test_attr_report
---
...
PICoolingDemand.build_test_attr_report = cluster_base.build_test_attr_report

--- @function PICoolingDemand:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
PICoolingDemand.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function PICoolingDemand:new_value(...)
...
function PICoolingDemand:read(device)
...
function PICoolingDemand:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function PICoolingDemand:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(PICoolingDemand, {__call = PICoolingDemand.new_value})
