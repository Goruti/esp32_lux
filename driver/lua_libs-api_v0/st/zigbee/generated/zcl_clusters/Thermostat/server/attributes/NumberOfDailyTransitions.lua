...
--- @alias NumberOfDailyTransitions
---
--- @field public ID number 0x0022 the ID of this attribute
--- @field public NAME string "NumberOfDailyTransitions" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local NumberOfDailyTransitions = {
  ID = 0x0022,
  NAME = "NumberOfDailyTransitions",
  base_type = data_types.Uint8,
}

function NumberOfDailyTransitions:augment_type(base_type_obj)
...
function NumberOfDailyTransitions.pretty_print(value_obj)
  NumberOfDailyTransitions.base_type.pretty_print(value_obj)
end

--- @function NumberOfDailyTransitions:build_test_attr_report
---
...
NumberOfDailyTransitions.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfDailyTransitions:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfDailyTransitions.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfDailyTransitions:new_value(...)
...
function NumberOfDailyTransitions:read(device)
...
function NumberOfDailyTransitions:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NumberOfDailyTransitions:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NumberOfDailyTransitions, {__call = NumberOfDailyTransitions.new_value})
