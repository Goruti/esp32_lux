...
function OccupiedSetbackMin.pretty_print(value_obj)
  OccupiedSetbackMin.base_type.pretty_print(value_obj)
end

--- @function OccupiedSetbackMin:build_test_attr_report
---
...
OccupiedSetbackMin.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OccupiedSetbackMin:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OccupiedSetbackMin.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OccupiedSetbackMin:new_value(...)
...
function OccupiedSetbackMin:read(device)
...
function OccupiedSetbackMin:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OccupiedSetbackMin:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OccupiedSetbackMin, {__call = OccupiedSetbackMin.new_value})
