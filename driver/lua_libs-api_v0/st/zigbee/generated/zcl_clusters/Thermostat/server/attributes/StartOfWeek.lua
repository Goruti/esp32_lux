...
--- @field public NAME string "StartOfWeek" the name of this attribute
...
StartOfWeek.SUNDAY    = 0x00
StartOfWeek.MONDAY    = 0x01
StartOfWeek.TUESDAY   = 0x02
StartOfWeek.WEDNESDAY = 0x03
StartOfWeek.THURSDAY  = 0x04
StartOfWeek.FRIDAY    = 0x05
StartOfWeek.SUNDAY    = 0x06


StartOfWeek.enum_fields = {
    [StartOfWeek.SUNDAY]    = "SUNDAY",
    [StartOfWeek.MONDAY]    = "MONDAY",
    [StartOfWeek.TUESDAY]   = "TUESDAY",
    [StartOfWeek.WEDNESDAY] = "WEDNESDAY",
    [StartOfWeek.THURSDAY]  = "THURSDAY",
    [StartOfWeek.FRIDAY]    = "FRIDAY",
    [StartOfWeek.SUNDAY]    = "SUNDAY",
}
...
function StartOfWeek:augment_type(base_type_obj)
...
function StartOfWeek.pretty_print(value_obj)
  return string.format("%s: %s[%s]", value_obj.field_name or value_obj.NAME, StartOfWeek.NAME, StartOfWeek.enum_fields[value_obj.value])
end

--- @function StartOfWeek:build_test_attr_report
---
...
StartOfWeek.build_test_attr_report = cluster_base.build_test_attr_report

--- @function StartOfWeek:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Enum8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
StartOfWeek.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function StartOfWeek:new_value(...)
...
function StartOfWeek:read(device)
...
function StartOfWeek:configure_reporting(device, min_rep_int, max_rep_int)
...
function StartOfWeek:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(StartOfWeek, {__call = StartOfWeek.new_value})
return StartOfWeek
