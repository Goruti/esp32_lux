...
--- @field public NAME string "OutdoorTemperature" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local OutdoorTemperature = {
  ID = 0x0001,
  NAME = "OutdoorTemperature",
  base_type = data_types.Int16,
}

function OutdoorTemperature:augment_type(base_type_obj)
...
function OutdoorTemperature.pretty_print(value_obj)
  OutdoorTemperature.base_type.pretty_print(value_obj)
end

--- @function OutdoorTemperature:build_test_attr_report
---
...
OutdoorTemperature.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OutdoorTemperature:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OutdoorTemperature.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OutdoorTemperature:new_value(...)
...
function OutdoorTemperature:read(device)
...
function OutdoorTemperature:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OutdoorTemperature:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OutdoorTemperature, {__call = OutdoorTemperature.new_value})
