...
--- @field public NAME string "OccupiedHeatingSetpoint" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local OccupiedHeatingSetpoint = {
  ID = 0x0012,
  NAME = "OccupiedHeatingSetpoint",
  base_type = data_types.Int16,
}

function OccupiedHeatingSetpoint:augment_type(base_type_obj)
...
function OccupiedHeatingSetpoint.pretty_print(value_obj)
  OccupiedHeatingSetpoint.base_type.pretty_print(value_obj)
end

--- @function OccupiedHeatingSetpoint:build_test_attr_report
---
...
OccupiedHeatingSetpoint.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OccupiedHeatingSetpoint:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OccupiedHeatingSetpoint.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OccupiedHeatingSetpoint:new_value(...)
...
function OccupiedHeatingSetpoint:read(device)
...
function OccupiedHeatingSetpoint:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OccupiedHeatingSetpoint:write(device, value)
...
function OccupiedHeatingSetpoint:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OccupiedHeatingSetpoint, {__call = OccupiedHeatingSetpoint.new_value})
