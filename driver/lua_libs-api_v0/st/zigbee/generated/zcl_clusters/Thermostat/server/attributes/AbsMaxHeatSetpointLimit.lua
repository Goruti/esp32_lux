...
--- @field public NAME string "AbsMaxHeatSetpointLimit" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local AbsMaxHeatSetpointLimit = {
  ID = 0x0004,
  NAME = "AbsMaxHeatSetpointLimit",
  base_type = data_types.Int16,
}

function AbsMaxHeatSetpointLimit:augment_type(base_type_obj)
...
function AbsMaxHeatSetpointLimit.pretty_print(value_obj)
  AbsMaxHeatSetpointLimit.base_type.pretty_print(value_obj)
end

--- @function AbsMaxHeatSetpointLimit:build_test_attr_report
---
...
AbsMaxHeatSetpointLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AbsMaxHeatSetpointLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AbsMaxHeatSetpointLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AbsMaxHeatSetpointLimit:new_value(...)
...
function AbsMaxHeatSetpointLimit:read(device)
...
function AbsMaxHeatSetpointLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AbsMaxHeatSetpointLimit:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AbsMaxHeatSetpointLimit, {__call = AbsMaxHeatSetpointLimit.new_value})
