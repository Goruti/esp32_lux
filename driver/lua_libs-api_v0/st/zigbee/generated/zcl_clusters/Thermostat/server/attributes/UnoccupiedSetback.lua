...
function UnoccupiedSetback.pretty_print(value_obj)
  UnoccupiedSetback.base_type.pretty_print(value_obj)
end

--- @function UnoccupiedSetback:build_test_attr_report
---
...
UnoccupiedSetback.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UnoccupiedSetback:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UnoccupiedSetback.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UnoccupiedSetback:new_value(...)
...
function UnoccupiedSetback:read(device)
...
function UnoccupiedSetback:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function UnoccupiedSetback:write(device, value)
...
function UnoccupiedSetback:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(UnoccupiedSetback, {__call = UnoccupiedSetback.new_value})
