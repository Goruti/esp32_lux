...
function EmergencyHeatDelta.pretty_print(value_obj)
  EmergencyHeatDelta.base_type.pretty_print(value_obj)
end

--- @function EmergencyHeatDelta:build_test_attr_report
---
...
EmergencyHeatDelta.build_test_attr_report = cluster_base.build_test_attr_report

--- @function EmergencyHeatDelta:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
EmergencyHeatDelta.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function EmergencyHeatDelta:new_value(...)
...
function EmergencyHeatDelta:read(device)
...
function EmergencyHeatDelta:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function EmergencyHeatDelta:write(device, value)
...
function EmergencyHeatDelta:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(EmergencyHeatDelta, {__call = EmergencyHeatDelta.new_value})
