...
function ACCoilTemperature.pretty_print(value_obj)
  ACCoilTemperature.base_type.pretty_print(value_obj)
end

--- @function ACCoilTemperature:build_test_attr_report
---
...
ACCoilTemperature.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACCoilTemperature:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACCoilTemperature.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACCoilTemperature:new_value(...)
...
function ACCoilTemperature:read(device)
...
function ACCoilTemperature:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ACCoilTemperature:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACCoilTemperature, {__call = ACCoilTemperature.new_value})
