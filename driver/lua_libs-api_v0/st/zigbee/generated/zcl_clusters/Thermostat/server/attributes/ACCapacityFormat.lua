...
function ACCapacityFormat.pretty_print(value_obj)
  return string.format("%s: %s[%s]", value_obj.field_name or value_obj.NAME, ACCapacityFormat.NAME, ACCapacityFormat.enum_fields[value_obj.value])
end

--- @function ACCapacityFormat:build_test_attr_report
---
...
ACCapacityFormat.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ACCapacityFormat:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Enum8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ACCapacityFormat.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ACCapacityFormat:new_value(...)
...
function ACCapacityFormat:read(device)
...
function ACCapacityFormat:configure_reporting(device, min_rep_int, max_rep_int)
...
function ACCapacityFormat:write(device, value)
...
function ACCapacityFormat:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ACCapacityFormat, {__call = ACCapacityFormat.new_value})
