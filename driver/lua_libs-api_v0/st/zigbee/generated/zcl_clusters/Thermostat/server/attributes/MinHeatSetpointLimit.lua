...
function MinHeatSetpointLimit.pretty_print(value_obj)
  MinHeatSetpointLimit.base_type.pretty_print(value_obj)
end

--- @function MinHeatSetpointLimit:build_test_attr_report
---
...
MinHeatSetpointLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MinHeatSetpointLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MinHeatSetpointLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function MinHeatSetpointLimit:new_value(...)
...
function MinHeatSetpointLimit:read(device)
...
function MinHeatSetpointLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MinHeatSetpointLimit:write(device, value)
...
function MinHeatSetpointLimit:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MinHeatSetpointLimit, {__call = MinHeatSetpointLimit.new_value})
