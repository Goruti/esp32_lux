...
--- @field public NAME string "AbsMinCoolSetpointLimit" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local AbsMinCoolSetpointLimit = {
  ID = 0x0005,
  NAME = "AbsMinCoolSetpointLimit",
  base_type = data_types.Int16,
}

function AbsMinCoolSetpointLimit:augment_type(base_type_obj)
...
function AbsMinCoolSetpointLimit.pretty_print(value_obj)
  AbsMinCoolSetpointLimit.base_type.pretty_print(value_obj)
end

--- @function AbsMinCoolSetpointLimit:build_test_attr_report
---
...
AbsMinCoolSetpointLimit.build_test_attr_report = cluster_base.build_test_attr_report

--- @function AbsMinCoolSetpointLimit:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
AbsMinCoolSetpointLimit.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function AbsMinCoolSetpointLimit:new_value(...)
...
function AbsMinCoolSetpointLimit:read(device)
...
function AbsMinCoolSetpointLimit:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function AbsMinCoolSetpointLimit:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(AbsMinCoolSetpointLimit, {__call = AbsMinCoolSetpointLimit.new_value})
