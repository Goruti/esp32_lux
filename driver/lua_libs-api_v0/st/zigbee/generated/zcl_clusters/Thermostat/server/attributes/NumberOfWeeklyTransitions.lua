...
--- @alias NumberOfWeeklyTransitions
---
--- @field public ID number 0x0021 the ID of this attribute
--- @field public NAME string "NumberOfWeeklyTransitions" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint8 the data type of this attribute
local NumberOfWeeklyTransitions = {
  ID = 0x0021,
  NAME = "NumberOfWeeklyTransitions",
  base_type = data_types.Uint8,
}

function NumberOfWeeklyTransitions:augment_type(base_type_obj)
...
function NumberOfWeeklyTransitions.pretty_print(value_obj)
  NumberOfWeeklyTransitions.base_type.pretty_print(value_obj)
end

--- @function NumberOfWeeklyTransitions:build_test_attr_report
---
...
NumberOfWeeklyTransitions.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfWeeklyTransitions:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfWeeklyTransitions.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfWeeklyTransitions:new_value(...)
...
function NumberOfWeeklyTransitions:read(device)
...
function NumberOfWeeklyTransitions:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NumberOfWeeklyTransitions:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NumberOfWeeklyTransitions, {__call = NumberOfWeeklyTransitions.new_value})
