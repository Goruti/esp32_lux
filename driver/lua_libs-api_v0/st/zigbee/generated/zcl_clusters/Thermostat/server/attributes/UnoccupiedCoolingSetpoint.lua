...
function UnoccupiedCoolingSetpoint:augment_type(base_type_obj)
...
function UnoccupiedCoolingSetpoint.pretty_print(value_obj)
  UnoccupiedCoolingSetpoint.base_type.pretty_print(value_obj)
end

--- @function UnoccupiedCoolingSetpoint:build_test_attr_report
---
...
UnoccupiedCoolingSetpoint.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UnoccupiedCoolingSetpoint:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UnoccupiedCoolingSetpoint.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UnoccupiedCoolingSetpoint:read(device)
...
function UnoccupiedCoolingSetpoint:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function UnoccupiedCoolingSetpoint:write(device, value)
