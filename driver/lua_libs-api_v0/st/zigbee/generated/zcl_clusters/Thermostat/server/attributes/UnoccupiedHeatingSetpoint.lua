...
--- @alias UnoccupiedHeatingSetpoint
---
--- @field public ID number 0x0014 the ID of this attribute
--- @field public NAME string "UnoccupiedHeatingSetpoint" the name of this attribute
--- @field public data_type st.zigbee.data_types.Int16 the data type of this attribute
local UnoccupiedHeatingSetpoint = {
  ID = 0x0014,
  NAME = "UnoccupiedHeatingSetpoint",
  base_type = data_types.Int16,
}

function UnoccupiedHeatingSetpoint:augment_type(base_type_obj)
...
function UnoccupiedHeatingSetpoint.pretty_print(value_obj)
  UnoccupiedHeatingSetpoint.base_type.pretty_print(value_obj)
end

--- @function UnoccupiedHeatingSetpoint:build_test_attr_report
---
...
UnoccupiedHeatingSetpoint.build_test_attr_report = cluster_base.build_test_attr_report

--- @function UnoccupiedHeatingSetpoint:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
UnoccupiedHeatingSetpoint.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function UnoccupiedHeatingSetpoint:new_value(...)
...
function UnoccupiedHeatingSetpoint:read(device)
...
function UnoccupiedHeatingSetpoint:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function UnoccupiedHeatingSetpoint:write(device, value)
...
function UnoccupiedHeatingSetpoint:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(UnoccupiedHeatingSetpoint, {__call = UnoccupiedHeatingSetpoint.new_value})
