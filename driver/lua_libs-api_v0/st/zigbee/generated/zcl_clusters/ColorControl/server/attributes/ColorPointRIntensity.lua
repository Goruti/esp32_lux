...
function ColorPointRIntensity.pretty_print(value_obj)
  ColorPointRIntensity.base_type.pretty_print(value_obj)
end

--- @function ColorPointRIntensity:build_test_attr_report
---
...
ColorPointRIntensity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorPointRIntensity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorPointRIntensity.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorPointRIntensity:new_value(...)
...
function ColorPointRIntensity:read(device)
...
function ColorPointRIntensity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorPointRIntensity:write(device, value)
...
function ColorPointRIntensity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorPointRIntensity, {__call = ColorPointRIntensity.new_value})
