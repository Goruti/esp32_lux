...
function Primary4X:augment_type(base_type_obj)
...
function Primary4X.pretty_print(value_obj)
  Primary4X.base_type.pretty_print(value_obj)
end

--- @function Primary4X:build_test_attr_report
---
...
Primary4X.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Primary4X:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Primary4X.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Primary4X:read(device)
...
function Primary4X:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
setmetatable(Primary4X, {__call = Primary4X.new_value})
return Primary4X
