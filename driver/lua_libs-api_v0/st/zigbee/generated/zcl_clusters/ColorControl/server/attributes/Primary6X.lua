...
--- @field public NAME string "Primary6X" the name of this attribute
...
function Primary6X:augment_type(base_type_obj)
...
function Primary6X.pretty_print(value_obj)
  Primary6X.base_type.pretty_print(value_obj)
end

--- @function Primary6X:build_test_attr_report
---
...
Primary6X.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Primary6X:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Primary6X.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Primary6X:read(device)
...
function Primary6X:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Primary6X:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Primary6X, {__call = Primary6X.new_value})
return Primary6X
