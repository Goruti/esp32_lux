...
--- @field public NAME string "Primary2X" the name of this attribute
...
function Primary2X:augment_type(base_type_obj)
...
function Primary2X.pretty_print(value_obj)
  Primary2X.base_type.pretty_print(value_obj)
end

--- @function Primary2X:build_test_attr_report
---
...
Primary2X.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Primary2X:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Primary2X.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Primary2X:read(device)
...
function Primary2X:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Primary2X:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Primary2X, {__call = Primary2X.new_value})
return Primary2X
