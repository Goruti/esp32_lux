...
function NumberOfPrimaries.pretty_print(value_obj)
  NumberOfPrimaries.base_type.pretty_print(value_obj)
end

--- @function NumberOfPrimaries:build_test_attr_report
---
...
NumberOfPrimaries.build_test_attr_report = cluster_base.build_test_attr_report

--- @function NumberOfPrimaries:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
NumberOfPrimaries.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function NumberOfPrimaries:new_value(...)
...
function NumberOfPrimaries:read(device)
...
function NumberOfPrimaries:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function NumberOfPrimaries:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(NumberOfPrimaries, {__call = NumberOfPrimaries.new_value})
