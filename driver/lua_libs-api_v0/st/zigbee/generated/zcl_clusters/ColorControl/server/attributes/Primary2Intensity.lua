...
function Primary2Intensity.pretty_print(value_obj)
  Primary2Intensity.base_type.pretty_print(value_obj)
end

--- @function Primary2Intensity:build_test_attr_report
---
...
Primary2Intensity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Primary2Intensity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Primary2Intensity.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Primary2Intensity:new_value(...)
...
function Primary2Intensity:read(device)
...
function Primary2Intensity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Primary2Intensity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Primary2Intensity, {__call = Primary2Intensity.new_value})
