...
--- @alias ColorLoopTime
---
--- @field public ID number 0x4004 the ID of this attribute
--- @field public NAME string "ColorLoopTime" the name of this attribute
...
function ColorLoopTime:augment_type(base_type_obj)
...
function ColorLoopTime.pretty_print(value_obj)
  ColorLoopTime.base_type.pretty_print(value_obj)
end

--- @function ColorLoopTime:build_test_attr_report
---
...
ColorLoopTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorLoopTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorLoopTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorLoopTime:new_value(...)
...
function ColorLoopTime:read(device)
...
function ColorLoopTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorLoopTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorLoopTime, {__call = ColorLoopTime.new_value})
