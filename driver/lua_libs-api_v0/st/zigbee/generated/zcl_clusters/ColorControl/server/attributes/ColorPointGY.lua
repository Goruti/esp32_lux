...
--- @field public NAME string "ColorPointGY" the name of this attribute
...
function ColorPointGY:augment_type(base_type_obj)
...
function ColorPointGY.pretty_print(value_obj)
  ColorPointGY.base_type.pretty_print(value_obj)
end

--- @function ColorPointGY:build_test_attr_report
---
...
ColorPointGY.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorPointGY:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorPointGY.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorPointGY:new_value(...)
...
function ColorPointGY:read(device)
...
function ColorPointGY:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorPointGY:write(device, value)
...
function ColorPointGY:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorPointGY, {__call = ColorPointGY.new_value})
return ColorPointGY
