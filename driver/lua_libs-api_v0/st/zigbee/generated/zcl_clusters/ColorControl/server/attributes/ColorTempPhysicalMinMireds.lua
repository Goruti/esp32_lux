...
--- @alias ColorTempPhysicalMinMireds
---
--- @field public ID number 0x400B the ID of this attribute
--- @field public NAME string "ColorTempPhysicalMinMireds" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ColorTempPhysicalMinMireds = {
  ID = 0x400B,
  NAME = "ColorTempPhysicalMinMireds",
  base_type = data_types.Uint16,
}

function ColorTempPhysicalMinMireds:augment_type(base_type_obj)
...
function ColorTempPhysicalMinMireds.pretty_print(value_obj)
  ColorTempPhysicalMinMireds.base_type.pretty_print(value_obj)
end

--- @function ColorTempPhysicalMinMireds:build_test_attr_report
---
...
ColorTempPhysicalMinMireds.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorTempPhysicalMinMireds:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorTempPhysicalMinMireds.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorTempPhysicalMinMireds:new_value(...)
...
function ColorTempPhysicalMinMireds:read(device)
...
function ColorTempPhysicalMinMireds:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorTempPhysicalMinMireds:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorTempPhysicalMinMireds, {__call = ColorTempPhysicalMinMireds.new_value})
