...
--- @alias CoupleColorTempToLevelMinMireds
---
--- @field public ID number 0x400D the ID of this attribute
--- @field public NAME string "CoupleColorTempToLevelMinMireds" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local CoupleColorTempToLevelMinMireds = {
  ID = 0x400D,
  NAME = "CoupleColorTempToLevelMinMireds",
  base_type = data_types.Uint16,
}

function CoupleColorTempToLevelMinMireds:augment_type(base_type_obj)
...
function CoupleColorTempToLevelMinMireds.pretty_print(value_obj)
  CoupleColorTempToLevelMinMireds.base_type.pretty_print(value_obj)
end

--- @function CoupleColorTempToLevelMinMireds:build_test_attr_report
---
...
CoupleColorTempToLevelMinMireds.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CoupleColorTempToLevelMinMireds:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CoupleColorTempToLevelMinMireds.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CoupleColorTempToLevelMinMireds:new_value(...)
...
function CoupleColorTempToLevelMinMireds:read(device)
...
function CoupleColorTempToLevelMinMireds:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CoupleColorTempToLevelMinMireds:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CoupleColorTempToLevelMinMireds, {__call = CoupleColorTempToLevelMinMireds.new_value})
