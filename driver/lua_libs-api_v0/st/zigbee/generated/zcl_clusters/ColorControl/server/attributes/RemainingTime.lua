...
--- @field public NAME string "RemainingTime" the name of this attribute
...
function RemainingTime:augment_type(base_type_obj)
...
function RemainingTime.pretty_print(value_obj)
  RemainingTime.base_type.pretty_print(value_obj)
end

--- @function RemainingTime:build_test_attr_report
---
...
RemainingTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function RemainingTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
RemainingTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function RemainingTime:new_value(...)
...
function RemainingTime:read(device)
...
function RemainingTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function RemainingTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(RemainingTime, {__call = RemainingTime.new_value})
