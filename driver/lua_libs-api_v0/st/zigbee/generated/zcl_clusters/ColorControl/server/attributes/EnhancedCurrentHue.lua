...
function EnhancedCurrentHue.pretty_print(value_obj)
  EnhancedCurrentHue.base_type.pretty_print(value_obj)
end

--- @function EnhancedCurrentHue:build_test_attr_report
---
...
EnhancedCurrentHue.build_test_attr_report = cluster_base.build_test_attr_report

--- @function EnhancedCurrentHue:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
EnhancedCurrentHue.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function EnhancedCurrentHue:new_value(...)
...
function EnhancedCurrentHue:read(device)
...
function EnhancedCurrentHue:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function EnhancedCurrentHue:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(EnhancedCurrentHue, {__call = EnhancedCurrentHue.new_value})
