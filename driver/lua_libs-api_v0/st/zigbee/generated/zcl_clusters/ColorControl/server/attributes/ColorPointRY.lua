...
--- @field public NAME string "ColorPointRY" the name of this attribute
...
function ColorPointRY:augment_type(base_type_obj)
...
function ColorPointRY.pretty_print(value_obj)
  ColorPointRY.base_type.pretty_print(value_obj)
end

--- @function ColorPointRY:build_test_attr_report
---
...
ColorPointRY.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorPointRY:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorPointRY.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorPointRY:new_value(...)
...
function ColorPointRY:read(device)
...
function ColorPointRY:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorPointRY:write(device, value)
...
function ColorPointRY:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorPointRY, {__call = ColorPointRY.new_value})
return ColorPointRY
