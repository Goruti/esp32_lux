...
function CurrentSaturation.pretty_print(value_obj)
  CurrentSaturation.base_type.pretty_print(value_obj)
end

--- @function CurrentSaturation:build_test_attr_report
---
...
CurrentSaturation.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentSaturation:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentSaturation.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentSaturation:new_value(...)
...
function CurrentSaturation:read(device)
...
function CurrentSaturation:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentSaturation:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentSaturation, {__call = CurrentSaturation.new_value})
