...
--- @alias ColorTempPhysicalMaxMireds
---
--- @field public ID number 0x400C the ID of this attribute
--- @field public NAME string "ColorTempPhysicalMaxMireds" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ColorTempPhysicalMaxMireds = {
  ID = 0x400C,
  NAME = "ColorTempPhysicalMaxMireds",
  base_type = data_types.Uint16,
}

function ColorTempPhysicalMaxMireds:augment_type(base_type_obj)
...
function ColorTempPhysicalMaxMireds.pretty_print(value_obj)
  ColorTempPhysicalMaxMireds.base_type.pretty_print(value_obj)
end

--- @function ColorTempPhysicalMaxMireds:build_test_attr_report
---
...
ColorTempPhysicalMaxMireds.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorTempPhysicalMaxMireds:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorTempPhysicalMaxMireds.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorTempPhysicalMaxMireds:new_value(...)
...
function ColorTempPhysicalMaxMireds:read(device)
...
function ColorTempPhysicalMaxMireds:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorTempPhysicalMaxMireds:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorTempPhysicalMaxMireds, {__call = ColorTempPhysicalMaxMireds.new_value})
