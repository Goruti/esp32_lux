...
--- @field public NAME string "CurrentX" the name of this attribute
...
function CurrentX:augment_type(base_type_obj)
...
function CurrentX.pretty_print(value_obj)
  CurrentX.base_type.pretty_print(value_obj)
end

--- @function CurrentX:build_test_attr_report
---
...
CurrentX.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentX:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentX.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentX:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentX:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentX, {__call = CurrentX.new_value})
return CurrentX
