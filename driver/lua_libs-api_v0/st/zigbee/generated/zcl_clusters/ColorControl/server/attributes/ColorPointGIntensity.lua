...
function ColorPointGIntensity.pretty_print(value_obj)
  ColorPointGIntensity.base_type.pretty_print(value_obj)
end

--- @function ColorPointGIntensity:build_test_attr_report
---
...
ColorPointGIntensity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorPointGIntensity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorPointGIntensity.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorPointGIntensity:new_value(...)
...
function ColorPointGIntensity:read(device)
...
function ColorPointGIntensity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorPointGIntensity:write(device, value)
...
function ColorPointGIntensity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorPointGIntensity, {__call = ColorPointGIntensity.new_value})
