...
--- @field public NAME string "Primary4Y" the name of this attribute
...
function Primary4Y:augment_type(base_type_obj)
...
function Primary4Y.pretty_print(value_obj)
  Primary4Y.base_type.pretty_print(value_obj)
end

--- @function Primary4Y:build_test_attr_report
---
...
Primary4Y.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Primary4Y:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Primary4Y.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Primary4Y:read(device)
...
function Primary4Y:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Primary4Y:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Primary4Y, {__call = Primary4Y.new_value})
return Primary4Y
