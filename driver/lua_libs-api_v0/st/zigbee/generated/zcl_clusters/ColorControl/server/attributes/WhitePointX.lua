...
--- @field public NAME string "WhitePointX" the name of this attribute
...
function WhitePointX:augment_type(base_type_obj)
...
function WhitePointX.pretty_print(value_obj)
  WhitePointX.base_type.pretty_print(value_obj)
end

--- @function WhitePointX:build_test_attr_report
---
...
WhitePointX.build_test_attr_report = cluster_base.build_test_attr_report

--- @function WhitePointX:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
WhitePointX.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function WhitePointX:new_value(...)
...
function WhitePointX:read(device)
...
function WhitePointX:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function WhitePointX:write(device, value)
...
function WhitePointX:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(WhitePointX, {__call = WhitePointX.new_value})
return WhitePointX
