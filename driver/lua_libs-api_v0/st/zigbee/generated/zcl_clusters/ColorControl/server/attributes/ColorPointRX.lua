...
--- @field public NAME string "ColorPointRX" the name of this attribute
...
function ColorPointRX:augment_type(base_type_obj)
...
function ColorPointRX.pretty_print(value_obj)
  ColorPointRX.base_type.pretty_print(value_obj)
end

--- @function ColorPointRX:build_test_attr_report
---
...
ColorPointRX.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorPointRX:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorPointRX.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorPointRX:new_value(...)
...
function ColorPointRX:read(device)
...
function ColorPointRX:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorPointRX:write(device, value)
...
function ColorPointRX:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorPointRX, {__call = ColorPointRX.new_value})
return ColorPointRX
