...
--- @field public NAME string "Primary1X" the name of this attribute
...
function Primary1X:augment_type(base_type_obj)
...
function Primary1X.pretty_print(value_obj)
  Primary1X.base_type.pretty_print(value_obj)
end

--- @function Primary1X:build_test_attr_report
---
...
Primary1X.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Primary1X:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Primary1X.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Primary1X:read(device)
...
function Primary1X:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Primary1X:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Primary1X, {__call = Primary1X.new_value})
return Primary1X
