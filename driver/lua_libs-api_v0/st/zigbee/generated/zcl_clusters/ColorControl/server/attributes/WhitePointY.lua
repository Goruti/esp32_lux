...
--- @field public NAME string "WhitePointY" the name of this attribute
...
function WhitePointY:augment_type(base_type_obj)
...
function WhitePointY.pretty_print(value_obj)
  WhitePointY.base_type.pretty_print(value_obj)
end

--- @function WhitePointY:build_test_attr_report
---
...
WhitePointY.build_test_attr_report = cluster_base.build_test_attr_report

--- @function WhitePointY:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
WhitePointY.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function WhitePointY:new_value(...)
...
function WhitePointY:read(device)
...
function WhitePointY:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function WhitePointY:write(device, value)
...
function WhitePointY:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(WhitePointY, {__call = WhitePointY.new_value})
return WhitePointY
