...
function Primary4Intensity.pretty_print(value_obj)
  Primary4Intensity.base_type.pretty_print(value_obj)
end

--- @function Primary4Intensity:build_test_attr_report
---
...
Primary4Intensity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Primary4Intensity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Primary4Intensity.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Primary4Intensity:new_value(...)
...
function Primary4Intensity:read(device)
...
function Primary4Intensity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Primary4Intensity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Primary4Intensity, {__call = Primary4Intensity.new_value})
