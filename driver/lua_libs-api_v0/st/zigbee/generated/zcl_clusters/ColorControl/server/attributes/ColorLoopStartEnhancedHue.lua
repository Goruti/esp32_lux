...
--- @alias ColorLoopStartEnhancedHue
---
--- @field public ID number 0x4005 the ID of this attribute
--- @field public NAME string "ColorLoopStartEnhancedHue" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ColorLoopStartEnhancedHue = {
  ID = 0x4005,
  NAME = "ColorLoopStartEnhancedHue",
  base_type = data_types.Uint16,
}

function ColorLoopStartEnhancedHue:augment_type(base_type_obj)
...
function ColorLoopStartEnhancedHue.pretty_print(value_obj)
  ColorLoopStartEnhancedHue.base_type.pretty_print(value_obj)
end

--- @function ColorLoopStartEnhancedHue:build_test_attr_report
---
...
ColorLoopStartEnhancedHue.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorLoopStartEnhancedHue:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorLoopStartEnhancedHue.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorLoopStartEnhancedHue:new_value(...)
...
function ColorLoopStartEnhancedHue:read(device)
...
function ColorLoopStartEnhancedHue:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorLoopStartEnhancedHue:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorLoopStartEnhancedHue, {__call = ColorLoopStartEnhancedHue.new_value})
