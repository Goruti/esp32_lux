...
--- @field public NAME string "CurrentHue" the name of this attribute
...
function CurrentHue:augment_type(base_type_obj)
...
function CurrentHue.pretty_print(value_obj)
  CurrentHue.base_type.pretty_print(value_obj)
end

--- @function CurrentHue:build_test_attr_report
---
...
CurrentHue.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentHue:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentHue.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentHue:read(device)
...
function CurrentHue:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentHue:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentHue, {__call = CurrentHue.new_value})
return CurrentHue
