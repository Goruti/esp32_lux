...
function Primary3Intensity.pretty_print(value_obj)
  Primary3Intensity.base_type.pretty_print(value_obj)
end

--- @function Primary3Intensity:build_test_attr_report
---
...
Primary3Intensity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Primary3Intensity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Primary3Intensity.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Primary3Intensity:new_value(...)
...
function Primary3Intensity:read(device)
...
function Primary3Intensity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function Primary3Intensity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Primary3Intensity, {__call = Primary3Intensity.new_value})
