...
--- @alias ColorLoopStoredEnhancedHue
---
--- @field public ID number 0x4006 the ID of this attribute
--- @field public NAME string "ColorLoopStoredEnhancedHue" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ColorLoopStoredEnhancedHue = {
  ID = 0x4006,
  NAME = "ColorLoopStoredEnhancedHue",
  base_type = data_types.Uint16,
}

function ColorLoopStoredEnhancedHue:augment_type(base_type_obj)
...
function ColorLoopStoredEnhancedHue.pretty_print(value_obj)
  ColorLoopStoredEnhancedHue.base_type.pretty_print(value_obj)
end

--- @function ColorLoopStoredEnhancedHue:build_test_attr_report
---
...
ColorLoopStoredEnhancedHue.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorLoopStoredEnhancedHue:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorLoopStoredEnhancedHue.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorLoopStoredEnhancedHue:new_value(...)
...
function ColorLoopStoredEnhancedHue:read(device)
...
function ColorLoopStoredEnhancedHue:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorLoopStoredEnhancedHue:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorLoopStoredEnhancedHue, {__call = ColorLoopStoredEnhancedHue.new_value})
