...
function ColorPointBIntensity.pretty_print(value_obj)
  ColorPointBIntensity.base_type.pretty_print(value_obj)
end

--- @function ColorPointBIntensity:build_test_attr_report
---
...
ColorPointBIntensity.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorPointBIntensity:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorPointBIntensity.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorPointBIntensity:new_value(...)
...
function ColorPointBIntensity:read(device)
...
function ColorPointBIntensity:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorPointBIntensity:write(device, value)
...
function ColorPointBIntensity:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorPointBIntensity, {__call = ColorPointBIntensity.new_value})
