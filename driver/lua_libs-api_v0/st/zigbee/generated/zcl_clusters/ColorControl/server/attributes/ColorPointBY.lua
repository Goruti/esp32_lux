...
--- @field public NAME string "ColorPointBY" the name of this attribute
...
function ColorPointBY:augment_type(base_type_obj)
...
function ColorPointBY.pretty_print(value_obj)
  ColorPointBY.base_type.pretty_print(value_obj)
end

--- @function ColorPointBY:build_test_attr_report
---
...
ColorPointBY.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorPointBY:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorPointBY.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorPointBY:new_value(...)
...
function ColorPointBY:read(device)
...
function ColorPointBY:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorPointBY:write(device, value)
...
function ColorPointBY:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorPointBY, {__call = ColorPointBY.new_value})
return ColorPointBY
