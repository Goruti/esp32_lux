...
--- @field public NAME string "CurrentY" the name of this attribute
...
function CurrentY:augment_type(base_type_obj)
...
function CurrentY.pretty_print(value_obj)
  CurrentY.base_type.pretty_print(value_obj)
end

--- @function CurrentY:build_test_attr_report
---
...
CurrentY.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentY:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentY.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentY:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentY:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentY, {__call = CurrentY.new_value})
return CurrentY
