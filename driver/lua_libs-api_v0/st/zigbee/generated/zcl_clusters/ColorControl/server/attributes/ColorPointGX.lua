...
--- @field public NAME string "ColorPointGX" the name of this attribute
...
function ColorPointGX:augment_type(base_type_obj)
...
function ColorPointGX.pretty_print(value_obj)
  ColorPointGX.base_type.pretty_print(value_obj)
end

--- @function ColorPointGX:build_test_attr_report
---
...
ColorPointGX.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorPointGX:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorPointGX.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorPointGX:new_value(...)
...
function ColorPointGX:read(device)
...
function ColorPointGX:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorPointGX:write(device, value)
...
function ColorPointGX:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorPointGX, {__call = ColorPointGX.new_value})
return ColorPointGX
