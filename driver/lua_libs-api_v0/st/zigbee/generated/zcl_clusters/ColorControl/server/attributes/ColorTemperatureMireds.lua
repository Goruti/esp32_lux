...
--- @alias ColorTemperatureMireds
---
--- @field public ID number 0x0007 the ID of this attribute
--- @field public NAME string "ColorTemperatureMireds" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local ColorTemperatureMireds = {
  ID = 0x0007,
  NAME = "ColorTemperatureMireds",
  base_type = data_types.Uint16,
}

function ColorTemperatureMireds:augment_type(base_type_obj)
...
function ColorTemperatureMireds.pretty_print(value_obj)
  ColorTemperatureMireds.base_type.pretty_print(value_obj)
end

--- @function ColorTemperatureMireds:build_test_attr_report
---
...
ColorTemperatureMireds.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorTemperatureMireds:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorTemperatureMireds.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorTemperatureMireds:new_value(...)
...
function ColorTemperatureMireds:read(device)
...
function ColorTemperatureMireds:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorTemperatureMireds:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorTemperatureMireds, {__call = ColorTemperatureMireds.new_value})
