...
--- @field public NAME string "ColorPointBX" the name of this attribute
...
function ColorPointBX:augment_type(base_type_obj)
...
function ColorPointBX.pretty_print(value_obj)
  ColorPointBX.base_type.pretty_print(value_obj)
end

--- @function ColorPointBX:build_test_attr_report
---
...
ColorPointBX.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ColorPointBX:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ColorPointBX.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ColorPointBX:new_value(...)
...
function ColorPointBX:read(device)
...
function ColorPointBX:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ColorPointBX:write(device, value)
...
function ColorPointBX:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ColorPointBX, {__call = ColorPointBX.new_value})
return ColorPointBX
