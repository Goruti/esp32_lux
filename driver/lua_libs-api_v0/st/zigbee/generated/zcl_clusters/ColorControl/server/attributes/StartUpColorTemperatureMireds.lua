...
--- @alias StartUpColorTemperatureMireds
---
--- @field public ID number 0x4010 the ID of this attribute
--- @field public NAME string "StartUpColorTemperatureMireds" the name of this attribute
--- @field public data_type st.zigbee.data_types.Uint16 the data type of this attribute
local StartUpColorTemperatureMireds = {
  ID = 0x4010,
  NAME = "StartUpColorTemperatureMireds",
  base_type = data_types.Uint16,
}

function StartUpColorTemperatureMireds:augment_type(base_type_obj)
...
function StartUpColorTemperatureMireds.pretty_print(value_obj)
  StartUpColorTemperatureMireds.base_type.pretty_print(value_obj)
end

--- @function StartUpColorTemperatureMireds:build_test_attr_report
---
...
StartUpColorTemperatureMireds.build_test_attr_report = cluster_base.build_test_attr_report

--- @function StartUpColorTemperatureMireds:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
StartUpColorTemperatureMireds.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function StartUpColorTemperatureMireds:new_value(...)
...
function StartUpColorTemperatureMireds:read(device)
...
function StartUpColorTemperatureMireds:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function StartUpColorTemperatureMireds:write(device, value)
...
function StartUpColorTemperatureMireds:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(StartUpColorTemperatureMireds, {__call = StartUpColorTemperatureMireds.new_value})
