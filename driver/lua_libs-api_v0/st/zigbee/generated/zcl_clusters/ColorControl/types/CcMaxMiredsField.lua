...
---
local CcMaxMiredsField = {}
local new_mt = UintABC.new_mt({NAME = "CcMaxMiredsField", ID = data_types.name_to_id_map["Uint16"]}, 2)
setmetatable(CcMaxMiredsField, new_mt)
return CcMaxMiredsField
