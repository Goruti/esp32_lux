...
--- @field public NAME string "TimeZone" the name of this attribute
...
function TimeZone:augment_type(base_type_obj)
...
function TimeZone.pretty_print(value_obj)
  TimeZone.base_type.pretty_print(value_obj)
end

--- @function TimeZone:build_test_attr_report
---
...
TimeZone.build_test_attr_report = cluster_base.build_test_attr_report

--- @function TimeZone:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
TimeZone.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function TimeZone:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
---
--- @param device st.zigbee.Device
--- @param value st.zigbee.data_types.Int32 the value to write
function TimeZone:write(device, value)
...
function TimeZone:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(TimeZone, {__call = TimeZone.new_value})
return TimeZone
