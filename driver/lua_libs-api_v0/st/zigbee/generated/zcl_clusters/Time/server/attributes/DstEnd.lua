...
--- @field public NAME string "DstEnd" the name of this attribute
...
function DstEnd:augment_type(base_type_obj)
...
function DstEnd.pretty_print(value_obj)
  DstEnd.base_type.pretty_print(value_obj)
end

--- @function DstEnd:build_test_attr_report
---
...
DstEnd.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DstEnd:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DstEnd.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DstEnd:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DstEnd:write(device, value)
...
function DstEnd:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DstEnd, {__call = DstEnd.new_value})
return DstEnd
