...
--- @field public NAME string "DstStart" the name of this attribute
...
function DstStart:augment_type(base_type_obj)
...
function DstStart.pretty_print(value_obj)
  DstStart.base_type.pretty_print(value_obj)
end

--- @function DstStart:build_test_attr_report
---
...
DstStart.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DstStart:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DstStart.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DstStart:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DstStart:write(device, value)
...
function DstStart:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DstStart, {__call = DstStart.new_value})
return DstStart
