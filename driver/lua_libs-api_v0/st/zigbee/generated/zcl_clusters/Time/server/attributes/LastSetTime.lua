...
--- @field public NAME string "LastSetTime" the name of this attribute
...
function LastSetTime:augment_type(base_type_obj)
...
function LastSetTime.pretty_print(value_obj)
  LastSetTime.base_type.pretty_print(value_obj)
end

--- @function LastSetTime:build_test_attr_report
---
...
LastSetTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LastSetTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.UtcTime the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LastSetTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LastSetTime:new_value(...)
...
function LastSetTime:read(device)
...
function LastSetTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LastSetTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LastSetTime, {__call = LastSetTime.new_value})
return LastSetTime
