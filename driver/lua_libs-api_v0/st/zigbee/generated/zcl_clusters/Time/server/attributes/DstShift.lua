...
--- @field public NAME string "DstShift" the name of this attribute
...
function DstShift:augment_type(base_type_obj)
...
function DstShift.pretty_print(value_obj)
  DstShift.base_type.pretty_print(value_obj)
end

--- @function DstShift:build_test_attr_report
---
...
DstShift.build_test_attr_report = cluster_base.build_test_attr_report

--- @function DstShift:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Int32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
DstShift.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function DstShift:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function DstShift:write(device, value)
...
function DstShift:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(DstShift, {__call = DstShift.new_value})
return DstShift
