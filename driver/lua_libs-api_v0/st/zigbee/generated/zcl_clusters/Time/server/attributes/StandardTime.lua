...
--- @field public NAME string "StandardTime" the name of this attribute
...
function StandardTime:augment_type(base_type_obj)
...
function StandardTime.pretty_print(value_obj)
  StandardTime.base_type.pretty_print(value_obj)
end

--- @function StandardTime:build_test_attr_report
---
...
StandardTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function StandardTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
StandardTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function StandardTime:new_value(...)
...
function StandardTime:read(device)
...
function StandardTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function StandardTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(StandardTime, {__call = StandardTime.new_value})
return StandardTime
