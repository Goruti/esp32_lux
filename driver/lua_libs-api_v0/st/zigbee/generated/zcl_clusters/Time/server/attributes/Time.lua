...
--- @field public NAME string "Time" the name of this attribute
...
function Time:augment_type(base_type_obj)
...
function Time.pretty_print(value_obj)
  Time.base_type.pretty_print(value_obj)
end

--- @function Time:build_test_attr_report
---
...
Time.build_test_attr_report = cluster_base.build_test_attr_report

--- @function Time:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.UtcTime the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
Time.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function Time:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
---
--- @param device st.zigbee.Device
--- @param value st.zigbee.data_types.UtcTime the value to write
function Time:write(device, value)
...
function Time:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(Time, {__call = Time.new_value})
return Time
