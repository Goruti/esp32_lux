...
--- @field public NAME string "LocalTime" the name of this attribute
...
function LocalTime:augment_type(base_type_obj)
...
function LocalTime.pretty_print(value_obj)
  LocalTime.base_type.pretty_print(value_obj)
end

--- @function LocalTime:build_test_attr_report
---
...
LocalTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LocalTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LocalTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LocalTime:read(device)
...
function LocalTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LocalTime:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LocalTime, {__call = LocalTime.new_value})
return LocalTime
