...
function LongPollInterval.pretty_print(value_obj)
  LongPollInterval.base_type.pretty_print(value_obj)
end

--- @function LongPollInterval:build_test_attr_report
---
...
LongPollInterval.build_test_attr_report = cluster_base.build_test_attr_report

--- @function LongPollInterval:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
LongPollInterval.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function LongPollInterval:new_value(...)
...
function LongPollInterval:read(device)
...
function LongPollInterval:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function LongPollInterval:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(LongPollInterval, {__call = LongPollInterval.new_value})
