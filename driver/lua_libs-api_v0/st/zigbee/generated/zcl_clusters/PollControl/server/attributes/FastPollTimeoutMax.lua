...
function FastPollTimeoutMax.pretty_print(value_obj)
  FastPollTimeoutMax.base_type.pretty_print(value_obj)
end

--- @function FastPollTimeoutMax:build_test_attr_report
---
...
FastPollTimeoutMax.build_test_attr_report = cluster_base.build_test_attr_report

--- @function FastPollTimeoutMax:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
FastPollTimeoutMax.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function FastPollTimeoutMax:new_value(...)
...
function FastPollTimeoutMax:read(device)
...
function FastPollTimeoutMax:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function FastPollTimeoutMax:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(FastPollTimeoutMax, {__call = FastPollTimeoutMax.new_value})
