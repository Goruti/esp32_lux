...
function ShortPollInterval.pretty_print(value_obj)
  ShortPollInterval.base_type.pretty_print(value_obj)
end

--- @function ShortPollInterval:build_test_attr_report
---
...
ShortPollInterval.build_test_attr_report = cluster_base.build_test_attr_report

--- @function ShortPollInterval:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
ShortPollInterval.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function ShortPollInterval:new_value(...)
...
function ShortPollInterval:read(device)
...
function ShortPollInterval:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function ShortPollInterval:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(ShortPollInterval, {__call = ShortPollInterval.new_value})
