...
function CheckInInterval.pretty_print(value_obj)
  CheckInInterval.base_type.pretty_print(value_obj)
end

--- @function CheckInInterval:build_test_attr_report
---
...
CheckInInterval.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CheckInInterval:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint32 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CheckInInterval.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CheckInInterval:new_value(...)
...
function CheckInInterval:read(device)
...
function CheckInInterval:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CheckInInterval:write(device, value)
...
function CheckInInterval:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CheckInInterval, {__call = CheckInInterval.new_value})
