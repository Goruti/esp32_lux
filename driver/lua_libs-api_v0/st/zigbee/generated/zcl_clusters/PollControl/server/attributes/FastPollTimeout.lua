...
function FastPollTimeout.pretty_print(value_obj)
  FastPollTimeout.base_type.pretty_print(value_obj)
end

--- @function FastPollTimeout:build_test_attr_report
---
...
FastPollTimeout.build_test_attr_report = cluster_base.build_test_attr_report

--- @function FastPollTimeout:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
FastPollTimeout.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function FastPollTimeout:new_value(...)
...
function FastPollTimeout:read(device)
...
function FastPollTimeout:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function FastPollTimeout:write(device, value)
...
function FastPollTimeout:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(FastPollTimeout, {__call = FastPollTimeout.new_value})
