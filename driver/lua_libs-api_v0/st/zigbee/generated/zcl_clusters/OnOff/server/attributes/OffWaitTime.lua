...
function OffWaitTime:augment_type(base_type_obj)
...
function OffWaitTime.pretty_print(value_obj)
  OffWaitTime.base_type.pretty_print(value_obj)
end

--- @function OffWaitTime:build_test_attr_report
---
...
OffWaitTime.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OffWaitTime:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OffWaitTime.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OffWaitTime:read(device)
...
function OffWaitTime:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function OffWaitTime:write(device, value)
