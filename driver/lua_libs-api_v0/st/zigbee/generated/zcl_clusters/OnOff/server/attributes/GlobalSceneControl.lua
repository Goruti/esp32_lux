...
function GlobalSceneControl:augment_type(base_type_obj)
...
function GlobalSceneControl.pretty_print(value_obj)
  GlobalSceneControl.base_type.pretty_print(value_obj)
end

--- @function GlobalSceneControl:build_test_attr_report
---
...
GlobalSceneControl.build_test_attr_report = cluster_base.build_test_attr_report

--- @function GlobalSceneControl:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
GlobalSceneControl.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function GlobalSceneControl:read(device)
...
function GlobalSceneControl:configure_reporting(device, min_rep_int, max_rep_int)
