...
--- @field public NAME string "OnOff" the name of this attribute
...
function OnOff:augment_type(base_type_obj)
...
function OnOff.pretty_print(value_obj)
  OnOff.base_type.pretty_print(value_obj)
end

--- @function OnOff:build_test_attr_report
---
...
OnOff.build_test_attr_report = cluster_base.build_test_attr_report

--- @function OnOff:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
OnOff.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function OnOff:configure_reporting(device, min_rep_int, max_rep_int)
...
function OnOff:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(OnOff, {__call = OnOff.new_value})
return OnOff
