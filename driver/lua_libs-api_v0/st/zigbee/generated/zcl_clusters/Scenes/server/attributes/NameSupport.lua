...
--- @field public SCENE_NAMES_SUPPORTED number 128
local NameSupport = {
  ID = 0x0004,
  NAME = "NameSupport",
...
NameSupport.SCENE_NAMES_SUPPORTED = 0x80


NameSupport.mask_fields = {
  BASE_MASK = 0xFF,
  SCENE_NAMES_SUPPORTED = 0x80,
}


--- @function NameSupport:is_scene_names_supported_set
--- @return boolean True if the value of SCENE_NAMES_SUPPORTED is non-zero
NameSupport.is_scene_names_supported_set = function(self)
  return (self.value & self.SCENE_NAMES_SUPPORTED) ~= 0
end
 
--- @function NameSupport:set_scene_names_supported
--- Set the value of the bit in the SCENE_NAMES_SUPPORTED field to 1
NameSupport.set_scene_names_supported = function(self)
  self.value = self.value | self.SCENE_NAMES_SUPPORTED
end

--- @function NameSupport:unset_scene_names_supported
--- Set the value of the bits in the SCENE_NAMES_SUPPORTED field to 0
NameSupport.unset_scene_names_supported = function(self)
  self.value = self.value & (~self.SCENE_NAMES_SUPPORTED & self.BASE_MASK)
end


NameSupport.mask_methods = {
  is_scene_names_supported_set = NameSupport.is_scene_names_supported_set,
  set_scene_names_supported = NameSupport.set_scene_names_supported,
  unset_scene_names_supported = NameSupport.unset_scene_names_supported,
}
