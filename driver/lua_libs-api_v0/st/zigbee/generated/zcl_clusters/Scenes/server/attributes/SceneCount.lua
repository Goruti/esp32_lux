...
--- @field public NAME string "SceneCount" the name of this attribute
...
function SceneCount:augment_type(base_type_obj)
...
function SceneCount.pretty_print(value_obj)
  SceneCount.base_type.pretty_print(value_obj)
end

--- @function SceneCount:build_test_attr_report
---
...
SceneCount.build_test_attr_report = cluster_base.build_test_attr_report

--- @function SceneCount:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
SceneCount.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function SceneCount:read(device)
...
function SceneCount:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function SceneCount:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(SceneCount, {__call = SceneCount.new_value})
return SceneCount
