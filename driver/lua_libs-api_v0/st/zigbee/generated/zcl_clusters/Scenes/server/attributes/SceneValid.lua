...
--- @field public NAME string "SceneValid" the name of this attribute
...
function SceneValid:augment_type(base_type_obj)
...
function SceneValid.pretty_print(value_obj)
  SceneValid.base_type.pretty_print(value_obj)
end

--- @function SceneValid:build_test_attr_report
---
...
SceneValid.build_test_attr_report = cluster_base.build_test_attr_report

--- @function SceneValid:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Boolean the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
SceneValid.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function SceneValid:read(device)
...
function SceneValid:configure_reporting(device, min_rep_int, max_rep_int)
...
function SceneValid:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(SceneValid, {__call = SceneValid.new_value})
return SceneValid
