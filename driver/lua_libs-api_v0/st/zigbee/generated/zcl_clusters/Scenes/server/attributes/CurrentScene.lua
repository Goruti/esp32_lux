...
--- @field public NAME string "CurrentScene" the name of this attribute
...
function CurrentScene:augment_type(base_type_obj)
...
function CurrentScene.pretty_print(value_obj)
  CurrentScene.base_type.pretty_print(value_obj)
end

--- @function CurrentScene:build_test_attr_report
---
...
CurrentScene.build_test_attr_report = cluster_base.build_test_attr_report

--- @function CurrentScene:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint8 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
CurrentScene.build_test_read_attr_response = cluster_base.build_test_read_attr_response
...
function CurrentScene:new_value(...)
...
function CurrentScene:read(device)
...
function CurrentScene:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function CurrentScene:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(CurrentScene, {__call = CurrentScene.new_value})
return CurrentScene
