...
--- @return st.zigbee.ZigbeeMessageTx The constructed ZigbeeMessageTx containing the ZclMessageBody
function ZclMessageBody.from_values(orig, data_table)
    if data_table.zcl_header == nil then
        error(string.format("%s requires valid ZCL Header", orig.NAME), 2)
    end
