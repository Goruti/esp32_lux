...
function windowShadePreset_defaults.window_shade_preset_cmd(ZigbeeDriver, ZigbeeDevice, command)
  local level = ZigbeeDevice.preferences.presetPosition or ZigbeeDevice:get_field(windowShadePreset_defaults.PRESET_LEVEL_KEY) or windowShadePreset_defaults.PRESET_LEVEL
