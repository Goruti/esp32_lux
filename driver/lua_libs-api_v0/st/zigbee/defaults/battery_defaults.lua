...
---
--- @param battery_table a map of battery voltages to battery percentages
...
function battery_defaults.battery_volt_attr_handler(driver, device, value, zb_rx)
  ...
  if batt_perc ~= nil then
    ...
    log.warn("The device reported a voltage, but the driver was not configured to handle it.")
  end
end
