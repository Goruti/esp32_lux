...
--- @class st.zigbee.zdo.ZdoMessageBody
---
...
--- @field public body st.zigbee.zdo.ZdoMessageBody The message body. This is a message frame that must implement serialize, get_length, pretty_print, etc.
...
--- @param buf Reader The buf positioned at the beginning of the bytes representing the ZdoHeader
--- @return st.zigbee.zdo.ZdoMessageBody a new instance of the ZdoMessageRx parsed from the bytes
...
--- @return st.zigbee.zdo.ZdoMessageBody The constructed ZdoMessageRx
